    ...
    (function (Sales) {
        ...
        (function (Assistant) {
            var Constants = /** @class */ (function () {
                ...
                Constants.MaxCardsInGroupView = 3;
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            ...
            var Util = /** @class */ (function () {
                ...
                Util.GetGroupCardFullHeader = function (groupcategory, length, headerString) {
                    return (groupcategory != 0 ? length + " " : "") + this.GetGroupCardHeaderWithoutCount(length, headerString);
                };
                Util.GetGroupCardHeaderWithoutCount = function (length, headerString) {
                    var pluralSuffix = length > 1 ? "s" : "";
                    return headerString + pluralSuffix;
                };
        ...
        (function (ActionCardControl) {
            var CardTemplate = /** @class */ (function () {
                ...
                CardTemplate.prototype.GetGroupHeaderString = function () {
                    return ActionCardControl.Util.GetGroupCardHeaderWithoutCount(this.CardList.length, this.Context.resources.getString(ActionCardControl.GroupCardFactory.GetGroupCardHeaderString(this.Card.groupcategory)));
                };
        ...
        (function (ActionCardControl) {
            var GroupTemplate = /** @class */ (function (_super) {
                ...
                GroupTemplate.prototype.PopulateCardDetails = function () {
                    ...
                    this.cardTitle = ActionCardControl.Util.GetGroupCardFullHeader(this.Card.groupcategory, this.CardList.length, this.Context.resources.getString(ActionCardControl.GroupCardFactory.GetGroupCardHeaderString(this.Card.groupcategory)));
                        ...
                        body: [
                            {
                                ...
                                selectAction: {
                                    type: "Action.Submit",
                                    title: this.cardTitle + ". " + (this.isExpanded ? this.closeGroupText : this.openGroupText),
                                    data: {
                                ...
                                columns: [
                                    ...
                                    },
                                    {
                                        ...
                                        selectAction: {
                                            ...
                                            title: this.Snooze,
                                            data: {
                                                ActionName: MscrmControls.Sales.Assistant.Command.SnoozeAllCardsInList,
                                    ...
                                    },
                                    {
                                        ...
                                        selectAction: {
                                            ...
                                            title: this.Dismiss,
                                            data: {
                                                ActionName: MscrmControls.Sales.Assistant.Command.DismissAllCardsInList,
                                                CardList: this.CardList,
                                            },
                                        },
                                        verticalContentAlignment: "Center",
