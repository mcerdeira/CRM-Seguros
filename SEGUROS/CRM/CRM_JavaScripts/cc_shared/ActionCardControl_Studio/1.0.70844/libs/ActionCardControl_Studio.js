    ...
    (function (Sales) {
        ...
        (function (Assistant) {
            var Command = /** @class */ (function () {
                ...
                Command.SnoozeAll = "Assistant.Internal.SnoozeAll";
                Command.DismissAll = "Assistant.Internal.DismissAll";
                ...
                Command.Open = "Assistant.Internal.Open";
                Command.ToggleGroupMode = "Assistant.Internal.ToggleGroupMode";
                Command.OpenRegardingEntity = "Assistant.Internal.OpenRegardingEntity";
        ...
        (function (ActionCardControl_1) {
            ...
            var ActionCardControl = /** @class */ (function () {
                ...
                ActionCardControl.prototype.init = function (context, notifyOutputChanged, state, container) {
                    ...
                    this.actionCardControl = new ActionCardControl_1.CardControl(context, card, cardList, cardView, externalDependencies);
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            ...
            var CardControl = /** @class */ (function () {
                function CardControl(context, card, cardList, cardView, externalDependencies, adaptiveCard) {
                ...
                CardControl.prototype.GetControlMainHTMLDiv = function () {
                    try {
                        var adaptiveCardHelper = new ActionCardControl.AdaptiveCardHelper(this.adaptiveCard, this.context, this.card, this.cardList, this.cardView, this.xrmNavigation);
                        var htmlContent = adaptiveCardHelper.GetCardHTMLContent();
                        return htmlContent;
                    }
                    catch (err) {
                        console.log(err);
                        return { style: { border: "" }, outerHTML: "Template error" };
                    }
                };
                return CardControl;
            }());
        ...
        (function (ActionCardControl) {
            ...
            var Util = /** @class */ (function () {
                ...
                Util.ShouldGetShowAllTemplate = function (cardList) {
                    return cardList[0].groupcategory != 0 && cardList[0].groupcategory != 1 && cardList.length > 3;
                };
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            var AdaptiveCardHelper = /** @class */ (function () {
                function AdaptiveCardHelper(adaptiveCard, context, card, cardList, cardView, xrmNavigation) {
                ...
                AdaptiveCardHelper.prototype.getBasicTemplate = function () {
                    var cardTemplate = ActionCardControl.TemplateFactory.GetCardTemplate(this.context, this.card, this.cardList, this.cardView, this.xrmNavigation);
                ...
                AdaptiveCardHelper.prototype.getGroupTemplate = function () {
                    ...
                    if (this.card.groupcategory != 1) {
                        cardList = this.cardList.slice(0, 3);
                    }
                    cardList.map(function (card) {
                        var cardTemplate = ActionCardControl.TemplateFactory.GetCardTemplate(_this.context, card, null, null, _this.xrmNavigation);
                        cardTemplate.PopulateCardDetails();
                        _this.adaptiveCard.onExecuteAction = cardTemplate.OnExecuteAction.bind(cardTemplate);
                        adaptiveCardTemplate["body"][1].items.push(cardTemplate.GetGroupCardTemplate());
                    });
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            var GroupCardFactory = /** @class */ (function () {
                ...
                GroupCardFactory.GetGroupCardHeader = function (groupcategory) {
                    switch (groupcategory) {
                        case 1:
        ...
        (function (ActionCardControl) {
            var IconFactory = /** @class */ (function () {
                ...
                IconFactory.GetCardIcon = function (card) {
                    ...
                    if (card.cardtype >= 9000 && card.icon && card.icon.length > 0) {
                        return card.icon;
                    }
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            var TemplateFactory = /** @class */ (function () {
                ...
                TemplateFactory.GetCardTemplate = function (context, card, cardList, cardView, xrmNavigation) {
                    switch (card.cardtype) {
                        ...
                        case 110:
                            return new ActionCardControl.TeaserCardTemplate(context, card, cardList, cardView, xrmNavigation);
                        default:
            ...
            var CardTemplate = /** @class */ (function () {
                                        ...
                                        columns: [
                                            ...
                                            },
                                            {
                                                ...
                                                selectAction: {
                                                    type: "Action.Submit",
                                                    data: {
                                                        ActionName: MscrmControls.Sales.Assistant.Command.Snooze,
                                                        SelectedCard: this.Card,
                                                    },
                                                },
                                                verticalContentAlignment: "Center",
                                            },
                                            {
                                                ...
                                                selectAction: {
                                                    type: "Action.Submit",
                                                    data: {
                                                        ActionName: MscrmControls.Sales.Assistant.Command.Dismiss,
                                                        SelectedCard: this.Card,
                                                    },
                                                },
                                                verticalContentAlignment: "Center",
                ...
                CardTemplate.prototype.GetGroupCardTemplate = function () {
                    var template = {
                        ...
                        selectAction: {
                            type: "Action.Submit",
                            title: MscrmControls.Sales.Assistant.Command.ShowDetailed,
                            data: {
        ...
        (function (ActionCardControl) {
            var GroupTemplate = /** @class */ (function (_super) {
                ...
                GroupTemplate.prototype.PopulateCardDetails = function () {
                    ...
                    var pluralSuffix = this.CardList.length > 1 ? "s" : "";
                    this.cardTitle =
                        (this.Card.groupcategory != 0 ? this.CardList.length + " " : "") +
                            this.Context.resources.getString(ActionCardControl.GroupCardFactory.GetGroupCardHeader(this.Card.groupcategory)) +
                            pluralSuffix;
            ...
            var MeetingCardTemplate = /** @class */ (function (_super) {
                ...
                MeetingCardTemplate.prototype.PopulateCardDetails = function () {
                    ...
                    if (this.Card.data.cardContextDetails &&
                        ...
                        this.regardingEntityName = this.Card.data.cardContextDetails[0].contextObject.entityName; //TODO: Get localized
                ...
                MeetingCardTemplate.prototype.GetTemplate = function () {
                    ...
                    regarding && template.body[0].items.push(regarding);
                    return template;
                };
                MeetingCardTemplate.prototype.GetGroupCardTemplate = function () {
                    var template = {
                        type: "Container",
                        items: [
                            { type: "TextBlock", text: " " },
                ...
                MeetingCardTemplate.prototype.GetRegarding = function () {
                    if (this.regardingTitle != "") {
                        return {
                            ...
                            selectAction: {
                                type: "Action.Submit",
                                title: MscrmControls.Sales.Assistant.Command.OpenRegardingEntity,
                                data: {
                                    ActionName: MscrmControls.Sales.Assistant.Command.OpenRegardingEntity,
                                    SelectedCard: this.Card,
                                },
                            },
                        };
                ...
                MeetingCardTemplate.prototype.GetAttendees = function () {
                    ...
                    if (this.Card.attendees && this.Card.attendees.length > 0) {
                        ...
                        this.Card.attendees.map(function (card) {
                ...
                RelevantNewsTemplate.prototype.GetNewsContent = function () {
                    ...
                    this.CardList.map(function (card) {
                        ...
                        newsContent.push({
                            ...
                            selectAction: {
                                type: "Action.Submit",
                                title: MscrmControls.Sales.Assistant.Command.OpenUrl,
                                data: {
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            var TeaserCardTemplate = /** @class */ (function (_super) {
                ...
                function TeaserCardTemplate(context, card, cardList, cardView, xrmNavigation) {
                    var _this = _super.call(this, context, card, cardList, cardView) || this;
                    _this.learnMoreText = "";
                    _this.dismissCard = "";
        ...
        (function (ActionCardControl) {
            var TopCardTemplate = /** @class */ (function (_super) {
                ...
                TopCardTemplate.prototype.PopulateCardDetails = function () {
                    this.SoftTitle = this.Card.softTitle || "";
                    this.SummaryText = this.Card.summaryText || "";
                    this.Icon = ActionCardControl.IconFactory.MiscIcons.TopCard;
