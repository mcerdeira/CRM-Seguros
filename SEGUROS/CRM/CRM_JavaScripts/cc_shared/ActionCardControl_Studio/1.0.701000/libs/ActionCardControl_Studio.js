                        ...
                        this.Card.actions.Mobile &&
                            this.Card.actions.Mobile.Actions.map(function (action) {
                                ...
                                actions.push({
                                    ...
                                    iconUrl: ActionCardControl.IconFactory.GetCardActionIcon(action.CommandName, _this.Card.data),
                                });
                            });
                        !this.Card.actions.Mobile &&
    ...
    (function (Sales) {
        ...
        (function (ActionCardControl) {
            var MeetingCardTemplate = /** @class */ (function (_super) {
                ...
                MeetingCardTemplate.prototype.GetFirstAttendeeV2 = function () {
