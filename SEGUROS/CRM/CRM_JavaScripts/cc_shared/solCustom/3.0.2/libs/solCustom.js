...
function initializeMsosLibrary($, window, document) {
    ...
    MultiSelectOptionSet.prototype = {
        ...
        _initializeUiElements: function () {
            ...
            this.$selectedItemsInstructions = $("<div class='msos-a11y msos-description'/>")
                .attr("id", "{0}_selecteditems_instructions".replace('{0}', this.config.key))
                .text(this.config.texts.selectedItemsInstructions);

            this.$comboboxInstructions = $("<div class='msos-a11y msos-description'/>")
            ...
            if (this.config.multiple) {
                ...
                if (this.config.showSelectAll) {
                    ...
                    selectAllLabelElement.attr('aria-label', this.config.texts.selectAll + " " + this.formatString(this.config.texts.totalItems, this.config.data.length));
                    ...
                    var solLabelDivContainer = $('<div class="msos-label-text"></div></label>').append(selectAllDiv).append(this.$numberOfItemsDiv);
            ...
            this.$leadingInput = $("<input type='text' class='msos-tab-stop msos-leading-input msos-description'/>");
            this.$trailingInput = $("<input type='text' class='msos-tab-stop msos-trailing-input msos-description'/>");
            this.$container
            ...
            this.$alertContainer = $('<div class="msos-alert-text" aria-live="assertive" aria-atomic="true" aria-relevant="additions" aria-hidden="true" />');
        ...
        _handleDelete: function(e) {
            ...
            activeDescendant.find(".msos-quick-delete").trigger("click");
            e.preventDefault();
        },
        ...
        _renderOption: function (solOption, index, length, $optionalTargetContainer) {
            var self = this,
                ...
                $inputElement,
                $labelText = $('<div class="msos-label-text msos-optionitem-text"/>').html(solOption.label.trim().length === 0 ? '&nbsp;' : solOption.label),
                $label,
                $displayElement,
