...
function initializeMsosLibrary($, window, document) {
    ...
    MultiSelectOptionSet.prototype = {
        ...
        _initializeUiElements: function () {
            ...
            this.$selectedItemsInstructions = $("<div class='msos-a11y' role='presentation' aria-hidden='true' />")
                .attr("id", "{0}_selecteditems_instructions".replace('{0}', this.config.key))
                .text(this.config.texts.selectedItemsInstructions);

            this.$comboboxInstructions = $("<div class='msos-a11y' role='presentation' aria-hidden='true' />")
            ...
            if (this.config.multiple) {
                ...
                if (this.config.showSelectAll) {
                    ...
                    var selectAllLabelElement = $(this.formatString('<label name={0} class="msos-label msos-selectall msos-option" role="presentation">', this.config.key + "msos-label"));
            ...
            this.$leadingInput = $("<div tabindex='0' class='msos-tab-stop msos-leading-input' role='presentation' />");
            this.$trailingInput = $("<div tabindex='0' class='msos-tab-stop msos-trailing-input' role='presentation' />");
            this.$container
        ...
        _initializeInputEvents: function () {
            ...
            this.$container.bind({
                ...
                touchend: function() {
                    // touch devices require a discrete call to activateControl on touchend
