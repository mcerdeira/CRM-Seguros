        ...
        _initializeUiElements: function () {
            ...
            if (this.config.multiple) {
                ...
                if (this.config.showSelectAll) {
                    ...
                    var selectAllLabelElement = $(this.formatString('<label name={0} class="msos-label msos-selectall msos-option" for={1}>', this.config.key + "msos-label", this.config.key + "_selectAll"));
            ...
            this.$leadingInput = $("<input type='text' class='msos-tab-stop msos-leading-input' />");
            this.$trailingInput = $("<input type='text' class='msos-tab-stop msos-trailing-input' />");
            this.$container
