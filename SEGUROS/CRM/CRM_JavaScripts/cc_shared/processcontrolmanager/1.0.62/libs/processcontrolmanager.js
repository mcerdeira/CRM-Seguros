    ...
    (function (Containers) {
        ...
        var ProcessControlManager = (function () {
            function ProcessControlManager() {
                this._referencedByProcessBreadCrumb = false;
                this._referencedByProcessStageControl = false;
                this._crossEntityFlyoutDisplayState = Containers.DisplayState.collapsed;
                this._forwardNavigationEntitiesDataPromise = Promise.resolve(null);
            }
            ...
            ProcessControlManager.getInstance = function (context, mode) {
                if (!ProcessControlManager.getIsRemoveBpfControlSingletonEnabled(context)) {
                ...
                var pageId = context.factory._customControlProperties.id;
                if (!ProcessControlManager._instancesByPageId) {
                    ProcessControlManager._instancesByPageId = {};
                }
                if (!ProcessControlManager._instancesByPageId[pageId]) {
                    ProcessControlManager._instancesByPageId[pageId] = new ProcessControlManager();
                }
                var instance = ProcessControlManager._instancesByPageId[pageId];
                if (mode === Containers.ControlMode.breadCrumb) {
                    instance._referencedByProcessBreadCrumb = true;
                }
                else if (mode === Containers.ControlMode.stage) {
                    instance._referencedByProcessStageControl = true;
                }
                return instance;
            };
            ProcessControlManager.removeInstanceReference = function (context, mode) {
                var _a, _b;
                if (!context) {
                    return;
                }
                ...
                var pageId = context.factory._customControlProperties.id;
                var instance = (_a = ProcessControlManager._instancesByPageId) === null || _a === void 0 ? void 0 : _a[pageId];
                if (!instance) {
                    return;
                }
                if (mode === Containers.ControlMode.breadCrumb) {
                    instance._referencedByProcessBreadCrumb = false;
                }
                else if (mode === Containers.ControlMode.stage) {
                    instance._referencedByProcessStageControl = false;
                }
                if (!instance._referencedByProcessBreadCrumb && !instance._referencedByProcessStageControl) {
                    (_b = ProcessControlManager._instancesByPageId) === null || _b === void 0 ? true : delete _b[pageId];
                }
            };
            ProcessControlManager.getIsRemoveBpfControlSingletonEnabled = function (context) {
                var _a;
                return (_a = context === null || context === void 0 ? void 0 : context.utils) === null || _a === void 0 ? void 0 : _a.isFeatureEnabled("RemoveBPFControlSingleton");
            };
            ...
            ProcessControlManager.prototype.getStageValidationResult = function () {
                return this.stageValidationResult;
            };
            ...
            ProcessControlManager.prototype.getStageStatusText = function (stageId) {
                if (this.getStageStatus(stageId) === BusinessProcessFlowStageStatus[BusinessProcessFlowStageStatus.Completed]) {
                    return Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Completed);
                }
                else {
                    return Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Inactive);
                }
            };
            ...
            ProcessControlManager.prototype.getStepIdsAndProperties = function (stageId) {
                ...
                for (var _i = 0, stageSteps_1 = stageSteps; _i < stageSteps_1.length; _i++) {
                    ...
                    if (this.stageValidationResult && !this.stageValidationResult.isValid) {
                        if (step.stepType.toLowerCase() === flowStepType) {
                            if (!MscrmCommon.ControlUtils.Object.isNullOrUndefined(step.stepId) &&
                                !MscrmCommon.ControlUtils.Object.isNullOrUndefined(step.stepId.guid)) {
                                isRequiredStepCompleted =
                                    this.stageValidationResult.errorSteps.indexOf(step.stepId.guid.toString()) === -1;
                            }
                        }
                        else {
            ...
            ProcessControlManager.prototype._getPropertiesByEntityFieldNameAndLabel = function (step, isStepInStageGatingError) {
                ...
                if (this._contextManager.context().utils.isFeatureEnabled(BPFCUSTOMCONTROL_FCB)) {
            ...
            ProcessControlManager.prototype._getConfigProperties = function (step, isStepInStageGatingError) {
                var _a;
                var isFeatureEnabled = this._contextManager
                    .context()
                    .utils.isFeatureEnabled(ENABLE_RETRIEVE_CCF_CONTROL_CONFIG_FCB);
                if (!isFeatureEnabled) {
                    return this._getPropertiesByEntityFieldNameAndLabel(step, isStepInStageGatingError);
                }
                var eventParameters = this.getTelemetryParams();
                ...
                if (!step.config) {
                    this._contextManager
                        .context()
                        .reporting.reportFailure("ProcessControlManager._getConfigProperties", new Error("Step configuration is null."), "", eventParameters);
                    return this._getPropertiesByEntityFieldNameAndLabel(step, isStepInStageGatingError);
                }
                this._contextManager
                    .context()
                    .reporting.reportSuccess("ProcessControlManager._getConfigProperties", eventParameters);
                ...
                return {
                    ...
                    descriptor: {
                        ...
                        Required: step.isRequired,
                        UniqueId: step.stepId.guid,
                        Parameters: (_a = step === null || step === void 0 ? void 0 : step.descriptor) === null || _a === void 0 ? void 0 : _a.Parameters,
                    },
                };
            };
            ...
            ProcessControlManager.prototype.getBPFEntityLogicalName = function () {
                return this._businessProcessFlowWrapper.bpfEntityLogicalName;
            };
            ...
            ProcessControlManager.prototype.moveToNextStage = function () {
                ...
                return this._businessProcessFlowWrapper.delegates.moveNext().then(function (response) {
                    if (!MscrmCommon.ControlUtils.Object.isNullOrUndefined(nextStage) &&
                        ...
                        Containers.StyleHelper.scrollIntoView(nextStage.id, _this);
                    }
                });
            };
            ProcessControlManager.prototype.moveToPreviousStage = function () {
                ...
                return this._businessProcessFlowWrapper.delegates.movePrevious().then(function (response) {
                    if (!MscrmCommon.ControlUtils.Object.isNullOrUndefined(previousStage) &&
                        ...
                        Containers.StyleHelper.scrollIntoView(previousStage.id, _this);
                    }
                });
            };
            ProcessControlManager.prototype.validateRequiredFields = function () {
                ...
                if (this.stageValidationResult && !this.stageValidationResult.isValid) {
                    this.contextManager
                        .context()
                        .utils.setNotification(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.RequiredStepWarningMesage), this.getActiveStageId().guid);
            ...
            ProcessControlManager.prototype.refreshFlowStepClick = function (flowStepId) {
                return this._businessProcessFlowWrapper.delegates.refreshFlowStepClick(flowStepId);
            };
            ...
            ProcessControlManager.prototype.setIsUserSelectedStage = function (isUserSelectedStage) {
                if (this._businessProcessFlowWrapper.delegates.setIsUserSelectedStage) {
                    this._businessProcessFlowWrapper.delegates.setIsUserSelectedStage(isUserSelectedStage);
                }
            };
            ...
            ProcessControlManager.prototype.getIsImmersiveBPF = function () {
                return this._businessProcessFlowWrapper.isImmersiveBPF;
            };
            ...
            ProcessControlManager.prototype.executePreMoveToNextStageEvent = function (targetStageId) {
                var result = this._businessProcessFlowWrapper.delegates.executePreEvent("runOnPreStageChange", "MoveToNextStage", 0, null, targetStageId);
            ...
            ProcessControlManager.prototype.getForwardNavigationEntitiesPromise = function () {
                ...
                if (nextStage) {
                    ...
                    this._forwardNavigationEntitiesDataPromise = this._businessProcessFlowWrapper.delegates
                        .getForwardNavigationEntities(currentEntityId, referencedEntityLogicalName, referencingEntityLogicalName, referencingEntityAttributeName)
                        .then(function (response) { return (_this.forwardNavigationEntitiesData = response); });
                }
                return this._forwardNavigationEntitiesDataPromise;
            };
            ...
            ProcessControlManager.prototype.getBpfInstanceActiveFor = function () {
                ...
                if (this.isBusinessProcessCompleted() || this.isBusinessProcessAborted()) {
            ...
            ProcessControlManager.prototype.getActiveForStatus = function (time) {
                if (time === null) {
                    return Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.ActiveForLessThanOneMinute);
                }
                else {
                    return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.ActiveDurationIn), time);
                }
            };
            ProcessControlManager.prototype.getBpfInstanceCompletedIn = function () {
                ...
                if (this.isBusinessProcessAborted()) {
                    var statusName = this._businessProcessFlowWrapper.statusName != null
                        ? this._businessProcessFlowWrapper.statusName
                        : BusinessProcessFlowInstanceStatus[this._businessProcessFlowWrapper.status];
                    if (time === null) {
                        return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.AbortedAfterLessThanOneMinute), statusName);
                    }
                    return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.AbortedIn), statusName, time);
                }
                if (time === null) {
                    return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.CompletedInLessThanOneMinute));
                }
                return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.CompletedIn), time);
            };
            ...
            ProcessControlManager.prototype.isCrossEntityNavigation = function (isMoveNext) {
                var currentStageRelatedEntityReference = this.getStageRelatedEntityReference(this.getActiveStageId());
            ...
            ProcessControlManager.prototype.openCrossEntity = function (promise, selectedStageId, selectedStageEntityReference) {
                var _this = this;
                promise.then(function (response) {
                    var _a, _b;
                    var entityReference = selectedStageEntityReference !== null && selectedStageEntityReference !== void 0 ? selectedStageEntityReference : _this.getStageRelatedEntityReference(selectedStageId);
                    var formOptions = {
                        entityName: entityReference.LogicalName,
                        entityId: entityReference.Id.toString(),
                        processInstanceId: (_a = _this.getBPFInstanceId()) === null || _a === void 0 ? void 0 : _a.guid,
                        processId: (_b = _this.getBPFId()) === null || _b === void 0 ? void 0 : _b.guid,
                        selectedStageId: selectedStageId === null || selectedStageId === void 0 ? void 0 : selectedStageId.guid,
                        isCrossEntityNavigate: true,
                        bpfDisplayStateForCrossEntityNavigation: Containers.DisplayState[_this.getDisplayState()],
                    };
                    _this.contextManager.context().navigation.openForm(formOptions);
                }, function (error) {
                    if (!_this.contextManager.context().utils.isFeatureEnabled("BPFFormSaveIntegration")) {
                        if (error) {
                            _this.contextManager
                                .context(Containers.ControlMode.stage)
            ...
            ProcessControlManager.prototype._getHumanTimeFormatFromMilliseconds = function (milliseconds, isShort) {
                ...
                var minuteString = minutes != 1
                    ? Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Minutes)
                    : Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Minute);
                var hourString = hours != 1
                    ? Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Hours)
                    : Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Hour);
                var dayString = days != 1
                    ? Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Days)
                    : Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Day);
                var monthString = Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Months);
                var yearString = Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.Years);
                if (minutes <= 0) {
                    message = isShort
                        ? MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.DurationLessThanOneMinute), "<")
                        : null;
                }
                else if (minutes > 0 && minutes <= 60) {
                    message = isShort
                        ? MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.DurationInMinutes), minutes)
                        : MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.HumanTimeFormat), minutes, minuteString);
                }
                else if (hours >= 1 && hours <= 72) {
                    message = isShort
                        ? MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.DurationInHours), hours)
                        : MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.HumanTimeFormat), hours, hourString);
                }
                else if (days >= 3 && days <= 90) {
                    message = isShort
                        ? MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.DurationInDays), days)
                        : MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.HumanTimeFormat), days, dayString);
                }
                else if (months >= 3 && months <= 36) {
                    message = isShort
                        ? MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.DurationInMonths), months)
                        : MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.HumanTimeFormat), months, monthString);
                }
                else {
                    message = isShort
                        ? MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.DurationInYears), years)
                        : MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(this, Containers.ResourceStrings.HumanTimeFormat), years, yearString);
                }
                return message;
            };
            ...
            ProcessControlManager.prototype.getBpfNavigationBehaviorAllowCreateNew = function (currentStage) {
                return this._businessProcessFlowWrapper.delegates.getBpfNavigationBehaviorAllowCreateNew(currentStage);
            };
            ProcessControlManager.prototype.getCurrentStage = function () {
                return this._businessProcessFlowWrapper.delegates.getActiveStage();
            };
            ProcessControlManager.prototype.reportStageNavigationBlockedToBpfChecker = function (blockedReason) {
                this._businessProcessFlowWrapper.delegates.reportStageNavigationBlockedToBpfChecker(blockedReason);
            };
            ProcessControlManager.prototype.getTelemetryParams = function () {
                ...
                try {
                    ...
                    var isRenderedFromFormXml = this._businessProcessFlowWrapper.isRenderedFromFormXml
                        ...
                        : false;
                    var isImmersiveBPF = this._businessProcessFlowWrapper.isImmersiveBPF
                        ? this._businessProcessFlowWrapper.isImmersiveBPF
                        : false;
                    var ProcessId = {
                        name: "ProcessId",
                    ...
                    eventParams.push(IsImmersiveBPF);
                }
                catch (error) { }
                return eventParams;
            };
            ProcessControlManager.prototype.isNewMobileModeEnabled = function () {
                return this.isMobileMode() && this._contextManager.context().utils.isFeatureEnabled("April2021Update");
            };
            ProcessControlManager._instancesByPageId = {};
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        "use strict";
        var ProcessControlBase = (function () {
            function ProcessControlBase(processControlManager) {
                this._processControlManager = processControlManager;
            }
            return ProcessControlBase;
        }());
        Containers.ProcessControlBase = ProcessControlBase;
    })(Containers = MscrmControls.Containers || (MscrmControls.Containers = {}));
})(MscrmControls || (MscrmControls = {}));
var MscrmControls;
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var ContextManager = (function () {
            ...
            ContextManager.prototype.context = function (controlMode) {
                var _a;
                ...
                return (_a = context !== null && context !== void 0 ? context : this._breadCrumbContext) !== null && _a !== void 0 ? _a : this._processStageContext;
            };
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        (function (ProcessControlIconSymbol) {
            ...
            ProcessControlIconSymbol[ProcessControlIconSymbol["StageGatingError"] = 14] = "StageGatingError";
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var ResourceStrings = (function () {
            ...
            ResourceStrings.getResourceString = function (processControlManager, resource) {
                var context = processControlManager.contextManager.context(Containers.ControlMode.breadCrumb);
                if (!context) {
                    return resource;
                }
            ...
            ResourceStrings.MoveToThePreviousStage = "ProcessControl_MoveToThePreviousStage";
            ResourceStrings.MoveToTheNextStage = "ProcessControl_MoveToTheNextStage";
            ...
            ResourceStrings.ActionStep_Accessibility_Label = "ActionStep_Accessibility_Label";
            ResourceStrings.ActionButton_Icon_Accessibility_Label = "ActionButton_Icon_Accessibility_Label";
            ResourceStrings.ProcessingFlowStepData = "Processing_FlowStep_Data";
            ResourceStrings.FlowStepExecute = "FlowStep_Execute";
            ResourceStrings.FlowStep_Status_Processing = "FlowStep_Status_Processing";
            ResourceStrings.FlowStep_Status_Succeeded = "FlowStep_Status_Succeeded";
            ResourceStrings.FlowStep_Status_Failed = "FlowStep_Status_Failed";
            ResourceStrings.FieldRequired = "FIELD_REQUIRED";
            ResourceStrings.ProcessControl_Loading = "ProcessControl_Loading";
            ResourceStrings.StageFlyoutDescription = "StageFlyoutDescription";
            ResourceStrings.Reactivated = "Process_Reactivated";
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyout = (function (_super) {
            __extends(CrossEntityFlyout, _super);
            function CrossEntityFlyout(processControlManager) {
                var _this = _super.call(this, processControlManager) || this;
                _this._flyoutContainer = new Containers.CrossEntityFlyoutContainer(processControlManager);
                return _this;
            }
            CrossEntityFlyout.prototype.render = function (relativeToElementId) {
                var crossEntityFlyoutDirection = Containers.StyleHelper.isEnoughSpaceAvailableForFlyout("nextButtonContainer", Containers.ControlMode.stage, crossEntityFlyoutHeight, this._processControlManager)
                    ? 3
                    : 2;
                this._manageFocus();
                return this._processControlManager.contextManager.context().factory.createElement("FLYOUT", {
                    id: "" + CrossEntityFlyout.crossEntityFlyoutContainerKey,
                    key: "" + CrossEntityFlyout.crossEntityFlyoutContainerKey,
                    flyoutStyle: {
                        boxShadow: this._processControlManager.contextManager.context().theming.shadows.shadow01,
                    },
            ...
            CrossEntityFlyout.prototype._manageFocus = function () {
                ...
                window.setTimeout(function () {
                    var id = _this._processControlManager.contextManager.getUniqueId(Containers.ControlMode.stage, CrossEntityFlyout.crossEntityFlyoutContainerKey);
                    var element = document.getElementById(id);
                    if (element) {
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutContainer = (function (_super) {
            __extends(CrossEntityFlyoutContainer, _super);
            function CrossEntityFlyoutContainer(processControlManager) {
                var _this = _super.call(this, processControlManager) || this;
                _this._flyoutHeaderContainer = new Containers.CrossEntityFlyoutHeaderContainer(processControlManager);
                _this._flyoutItemsContainer = new Containers.CrossEntityFlyoutItemsContainer(processControlManager);
                _this._flyoutFooterContainer = new Containers.CrossEntityFlyoutFooterContainer(processControlManager);
                return _this;
            }
            CrossEntityFlyoutContainer.prototype.render = function (relativeToElementId) {
                this._relativeToElementId = relativeToElementId;
                return this._processControlManager.contextManager.context().factory.createElement("CONTAINER", {
                    ...
                    style: {
                        backgroundColor: Containers.StyleHelper.getShade(Shades.WhiteBackGround, this._processControlManager),
                        flexDirection: "column",
                        borderWidth: "1px",
                        borderStyle: "solid",
                        overflowX: "hidden",
                        borderColor: Containers.StyleHelper.getShade(Shades.Grey2, this._processControlManager),
                        width: Containers.StyleHelper.getCrossEntityFlyoutWidth(),
            ...
            CrossEntityFlyoutContainer.prototype._keyDownHandler = function (event) {
                switch (event.keyCode) {
                    case 27:
                        ...
                        break;
                    case 9:
                        Containers.FlyoutTabbingHelper.addCircularTabbing(event, this._processControlManager.contextManager.getUniqueId(Containers.ControlMode.stage, Containers.CrossEntityFlyout.crossEntityFlyoutContainerKey));
                        break;
                }
            };
            CrossEntityFlyoutContainer.prototype._closeCrossEntityFlyoutHandler = function () {
                var _this = this;
                this._processControlManager.setCrossEntityDisplayState(Containers.DisplayState.collapsed);
                this._processControlManager.contextManager.context().utils.requestRender();
                window.setTimeout(function () {
                    var id = _this._processControlManager.contextManager.getUniqueId(Containers.ControlMode.stage, _this._relativeToElementId);
                    var element = document.getElementById(id);
                    if (element) {
                        element.focus();
                    }
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutFooterContainer = (function (_super) {
            __extends(CrossEntityFlyoutFooterContainer, _super);
            function CrossEntityFlyoutFooterContainer(processControlManager) {
                var _this = _super.call(this, processControlManager) || this;
                _this.flyoutCreateIcon = new Containers.ProcessControlIcon(processControlManager);
                return _this;
            }
            CrossEntityFlyoutFooterContainer.prototype.render = function () {
                return this._processControlManager.contextManager.context().factory.createElement("CONTAINER", {
                    ...
                    style: {
                        flexDirection: "row",
                        color: Containers.StyleHelper.getShade(Shades.MainThemeDark, this._processControlManager),
                        justifyContent: this._processControlManager.forwardNavigationEntitiesData &&
                            this._processControlManager.forwardNavigationEntitiesData.showCreate === false
                            ? "flex-end"
                            : "space-between",
                        padding: "5px",
                    },
            ...
            CrossEntityFlyoutFooterContainer.prototype._renderCancel = function () {
                var _this = this;
                return this._processControlManager.contextManager.context().factory.createElement("BUTTON", {
                    key: CancelContainerKey,
                    id: CancelContainerKey,
                    tabIndex: 0,
                    role: "button",
                    accessibilityLabel: Containers.ResourceStrings.getResourceString(this._processControlManager, Containers.ResourceStrings.Close),
                    style: {
                        cursor: "pointer",
                        color: "inherit",
                    ...
                    onClick: function (event) {
                        _this._processControlManager.setCrossEntityDisplayState(Containers.DisplayState.collapsed);
                        _this._processControlManager.contextManager.context().utils.requestRender();
                        _this._manageFocusCancelButtonOnClick();
                    },
                ...
                }, Containers.ResourceStrings.getResourceString(this._processControlManager, Containers.ResourceStrings.Close));
            };
            CrossEntityFlyoutFooterContainer.prototype._manageFocusCancelButtonOnClick = function () {
                var _this = this;
                window.setTimeout(function () {
                    var nextButtonContainerId = _this._processControlManager.contextManager
                        .context()
                        .accessibility.getUniqueId(nextButtonContainerName);
                    var nextButtonContainerElement = document.getElementById(nextButtonContainerId);
                    if (nextButtonContainerElement) {
                        nextButtonContainerElement.focus();
                    }
                }, 100);
            };
            CrossEntityFlyoutFooterContainer.prototype._renderCreateNew = function () {
                var _this = this;
                var description = Containers.ResourceStrings.getResourceString(this._processControlManager, Containers.ResourceStrings.CreateNew);
                if (!description || description.trim().length === 0) {
                    return null;
                }
                var currentStage = this._processControlManager.getCurrentStage();
                var allowCreateNew = this._processControlManager.getBpfNavigationBehaviorAllowCreateNew(currentStage);
                var hideCreateNew = this._processControlManager.forwardNavigationEntitiesData &&
                    this._processControlManager.forwardNavigationEntitiesData.showCreate === false;
                if (hideCreateNew || allowCreateNew === false) {
                    return null;
                }
                var createNewIconStyle = {
                    padding: this._processControlManager.contextManager.context().client.isRTL ? "2px 0 0 5px" : "2px 5px 0 0",
                };
                return this._processControlManager.contextManager.context().factory.createElement("BUTTON", {
            ...
            CrossEntityFlyoutFooterContainer.prototype._createNewClickHandler = function () {
                var _this = this;
                var nextStage = this._processControlManager.getNextStage();
                if (!nextStage || !nextStage.id) {
                    return;
                }
                var nextEntityLogicalName = nextStage.entityName;
                var nextStageId = nextStage.id.guid.toString();
                var processInstanceId = this._processControlManager.getBPFInstanceId().guid.toString();
                var processId = this._processControlManager.getBPFId().guid.toString();
                var currentEntity = this._processControlManager.getCurrentEntity();
                ...
                this._processControlManager.setDisplayState(Containers.DisplayState.collapsed);
                this._processControlManager.contextManager
                    .context()
                    ...
                    if (!response ||
                        ...
                        _this._processControlManager.setSelectedStage(nextStage.id);
                        return;
                    }
                    var entity = _this._processControlManager.getCurrentEntity();
                    ...
                    _this._processControlManager.getNavigateToNextEntityPromise(nextEntity).then(function (response) {
                        var formOptions = {
                        ...
                        _this._processControlManager.contextManager.context().navigation.openForm(formOptions, parameters);
                    });
                }, null);
            };
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutHeaderContainer = (function (_super) {
            __extends(CrossEntityFlyoutHeaderContainer, _super);
            function CrossEntityFlyoutHeaderContainer(processControlManager) {
                return _super.call(this, processControlManager) || this;
            }
            CrossEntityFlyoutHeaderContainer.prototype.render = function () {
                if (this._processControlManager.forwardNavigationEntitiesData) {
                    var title = Containers.ResourceStrings.getResourceString(this._processControlManager, Containers.ResourceStrings.SelectChild) + " " + this._processControlManager.forwardNavigationEntitiesData.entityDisplayName;
                    return this._processControlManager.contextManager.context().factory.createElement("CONTAINER", {
            ...
            CrossEntityFlyoutHeaderContainer.prototype._renderFlyoutTitle = function (title) {
                ...
                var flyoutTitleLabel = new Containers.ProcessHeaderNameLabel(this._processControlManager);
                return flyoutTitleLabel.render(flyoutTitleLabelName, title, {
                    id: flyoutTitleLabelName,
                    key: flyoutTitleLabelName,
                    role: "alert",
                    style: {
                        color: Containers.StyleHelper.getShade(Shades.Grey7, this._processControlManager),
                        fontSize: "1em",
                        fontWeight: "600",
                        width: "90%",
                        margin: "0px",
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var CrossEntityItem = (function (_super) {
            __extends(CrossEntityItem, _super);
            function CrossEntityItem(processControlManager) {
                return _super.call(this, processControlManager) || this;
            }
            CrossEntityItem.prototype.render = function (navigationEntity, idNumber) {
                var label = this._processControlManager.contextManager.context().factory.createElement("LABEL", {
                    id: "" + crossEntityItem,
                    key: "" + crossEntityItem,
                    style: {
                        width: "inherit",
                ...
                var iconProps = {
                    style: {
                        ...
                        fontSize: "16px",
                        verticalAlign: "sub",
                        paddingLeft: this._processControlManager.contextManager.context().theming.measures.measure050,
                        paddingRight: this._processControlManager.contextManager.context().theming.measures.measure100,
                    },
                    type: navigationEntity.entityLogicalName,
                };
                var icon = this._processControlManager.contextManager.context().factory.createElement("ENTITYICON", iconProps);
                return this._processControlManager.contextManager.context().factory.createElement("LISTITEM", {
                    ...
                    style: {
                        ...
                        textOverflow: "ellipsis",
                        overflowX: "hidden",
                        color: Containers.StyleHelper.getShade(Shades.Grey5, this._processControlManager),
                        whiteSpace: "normal",
                        wordWrap: "break-word",
                        ":hover": {
                            backgroundColor: Containers.StyleHelper.getShade(Shades.Grey1, this._processControlManager),
                        },
                        ":focus": {
                            backgroundColor: Containers.StyleHelper.getShade(Shades.Grey3, this._processControlManager),
                        },
                    },
                ...
                }, this._processControlManager.contextManager.context().client.isRTL ? [label, icon] : [icon, label]);
            };
            CrossEntityItem.prototype._clickHandler = function (navigationEntity) {
                ...
                var navigationPromise = this._processControlManager.getNavigateToNextEntityPromise(navigationEntityReference);
                var selectedStageId = (_a = this._processControlManager.getNextStage()) === null || _a === void 0 ? void 0 : _a.id;
                this._processControlManager.openCrossEntity(navigationPromise, selectedStageId, navigationEntityReference);
            };
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutListLoadingKey = "CrossEntityFlyoutListLoadingKey";
        var CrossEntityFlyoutItemsContainer = (function (_super) {
            __extends(CrossEntityFlyoutItemsContainer, _super);
            function CrossEntityFlyoutItemsContainer(processControlManager) {
                return _super.call(this, processControlManager) || this;
            }
            CrossEntityFlyoutItemsContainer.prototype.render = function () {
                ...
                if (!this._processControlManager.forwardNavigationEntitiesData) {
                    return this._processControlManager.contextManager.context().factory.createElement("LABEL", {
                        id: CrossEntityFlyoutListLoadingKey,
                        key: CrossEntityFlyoutListLoadingKey,
                        style: this._getStyle(CrossEntityFlyoutListLoadingKey),
                    }, Containers.ResourceStrings.getResourceString(this._processControlManager, Containers.ResourceStrings.ProcessControl_Loading));
                }
                this._processControlManager.forwardNavigationEntitiesData.navigationEntities.forEach(function (currentNavigationEntity, index) {
                    crossEntityItems.push(new Containers.CrossEntityItem(_this._processControlManager).render(currentNavigationEntity, index));
                });
                if (crossEntityItems.length > 0) {
                    return this._processControlManager.contextManager.context().factory.createElement("SCROLLCONTAINER", {
                    ...
                    }, Containers.ResourceStrings.getResourceString(this._processControlManager, Containers.ResourceStrings.NoRecordsFound));
                    return this._processControlManager.contextManager.context().factory.createElement("CONTAINER", {
            ...
            CrossEntityFlyoutItemsContainer.prototype._getStyle = function (key) {
                ...
                if (key === CrossEntityFlyoutItemsContainerKey) {
                    ...
                    style.borderBottomColor = Containers.StyleHelper.getShade(Shades.Grey2, this._processControlManager);
                ...
                else if (key === NoRecordsFoundKey || key === CrossEntityFlyoutListLoadingKey) {
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        "use strict";
        var ProcessControlIcon = (function (_super) {
            __extends(ProcessControlIcon, _super);
            function ProcessControlIcon(processControlManager) {
                var _this = _super.call(this, processControlManager) || this;
                _this._iconsMap = {
                    1: {
                        symbol: "\uE93A",
            ...
            ProcessControlIcon.prototype.render = function (name, iconSymbol, onClick, style, role, title, accessibilityLabel) {
                if (style === void 0) { style = null; }
                if (role === void 0) { role = ""; }
                if (title === void 0) { title = ""; }
                if (accessibilityLabel === void 0) { accessibilityLabel = ""; }
                var properties = {
                    id: "" + name + iconSymbol + "_" + Math.floor(Math.random() * Date.now() * 10 + 1),
                    key: "" + name + iconSymbol,
                    type: iconSymbol,
                    title: title,
                    role: role,
                ...
                return this._processControlManager.contextManager
                    .context()
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        "use strict";
        var ProcessHeaderNameLabel = (function (_super) {
            __extends(ProcessHeaderNameLabel, _super);
            function ProcessHeaderNameLabel(processControlManager) {
                return _super.call(this, processControlManager) || this;
            }
            ProcessHeaderNameLabel.prototype.render = function (name, label, properties) {
                if (properties) {
                    return this._processControlManager.contextManager
                        .context()
                        .factory.createElement("CONTAINER", properties, label);
                }
                else {
...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var StyleHelper = (function () {
            ...
            StyleHelper.getStatusFontFamily = function (processControlManager) {
                return processControlManager.contextManager.context().theming.fontfamilies.semilight;
            };
            StyleHelper.getStatusFontSize = function (processControlManager) {
                return processControlManager.isMobileMode() ? "0.85em" : "1em";
            };
            StyleHelper.getprocessNameFontSize = function (processControlManager) {
                var isMobileMode = processControlManager.isMobileMode();
                var isNewMobileModeEnabled = processControlManager.isNewMobileModeEnabled();
                return isNewMobileModeEnabled ? "0.85em" : isMobileMode ? "1.125em" : "1em";
            };
            StyleHelper.getShade = function (shade, processControlManager) {
                var context = processControlManager.contextManager.context();
                switch (shade) {
            ...
            StyleHelper.isEnoughSpaceAvailableForFlyout = function (elementId, controlMode, flyoutHeight, processControlManager) {
                var heightAvailable;
                var stageButtonContainer = (document.getElementById(processControlManager.contextManager.getUniqueId(controlMode, elementId)));
            ...
            StyleHelper.scrollIntoView = function (stageId, processControlManager) {
                var breadCrumbContext = processControlManager.contextManager.context(Containers.ControlMode.breadCrumb);
                var firstElement = document.getElementById(breadCrumbContext.accessibility.getUniqueId(StyleHelper.getProcessStageListItemId(processControlManager.getStageIds()[0].guid)));
            ...
            StyleHelper.addTabIndexes = function (stageId, processControlManager) {
                var breadCrumbContext = processControlManager.contextManager.context(Containers.ControlMode.breadCrumb);
                if (!breadCrumbContext) {
                    return;
                }
                var firstElement = document.getElementById(breadCrumbContext.accessibility.getUniqueId("processHeaderStage_" + processControlManager.getStageIds()[0].guid));
            ...
            StyleHelper.removeTabIndexes = function (processControlManager) {
                var breadCrumbContext = processControlManager.contextManager.context(Containers.ControlMode.breadCrumb);
                if (!breadCrumbContext) {
                    return;
                }
...
//# sourceMappingURL=ProcessControlManager.js.map