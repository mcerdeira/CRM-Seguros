    ...
    (function (Containers) {
        ...
        var CrossEntityItem = (function (_super) {
            ...
            CrossEntityItem.prototype._clickHandler = function (navigationEntity) {
                ...
                this._processControlManager.getNavigateToNextEntityPromise(navigationEntityReference).then(function (response) {
                    _this._processControlManager.setCrossEntityDisplayState(Containers.DisplayState.collapsed);
                    var formOptions = {
                        entityName: navigationEntityReference.LogicalName,
                        entityId: navigationEntityReference.Id.toString(),
                    };
                    _this._processControlManager.contextManager.context().navigation.openForm(formOptions);
                });
            };
