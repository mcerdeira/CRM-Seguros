    ...
    (function (Containers) {
        ...
        var ContextManager = (function () {
            ...
            ContextManager.prototype._updateSavedState = function (context, controlMode, businessProcessFlowWrapper) {
                ...
                if ((currentState.entityId && mergedState.entityId && mergedState.entityId.toString() !== currentState.entityId.toString())
                    || (currentState.processId && mergedState.processId && mergedState.processId.guid !== currentState.processId.guid)
                    || (currentState.processInstanceId && mergedState.processInstanceId && mergedState.processInstanceId.guid !== currentState.processInstanceId.guid)
                    || mergedState.displayState !== currentState.displayState
                    || (currentState.selectedStage && mergedState.selectedStage && mergedState.selectedStage.guid !== currentState.selectedStage.guid)) {
                    if (controlMode === Containers.ControlMode.breadCrumb) {
        ...
        var ProcessControlManager = (function () {
            ...
            ProcessControlManager.prototype.getStepIdsAndProperties = function (stageId) {
                ...
                for (var _i = 0, stageSteps_1 = stageSteps; _i < stageSteps_1.length; _i++) {
                    ...
                    if (MscrmCommon.ControlUtils.String.isNullOrEmpty(fieldName) && step.stepType.toLowerCase() !== actionStepType) {
                        continue;
                    }
                    ...
                    if (this.stageValidationResult && !this.stageValidationResult.isValid) {
                        if (this.stageValidationResult.emptySteps.length !== 0) {
                            isRequiredStepCompleted = step.isRequired ? this.stageValidationResult.emptySteps.indexOf(step.attributeName) === -1 : true;
                        }
                        if (this.stageValidationResult.errorSteps.length !== 0) {
                            isRequiredStepCompleted = isRequiredStepCompleted || this.stageValidationResult.emptySteps.indexOf(step.attributeName) === -1;
                        }
                    }
                    var properties = this._getPropertiesByEntityFieldNameAndLabel(step, !isRequiredStepCompleted);
                    if (!properties) {
                        return null;
                    }
                    if (this.stageValidationResult && !this.stageValidationResult.isValid && !isSomeStepInFocus && !this.isStageLocked(stageId)) {
            ...
            ProcessControlManager.prototype.getStageEntityLogicalName = function (stageId) {
                return this._getStageWithId(stageId).relatedEntityReference.LogicalName;
            };
            ...
            ProcessControlManager.prototype.isStageLocked = function (stageId) {
                ...
                if (!this.isStageForCurrentEntity(stageId) && (!relatedEntityReference || relatedEntityReference.Id.toString() === Guid.EMPTY.toString())) {
                    return true;
                }
            ...
            ProcessControlManager.prototype.isBusinessProcessDisabled = function () {
                return (this._businessProcessFlowWrapper.status === 3) || (this._businessProcessFlowWrapper.processState === 0);
            };
            ...
            ProcessControlManager.prototype.moveToNextStage = function () {
                ...
                return this._businessProcessFlowWrapper.delegates.moveNext().then(function (response) {
                    Containers.StyleHelper.scrollIntoView(_this.getNextStage().id);
                });
            };
            ProcessControlManager.prototype.moveToPreviousStage = function () {
                ...
                return this._businessProcessFlowWrapper.delegates.movePrevious().then(function (response) {
                    Containers.StyleHelper.scrollIntoView(_this.getPreviousStage().id);
                });
            };
            ProcessControlManager.prototype.validateRequiredFields = function () {
                ...
                if (this.stageValidationResult && !this.stageValidationResult.isValid) {
                    this.contextManager.context().utils.setNotification(Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.RequiredStepWarningMesage), this.getActiveStageId().guid);
            ...
            ProcessControlManager.prototype.setSelectedStage = function (stageId) {
                this._businessProcessFlowWrapper.delegates.setSelectedStage(stageId);
            };
            ...
            ProcessControlManager.prototype.getForwardNavigationEntitiesPromise = function () {
                ...
                if (nextStage) {
                    var referencingEntityAttributeName = this._getStageWithId(this.getActiveStageId()).referencingAttributeName;
            ...
            ProcessControlManager.prototype.isMobileMode = function () {
                return this.contextManager.context().client.getFormFactor() === 3 || window.innerWidth <= parseInt(this.contextManager.context().theming.breakpoints.dimensions);
            };
            ...
            ProcessControlManager.prototype.getBpfInstanceActiveFor = function () {
                ...
                if (ProcessControlManager.Instance.isBusinessProcessCompleted() || ProcessControlManager.Instance.isBusinessProcessAborted()) {
            ...
            ProcessControlManager.prototype.isCrossEntityNavigation = function (isMoveNext) {
                ...
                return (currentStageRelatedEntityReference && nextStageRelatedEntityReference && currentStageRelatedEntityReference.LogicalName !== nextStageRelatedEntityReference.LogicalName);
            };
            ProcessControlManager.prototype._getHumanTimeFormatFromMilliseconds = function (milliseconds, isShort) {
                ...
                var mstring = Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.CreateNew);
                var minuteString = minutes != 1 ? Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Minutes)
                    : Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Minute);
                var hourString = hours != 1 ? Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Hours)
                    : Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Hour);
                var dayString = days != 1 ? Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Days)
                    : Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Day);
                var weekString = Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.Weeks);
    ...
    (function (Containers) {
        ...
        var AccessibilityHelper = (function () {
            ...
            AccessibilityHelper._elementIsEditable = function (element) {
                return element.tagName.toLowerCase() === "input" || element.tagName.toLowerCase() === "textarea" || element.contentEditable === "true";
            };
            ...
            AccessibilityHelper._elementIsVisible = function (element) {
                return !element.hidden && (element.offsetWidth || element.offsetHeight || element.getClientRects().length)
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyout = (function () {
            ...
            CrossEntityFlyout.prototype.render = function (relativeToElementId) {
                var crossEntityFlyoutDirection = Containers.StyleHelper.isEnoughSpaceAvailableForFlyout("nextButtonContainer", Containers.ControlMode.stage, crossEntityFlyoutHeight) ? 3 : 2;
                this._manageFocus();
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutFooterContainer = (function () {
            ...
            CrossEntityFlyoutFooterContainer.prototype._renderCreateNew = function () {
                ...
                var allowCreateNew = Containers.ProcessControlManager.Instance.getBpfNavigationBehavior().allowCreateNew ? Containers.ProcessControlManager.Instance.getBpfNavigationBehavior().allowCreateNew(currentStage) : true;
                if (Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData.showCreate === false || allowCreateNew === false) {
                    return null;
                }
                ...
                }, [this.flyoutCreateIcon.render(CreateNewIcon, Containers.ProcessControlIconSymbol.CreateNew, function () { }, createNewIconStyle), description]);
            };
            CrossEntityFlyoutFooterContainer.prototype._createNewClickHandler = function () {
                var nextEntityLogicalName = Containers.ProcessControlManager.Instance.getNextStage().entityName;
                ...
                Containers.ProcessControlManager.Instance.contextManager.context().navigation.openForm(quickCreateFormOptions, parameters).then(function (response) {
                    if (!response || !response.savedEntityReference || response.savedEntityReference.length === 0 || Guid.equals(new Guid(response.savedEntityReference[0].id), Guid.EMPTY)) {
                        return;
                    }
    ...
    (function (Containers) {
        ...
        var CrossEntityItem = (function () {
            ...
            CrossEntityItem.prototype.render = function (navigationEntity, idNumber) {
                ...
                var icon = Containers.ProcessControlManager.Instance.contextManager.context().factory.createElement("ENTITYICON", iconProps);
            ...
            CrossEntityItem.prototype._clickHandler = function (navigationEntity) {
                ...
                var processId = Containers.ProcessControlManager.Instance.getBPFId();
                var processInstanceId = Containers.ProcessControlManager.Instance.getBPFInstanceId();
    ...
    (function (Containers) {
        ...
        var ProcessControlIcon = (function () {
            ...
            ProcessControlIcon.prototype.render = function (name, iconSymbol, onClick, style, role, title) {
                ...
                return Containers.ProcessControlManager.Instance.contextManager.context().factory.createElement("LABEL", properties, this._iconsMap[iconSymbol].symbol);
            };
    ...
    (function (Containers) {
        ...
        var ProcessHeaderNameLabel = (function () {
            ...
            ProcessHeaderNameLabel.prototype.render = function (name, label, properties) {
                if (properties) {
                    return Containers.ProcessControlManager.Instance.contextManager.context().factory.createElement("LABEL", properties, label);
                }
                else {
                    ...
                    return Containers.ProcessControlManager.Instance.contextManager.context().factory.createElement("LABEL", defaultProperties, label);
                }
            };
    ...
    (function (Containers) {
        ...
        var StyleHelper = (function () {
            ...
            StyleHelper.scrollIntoView = function (stageId) {
                ...
                if (!firstElementClientRect || firstElementClientRect.length == 0 || !nextElementClientRect || nextElementClientRect.length === 0) {
                    return;
                }
            ...
            StyleHelper.addTabIndexes = function (stageId) {
                ...
                if (!defaultTopClientRect || defaultTopClientRect.length === 0 || !newTopClientRect || newTopClientRect.length === 0) {
                    return;
                }
