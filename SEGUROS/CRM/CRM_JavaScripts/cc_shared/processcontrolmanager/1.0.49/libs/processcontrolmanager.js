...
(function (MscrmControls) {
    ...
    (function (Containers) {
        ...
        var DESIGN_LANGUGAGE_TEAMS_THEME = "DesignLanguageTeamsTheme";
        var ProcessControlManager = (function () {
            ...
            ProcessControlManager.prototype.getBpfInstanceCompletedIn = function () {
                ...
                if (ProcessControlManager.Instance.isBusinessProcessAborted()) {
                    ...
                    if (time === null) {
                        return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.AbortedAfterLessThanOneMinute), statusName);
                    }
                    return MscrmCommon.ControlUtils.String.Format(Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.AbortedIn), statusName, time);
                }
                if (time === null) {
            ...
            ProcessControlManager.prototype.isBpfTeamsThemingEnabled = function () {
                return this._context.utils.isFeatureEnabled(DESIGN_LANGUGAGE_TEAMS_THEME);
            };
            ProcessControlManager.prototype.isNewMobileModeEnabled = function () {
                return this.isMobileMode() && this._context.utils.isFeatureEnabled("April2021Update");
            };
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutFooterContainer = (function () {
            ...
            CrossEntityFlyoutFooterContainer.prototype.render = function () {
                return Containers.ProcessControlManager.Instance.contextManager.context().factory.createElement("CONTAINER", {
                    ...
                    style: {
                        ...
                        justifyContent: Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData &&
                            Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData.showCreate === false
                            ? "flex-end"
                            : "space-between",
                        padding: "5px",
                    },
            ...
            CrossEntityFlyoutFooterContainer.prototype._manageFocusCancelButtonOnClick = function () {
                window.setTimeout(function () {
                    var nextButtonContainerId = Containers.ProcessControlManager.Instance.contextManager
                        .context()
            ...
            CrossEntityFlyoutFooterContainer.prototype._renderCreateNew = function () {
                ...
                var allowCreateNew = Containers.ProcessControlManager.Instance.getBpfNavigationBehaviorAllowCreateNew(currentStage);
                var hideCreateNew = Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData &&
                    Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData.showCreate === false;
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutHeaderContainer = (function () {
            ...
            CrossEntityFlyoutHeaderContainer.prototype.render = function () {
                if (Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData) {
    ...
    (function (Containers) {
        ...
        var CrossEntityFlyoutItemsContainer = (function () {
            ...
            CrossEntityFlyoutItemsContainer.prototype.render = function () {
                ...
                if (!Containers.ProcessControlManager.Instance.forwardNavigationEntitiesData) {
                    return Containers.ProcessControlManager.Instance.contextManager.context().factory.createElement("LABEL", {
                    ...
                    }, Containers.ResourceStrings.getResourceString(Containers.ResourceStrings.ProcessControl_Loading));
                }
    ...
    (function (Containers) {
        ...
        var StyleHelper = (function () {
            ...
            StyleHelper.getprocessNameFontSize = function () {
                ...
                var isNewMobileModeEnabled = Containers.ProcessControlManager.Instance.isNewMobileModeEnabled();
