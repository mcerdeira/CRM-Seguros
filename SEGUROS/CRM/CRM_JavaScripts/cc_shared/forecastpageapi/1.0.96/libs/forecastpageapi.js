...
var BaseUiApi = (function () {
    ...
    BaseUiApi.prototype.getDateFormattedValue = function (date) {
        if (date.toDateString().toLocaleLowerCase() === new Date('0001-01-01T00:00:00Z').toDateString().toLocaleLowerCase())
            return "";
        return this.context.forecastServices.crmDataFormatter.formatDate(date);
    };
...
var EditWithHistoryApiImpl = (function (_super) {
    ...
    EditWithHistoryApiImpl.prototype.onHistoryClick = function (rowId, colId) {
        this.logUsage("FI_ManualAdjust", "History icon clicked", { rowId: rowId, colId: colId });
...
var FCChartsApiImpl = (function (_super) {
    ...
    FCChartsApiImpl.prototype.IsWaterFallPanelOpen = function () {
        return this.stateManager.IsWaterFallPanelOpen();
    };
    ...
    FCChartsApiImpl.prototype._onCellSelect = function (fcId, frId, rowId) {
        ...
        this.fetchTrendChartData(fcId, frId, fiId, isRollUp, requestId);
    };
    FCChartsApiImpl.prototype._onPredictiveCellSelect = function (fcId, frId, rowId) {
        var isRollUp = !rowId.endsWith("_agg");
        var fiId = rowId.replace("_agg", "");
        this.stateManager.resetChartData();
        this.SetIsWaterFallPanelOpen(true);
        this.fetchAndUpdatelatestPredictiveResultSplit(fcId, frId, rowId, fiId, isRollUp);
    };
    ...
    FCChartsApiImpl.prototype.fetchAndUpdatelatestPredictiveResultSplit = function (fcId, frId, rowId, fiId, isRollUp) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FCChartsApiImpl.prototype.fetchTrendChartData = function (fcId, frId, fiId, isRollUp, requestId) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, Promise.all(promises).then(function (result) {
                                ...
                                .catch(function (error) {
                                _this.logError("FcChartsApi", error, "Error fetching chart data");
                            })];
                    case 1:
                        _a.sent();
                        if (this.stateManager.getCompositeChartRequestId() == requestId) {
...
var FcFrManager = (function (_super) {
        ...
        _this.frListItemSelector = reselect_1.createSelector(function (allFcs) { return allFcs; }, function (allFRs) {
            ...
            return allFRs.map(function (fr) {
                ...
                if ((validFromDate <= currDate) && (validToDate >= currDate)) {
                    var appendstring = _this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.APPENDWITHSPACE);
                    var currentrec = _this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.CURRENTRECURRENCE);
                    outP.title = appendstring.replace("{0}", outP.title).replace("{1}", currentrec);
                }
                return outP;
            });
        });
    ...
    FcFrManager.prototype.selectFirstFrFromList = function (_a) {
        ...
        if (frList.length > 0) {
            ...
            if (index == -1)
                index = 0;
            this.onFrChange(frList[index].id);
        }
    };
...
var FiFetcher = (function (_super) {
    ...
    FiFetcher.prototype.fetchRootFI = function (_a) {
        ...
        var snapId = __1.EMPTY_GUID;
        this.context.forecastServices.forecastDataAccess.fetchForecastInstances(newId, fcId, [""], pageInfos, __1.EMPTY_GUID).then(function (fiResponse) {
            ...
            _this.fullApi.fiGrid.onPivotChange();
        }).catch(function (e) {
        ...
        if (colId == "") {
            ...
            if (this.fullApi.global.getForecastPageMode() == forecastPageTypes_1.ForecastPageMode.FIGrid) {
                if (colInfo != undefined && colInfo.forecastColumnType != forecastPageTypes_1.ForecastColumnType.Predictive) {
                    ...
                    this.fullApi.fcCharts._onPredictiveCellSelect(this.fullApi.fcfrManager.getActiveFCId(), this.fullApi.fcfrManager.getActiveFRId(), rowId);
                ...
                this.fullApi.snapshots._onCellSelect(rowId);
                ...
                this.fullApi.fcCharts._onCellSelect(this.fullApi.fcfrManager.getActiveFCId(), this.fullApi.fcfrManager.getActiveFRId(), rowId);
            }
        }
    };
...
var FiGridCommon = (function (_super) {
    ...
    FiGridCommon.prototype.onPivotChange = function () {
        if (this.fullApi.global.getForecastPageMode() != forecastPageTypes_1.ForecastPageMode.FIGrid) {
            if (this.fullApi.global.getForecastPageMode() === forecastPageTypes_1.ForecastPageMode.DealFlow) {
                if (!this.fullApi.snapshots.isDealFlowChartVisible()) {
                    ...
                    this.fullApi.snapshots.fetchSnapshotListforFR();
                }
            ...
            this.onPivotChangeRetainSelectedCell();
        }
    };
    FiGridCommon.prototype.onPivotChangeRetainSelectedCell = function () {
        ...
        if (selectedCell.rowId == types_1.NULL_CELLINFO.rowId
            ...
            this.fullApi.fiGrid.onCellSelect(rowId, colId);
        }
        else {
            this.fullApi.fiGrid.onCellSelect(selectedCell.rowId, this.fullApi.fiGrid.getFiColumns()[0].id);
        }
    };
    return FiGridCommon;
}(baseUiApi_1.BaseUiApi));
        ...
        this.getVisibleColumnDefinitions(fc).map(function (col) {
            ...
            switch (col.forecastColumnType) {
                ...
                case __1.ForecastColumnType.Rollup:
                    {
                        if (fiColumnData[col.id].isEditable) {
                        ...
                        else if (fiColumnData[col.id].showHistory) {
...
var GlobalStateManager = (function (_super) {
    ...
    GlobalStateManager.prototype.setForecastPageMode = function (arg0) {
        ...
        this.fullApi.fiGrid.onPivotChange();
    };
    ...
    KanbanApiImpl.prototype.getEventHandlerCallbacks = function (forecastConfigInfo) {
        ...
        return {
            ...
            onDataRecordSaved: function (recordId, values, attributesSaved, curLaneId) {
                ...
                _this.fullApi.partRecordViewer._onParticipatingRecordSaved(recordId, hierarchyValId, Number(curLaneId), changedValsMap);
            }
        };
    };
...
var PartRecordGridApiImpl = (function (_super) {
    ...
    PartRecordGridApiImpl.prototype.onRecordSaved = function (recordId, hierarchyLinkedAtttributeId, optionSetValue, changes) {
        this.fullApi.partRecordViewer._onParticipatingRecordSaved(recordId, hierarchyLinkedAtttributeId, optionSetValue, changes);
    };
...
var PartRecordViewerApiImpl = (function (_super) {
    ...
    PartRecordViewerApiImpl.prototype.onCloseClickForDealFlowViewer = function () {
        this.logUsage("PartRecordViewer", "Close button clicked for deal flow viewer", {});
    ...
    PartRecordViewerApiImpl.prototype._onParticipatingRecordSaved = function (recordId, hierarchyLinkedAtttributeId, optionSetValue, changes) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        newFiList = _b.sent();
                        this.logInfo("DeltaRecomputeCallComplete", "completed");
                        this.logDebug("DeltaRecomputeCallComplete", "Response value", { newFiList: newFiList });
    ...
    PartRecordViewerApiImpl.prototype.deriveDeltaRecomputeColumnIdsAndHierarchyIDs = function (optionSetValue, hierarchyLinkedAtttributeId, changes) {
        var fc = this.context.stateManager.fcFr.getActiveFc();
        var col = fc.gridMetadata.columnDefinitions.find(function (col) { return col.optionSetValue === optionSetValue; });
        ...
        changes.forEach(function (val, key) {
            if (key === attrOptionSet) {
                if (optionSetValue !== val.peviousValue) {
                    var col_1 = fc.gridMetadata.columnDefinitions.find(function (col) { return col.optionSetValue === val.peviousValue; });
...
var SnapshotApiImpl = (function (_super) {
    ...
    SnapshotApiImpl.prototype._onCellSelect = function (rowId) {
        ...
        if (this.isDealFlowChartVisible() && !this.isSelectionChanged()) {
            this.fetchAndUpdateDealFlowChartData();
        }
        else {
            this.setChartDataFetchStatus(forecastPageTypes_1.Status.Init);
        }
    };
    SnapshotApiImpl.prototype.fetchAndUpdateDealFlowChartData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                rowType = isAgg ? "" + forecastPageTypes_1.ForecastInstanceColumnGroupType.Aggregated : "" + forecastPageTypes_1.ForecastInstanceColumnGroupType.RolledUp;
                fiId = this.normalizeID(rowId);
                this._triggerChartDataFetch(fiId, rowType);
                return [2];
            });
        });
    };
    ...
    SnapshotApiImpl.prototype.fetchSnapshotListforFR = function () {
        this.setSnapshotDataFetchStatus(forecastPageTypes_1.Status.InProgress);
        this.fetchSnapshotList();
    };
    SnapshotApiImpl.prototype.setDefaultSnapshotSelection = function () {
    ...
    SnapshotApiImpl.prototype.fetchSnapshotList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fcId, frId, snapshots, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        this.setDefaultSnapshotSelection();
                        return [3, 3];
                    case 2:
                        e_1 = _a.sent();
                        this.logError("SnapshotApi", e_1, "Error fetching snapshotlist.");
    ...
    SnapshotApiImpl.prototype._triggerChartDataFetch = function (fiId, forecastInstanceGroupType) {
        return __awaiter(this, void 0, void 0, function () {
            var forecastConfig, fcId, frId, mainSnapId, secondSnapId, baseCurrencySymbol_1, chartData, e_2;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        e_2 = _a.sent();
                        this.logError("SnapshotApi", e_2, "Error fetching deal flow chart data.");
...
exports.dfData = {
    Nodes: [
        { name: "Best case", color: "#3049AD", key: "42d408cc-8c83-4d3c-b745-f53605a71ba6", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Committed", color: "#118DFF", key: "6760f59f-0464-428a-8c0d-e901a64b320c", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Lost", color: "#C83D95", key: "5f35c872-cd78-4cee-98c5-837db0c086db", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Pipeline", color: "#E04854", key: "ffdbc5ea-7624-4ea9-b711-11aa7c3aa54c", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Won", color: "#FFADC1", key: "da233e18-379d-4aef-a66d-4a355ab0c9f7", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Best case", color: "#3049AD", key: "42d408cc-8c83-4d3c-b745-f53605a71ba6", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Committed", color: "#118DFF", key: "6760f59f-0464-428a-8c0d-e901a64b320c", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Lost", color: "#C83D95", key: "5f35c872-cd78-4cee-98c5-837db0c086db", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
        { name: "Pipeline", color: "#E04854", key: "ffdbc5ea-7624-4ea9-b711-11aa7c3aa54c", value: 12332, formattedValue: "", snapshotId: "", snapshotName: "", abbreviatedValue: "", participatingRecordsCount: 5 },
