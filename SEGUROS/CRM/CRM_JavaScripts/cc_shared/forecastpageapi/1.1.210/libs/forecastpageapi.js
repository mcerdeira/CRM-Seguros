...
var FCChartsApiImpl = (function (_super) {
    ...
    FCChartsApiImpl.prototype.getForecastCumulativeTrendLineSeries = function () {
        ...
        if (this.fullApi.fcfrManager.getActiveFC().advancedsettings.SelectedDownStreamPrimaryDataType !== forecastPageTypes_1.DownStreamPrimaryDataType.Quantity)
    ...
    FCChartsApiImpl.prototype.fetchTrendChartData = function (fcId, frId, fiId, isRollUp, requestId, context) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, trendChartData, promises, selectedDataType, trendDataPromise, predictionPromise, timeStampRequestEnd, scenarioName, e_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        trendChartData = {};
                        promises = [];
                        selectedDataType = this.fullApi.fcfrManager.getActiveFC().advancedsettings.SelectedDownStreamPrimaryDataType
                            ? this.fullApi.fcfrManager.getActiveFC().advancedsettings.SelectedDownStreamPrimaryDataType
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (Object.keys(existingChartData).length == 0) {
                    ...
                    quotaColumn = fcInfo.gridMetadata.columnDefinitions.find(function (c) { c.uniqueName == "Quota"; });
...
var drillDownDataFetcher = (function (_super) {
    ...
    drillDownDataFetcher.prototype.fetchDrillDownInstancesForParentAndPageNo = function (rowId, pageNo, context) {
        ...
        this.toastTimerId = window.setTimeout(function () { return _this.checkAndShowLongDurationMessageToast(rowId, pageInfos, forecastRecurrenceId, forecastPivotId); }, constants_1.DRILLDOWN_TIMEOUT_FOR_TOAST_MS);
...
var SnapshotApiImpl = (function (_super) {
    ...
    SnapshotApiImpl.prototype._triggerChartDataFetch = function (fiId, forecastInstanceGroupType, context) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, forecastConfig, fcId, frId, mainSnapId, secondSnapId, baseCurrencySymbol_1, selectedDataType, chartData, timeStampRequestEnd, scenarioName, e_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        baseCurrencySymbol_1 = forecastConfig.advancedsettings.SelectedDownStreamPrimaryDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Currency ? this.fullApi.global.getActiveCurrencySymbol() : "";
                        selectedDataType = forecastConfig.advancedsettings.SelectedDownStreamPrimaryDataType ? forecastConfig.advancedsettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
    ...
    SnapshotApiImpl.prototype.getFormattedValueForSelectedDataTypeFromColName = function (val, colName) {
        var selectedDataType = this.fullApi.fcfrManager.getActiveFC().advancedsettings.SelectedDownStreamPrimaryDataType;
...
var SnapshotFiGridApiImpl = (function (_super) {
    ...
    SnapshotFiGridApiImpl.prototype.getSelectedColumnsForGrid = function (allColumns) {
        var fcInfo = this.fullApi.fcfrManager.getActiveFC();
        var selectedDataType = fcInfo.advancedsettings.SelectedDownStreamPrimaryDataType
            ? fcInfo.advancedsettings.SelectedDownStreamPrimaryDataType
            : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        ...
        var userSelectedColumnIds = fcInfo.advancedsettings.SelectedDuplicateColumns;
