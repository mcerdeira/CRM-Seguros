...
var FcFrManager = (function (_super) {
    ...
    FcFrManager.prototype._onFcChange = function (newId, mruFrID, context) {
        this.logUsage("FC selector", "", { newId: newId }, "Change", "FcFrManager.onFcChange", constants_1.FCFR_FEATURE_NAME);
...
var FiFetcher = (function (_super) {
    ...
    FiFetcher.prototype.fetchRootFI = function (_a) {
        ...
        this.context.forecastServices.forecastDataAccess.fetchForecastInstances(newId, fcId, [""], pageInfos, snapId).then(function (fiResponse) {
            _this.logInfo("FiFetch - root", "complete", __assign({}, context), "fetchRootFi-success");
    ...
    FiFetcher.prototype.fetchChildFiForParentAndPageNo = function (rowId, pageNo, context) {
        ...
        this.context.forecastServices.forecastDataAccess.fetchForecastInstances(frId, fcId, [rowId], pageInfos, snapId).then(function (fiResponse) {
            _this.logInfo("FiFetch", "complete", __assign({}, context), "fiChildFetch-success");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        siPackage = _a.sent();
                        this.stateManager.setIsSIPackageInstalled(true);
                        return [2];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (featureState) {
                            ...
                            this.stateManager.setSnapshotFeatureEnabled(featureState.isSnaphotEnabled);
                        }
                        return [2];
                }
            });
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                var featureState = {
                    ...
                    isSnaphotEnabled: (featureStateData.Snapshot === 1)
                };
