...
var pivotManager = (function (_super) {
    ...
    pivotManager.prototype.getPivotList = function () {
        var activeFcId = this.context.stateManager.fcFr.getActiveFcId();
        this.logUsage("getPivotList() Active Pivot Id", "", { "fcId": activeFcId, "pivotId": this.stateManager.getActivePivotId() }, "Change", "PivotManager.getPivotList()", constants_1.PIVOT_FEATURE_NAME);
...
var constants_1 = __webpack_require__(/*! ./constants */ "./src/ForecastPageUiApi/common/constants.ts");
var BaseUiApi = (function () {
    ...
    BaseUiApi.prototype.getColumnDataType = function () {
        var columnDataType = forecastPageTypes_1.ForecastColumnDataType.NotSupported;
        var cell = this.context.stateManager.fiGrid.getCalloutCell();
        if (cell) {
            var colInfo = this.getColumnInfoFromId(cell.colId);
            if (colInfo) {
                columnDataType = colInfo.dataType;
            }
        }
    ...
    BaseUiApi.prototype.getVisibleColumnDefinitions = function (fc) {
        var columns = fc.gridMetadata.columnDefinitions;
        return columns.filter(function (c) { return c.isVisible; });
    };
    ...
    BaseUiApi.prototype.getActiveCurrencyFormattedValue = function (value) {
        var activeCurrency = this.fullApi.multiCurrencyManager.getActiveCurrency();
        value *= activeCurrency.ExchangeRate;
        return this.getCurrencyFormattedValue(value);
    };
    BaseUiApi.prototype.openEntityFormInDialog = function (entityName, entityId) {
        return window.Xrm.Navigation.navigateTo({
    ...
    BaseUiApi.prototype.getCurrencyFormattedValue = function (value) {
        var activeCurrency = this.fullApi.multiCurrencyManager.getActiveCurrency();
        var currencySymbol = activeCurrency.CurrencySymbol;
        var precision = activeCurrency.CurrencyPrecision;
        return this.context.forecastServices.crmDataFormatter.formatCurrency(value, currencySymbol, precision);
    };
    ...
    BaseUiApi.prototype.addToastNotification = function (message) {
        return this.context.forecastServices.nrtToastNotificationsManager.createInfoToastNotification(message);
    };
    BaseUiApi.prototype.clearToastNofication = function (id) {
        this.context.forecastServices.nrtToastNotificationsManager.clearNotification(id);
    };
    ...
    BaseUiApi.prototype.checkIfColumnTypeOfCurrency = function (colId) {
        var col = this.getColumnInfoFromId(colId);
        if (!col) {
            return false;
        }
        return (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency ||
            (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Old &&
                !(col.forecastColumnType == forecastPageTypes_1.ForecastColumnType.HierarchyPrimary || col.forecastColumnType == forecastPageTypes_1.ForecastColumnType.HierarchySecondary)));
    };
    BaseUiApi.prototype.getValueBasedonColumnType = function (col, value) {
        if (!col)
            return value.toString();
        if (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency ||
            (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Old &&
                !(col.forecastColumnType == forecastPageTypes_1.ForecastColumnType.HierarchyPrimary || col.forecastColumnType == forecastPageTypes_1.ForecastColumnType.HierarchySecondary))) {
            return this.getActiveCurrencyFormattedValue(value);
        }
        var precision = 2;
        if (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Integer)
            precision = 0;
        return this.getNumberFormattedValue(value, precision);
    };
    ...
    BaseUiApi.prototype.logPerf = function (component, event, args, action, methodName, featureName) {
        if (args === void 0) { args = {}; }
        this.logger.logPerf(component, event, args, action, methodName, featureName);
    };
    ...
    BaseUiApi.prototype.createNewContext = function (triggerSource) {
        ...
        return {
            ...
            triggerTimeStamp: performance.now()
        };
    };
    ...
    BaseUiApi.prototype.getPerfDataJson = function (scenarioName, loadTime) {
        return {
            scenario: scenarioName,
            timetaken: loadTime
        };
    };
    BaseUiApi.prototype.hasWorkflowNotEnabledError = function (e) {
        try {
            var details = e.stack ? e.stack : JSON.stringify(e);
            if (e && e.errorCode && e.errorCode == constants_1.WEBAPI_ERRORCODE && details && details.indexOf(constants_1.RESOURCE_ACTION_NOT_FOUND_ERROR) != -1) {
                return true;
            }
        }
        catch (e) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ALLOW_TREND_COLS_CURRENCY = exports.WEBAPI_ERRORCODE = exports.RESOURCE_ACTION_NOT_FOUND_ERROR = exports.DRILLDOWN_TIMEOUT_FOR_TOAST_MS = exports.DEALFLOW_FEATURE_NAME = exports.FISNAPSHOT_FEATURE_NAME = exports.PREDICTIVE_FEATURE_NAME = exports.DISMISS_ACTION = exports.CLICK_ACTION = exports.PARTICIPAATING_RECORDS_FEATURE_NAME = exports.PIVOT_FEATURE_NAME = exports.MULTI_CURRENCY_FEATURE_NAME = exports.FCFR_FEATURE_NAME = exports.FORECAST_DRILLDOWN_FEATURE_NAME = exports.SHOWBY_FLOW_FEATURE_NAME = exports.FIGRID_ADJUST_FEATURE_NAME = exports.MANUAL_ADJUST_FEATURE_NAME = void 0;
...
exports.FORECAST_DRILLDOWN_FEATURE_NAME = "Forecasting-Drilldown";
exports.FCFR_FEATURE_NAME = "FC-FR Manager";
exports.MULTI_CURRENCY_FEATURE_NAME = "Forecasting-MultiCurrency";
...
exports.DRILLDOWN_TIMEOUT_FOR_TOAST_MS = 10000;
exports.RESOURCE_ACTION_NOT_FOUND_ERROR = 'msdyn_ForecastInstanceActions';
exports.WEBAPI_ERRORCODE = 2147879050;
exports.ALLOW_TREND_COLS_CURRENCY = ["materialized", "predictiveforecast", "dummy"];


/***/ }),

/***/ "./src/ForecastPageUiApi/customScriptInjection/AssetLoader.ts":
/*!********************************************************************!*\
  !*** ./src/ForecastPageUiApi/customScriptInjection/AssetLoader.ts ***!
  \********************************************************************/
/*! no static exports found */
...
var AssetLoader = (function () {
    function AssetLoader(targetDocument) {
        if (targetDocument === void 0) { targetDocument = document; }
        this._jsLoadingPromises = {};
        this._targetDocument = targetDocument;
    }
    AssetLoader.prototype.loadScript = function (filename) {
        var _this = this;
        var referenceFilename = filename;
        if (!this._jsLoadingPromises[referenceFilename]) {
            this._jsLoadingPromises[referenceFilename] = new Promise(function (resolve, reject) {
                var script = _this._targetDocument.createElement("script");
                ...
                script.src = filename;
                _this._targetDocument.body.appendChild(script);
            });
        }
        return this._jsLoadingPromises[referenceFilename];
    };
    AssetLoader.prototype.loadScripts = function (filenames) {
        var _this = this;
        return filenames
            .reduce(function (prev, filename) {
            return prev.then(function () { return _this.loadScript(filename); });
        }, Promise.resolve());
    };
    AssetLoader.prototype.removeIFrame = function () {
        var targetDocument = this._targetDocument;
        if (targetDocument && targetDocument.parentNode) {
            targetDocument.parentNode.removeChild(targetDocument);
        }
    };
    return AssetLoader;
}());
...
/***/ "./src/ForecastPageUiApi/customScriptInjection/FcWebResourcesApiImpl.ts":
/*!******************************************************************************!*\
  !*** ./src/ForecastPageUiApi/customScriptInjection/FcWebResourcesApiImpl.ts ***!
  \******************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.FcWebResourcesApiImpl = void 0;
var baseUiApi_1 = __webpack_require__(/*! ../common/baseUiApi */ "./src/ForecastPageUiApi/common/baseUiApi.ts");
var ScriptContainer_1 = __webpack_require__(/*! ./ScriptContainer */ "./src/ForecastPageUiApi/customScriptInjection/ScriptContainer.ts");
var FcWebResourcesApiImpl = (function (_super) {
    __extends(FcWebResourcesApiImpl, _super);
    function FcWebResourcesApiImpl(context, fullApi) {
        var _this = _super.call(this, context, fullApi) || this;
        _this.Forecasting_WebResources_Iframe_ID = "SalesForecastingWebResources_ApiFrame";
        _this.ClientAPI_Handlers = ["OnRowLoad", "OnSave", "OnChange"];
        _this.WebResourcesFilePathPrefix = "WebResources/";
        _this.fcWebResourceStateManager = context.stateManager.fcWebResourcesStateManager;
        _this.fcFrManager = context.stateManager.fcFr;
        return _this;
    }
    FcWebResourcesApiImpl.prototype.setHandlerDetails = function (fns) {
        this.fcWebResourceStateManager.setHandlerDetails(fns);
    };
    FcWebResourcesApiImpl.prototype.getHandlerDetails = function () {
        return this.fcWebResourceStateManager.getHandlerDetails();
    };
    FcWebResourcesApiImpl.prototype.getIsFcWebResourcesLoading = function () {
        return this.fcWebResourceStateManager.getIsFcWebResourcesLoading();
    };
    FcWebResourcesApiImpl.prototype.getIsFcWebResourcesLoadSuccess = function () {
        return this.fcWebResourceStateManager.getIsFcWebResourcesLoadSuccess();
    };
    FcWebResourcesApiImpl.prototype.getIsFcMappedWithWebResources = function () {
        return this.fcWebResourceStateManager.getIsFcMappedWithWebResources();
    };
    FcWebResourcesApiImpl.prototype.onFcChange = function (newId, oldId, context) {
        var _this = this;
        if (oldId != newId) {
            this.fcWebResourceStateManager.resetFcWebResourcesData();
            this.clearFcWebResources();
            var fc = this.fcFrManager.getActiveFc();
            if (fc && fc.advancedsettings && fc.advancedsettings.UnderlyingRecordsWebResourceList) {
                context = context || this.createNewContext("fcwebresourcesapi-fcchange-loadwebresources");
                var webResourcesPathArr_1 = [];
                fc.advancedsettings.UnderlyingRecordsWebResourceList.forEach(function (webResource) {
                    webResourcesPathArr_1.push(_this.WebResourcesFilePathPrefix + webResource.Name);
                });
                this.fcWebResourceStateManager.setWebResourcesMappedWithFc(webResourcesPathArr_1);
                this.fcWebResourceStateManager.setIsFcWebResourcesLoading(true);
                this.fcWebResourceStateManager.setIsFcMappedWithWebResources(true);
                this.loadWebResources(webResourcesPathArr_1, fc.id, context);
            }
            else {
                this.fcWebResourceStateManager.setIsFcMappedWithWebResources(false);
            }
        }
    };
    FcWebResourcesApiImpl.prototype.clearFcWebResources = function () {
        var scContainer = ScriptContainer_1.ScriptContainer.getInstance(this.Forecasting_WebResources_Iframe_ID, false);
        scContainer && scContainer.unloadIFrame();
    };
    FcWebResourcesApiImpl.prototype.loadWebResources = function (webResourcesArr, fcId, context) {
        var _this = this;
        context = context || this.createNewContext("fcwebresourcesapi-fcchange-loadwebresources");
        var scContainer = ScriptContainer_1.ScriptContainer.getInstance(this.Forecasting_WebResources_Iframe_ID);
        var webResourceFuture = scContainer.loadWebResources(webResourcesArr);
        webResourceFuture.then(function (val) {
            var currentFc = _this.fullApi.fcfrManager.getActiveFC();
            if (currentFc && currentFc.id === fcId) {
                _this.updateHanldersFromLoadedWebResources(scContainer);
                _this.fcWebResourceStateManager.setIsFcWebResourcesLoading(false);
                _this.fcWebResourceStateManager.setIsFcWebResourcesLoadSuccess(true);
                _this.logInfo("FcWebResoucesApi", "Loaded webresources successfully for the Fc", __assign(__assign({}, context), { fcId: fcId }));
            }
        }).catch(function (err) {
            _this.logError("FcWebResourcesApi", err, "Error loading webresources mapped for FC", __assign(__assign({}, context), { fcId: fcId }));
            var currentFc = _this.fullApi.fcfrManager.getActiveFC();
            if (currentFc && currentFc.id === fcId) {
                _this.fcWebResourceStateManager.setIsFcWebResourcesLoading(false);
                _this.fcWebResourceStateManager.setIsFcWebResourcesLoadSuccess(false);
            }
        });
    };
    FcWebResourcesApiImpl.prototype.updateHanldersFromLoadedWebResources = function (scContainer) {
        var handlerFnMpg = {};
        this.ClientAPI_Handlers.forEach(function (handler) {
            handlerFnMpg[handler] = scContainer.getHandler(handler);
        });
        this.fcWebResourceStateManager.setHandlerDetails(handlerFnMpg);
    };
    return FcWebResourcesApiImpl;
}(baseUiApi_1.BaseUiApi));
exports.FcWebResourcesApiImpl = FcWebResourcesApiImpl;


/***/ }),

/***/ "./src/ForecastPageUiApi/customScriptInjection/ScriptContainer.ts":
/*!************************************************************************!*\
  !*** ./src/ForecastPageUiApi/customScriptInjection/ScriptContainer.ts ***!
  \************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ScriptContainer = void 0;
var AssetLoader_1 = __importDefault(__webpack_require__(/*! ./AssetLoader */ "./src/ForecastPageUiApi/customScriptInjection/AssetLoader.ts"));
var ScriptContainer = (function () {
    function ScriptContainer(iframeId) {
        var _a;
        this._assetLoader = {};
        this._iframe = {};
        this.iframeId = iframeId;
        if (!ScriptContainer._instances[iframeId]) {
            this._injectIFrame(iframeId);
        }
        this._assetLoader = new AssetLoader_1.default(this._iframe.contentDocument ? this._iframe.contentDocument : (_a = this._iframe.contentWindow) === null || _a === void 0 ? void 0 : _a.document);
    }
    ScriptContainer.getInstance = function (frameId, createInstanceIfNotExistAlready) {
        if (createInstanceIfNotExistAlready === void 0) { createInstanceIfNotExistAlready = true; }
        if (!ScriptContainer._instances[frameId] && createInstanceIfNotExistAlready) {
            ScriptContainer._instances[frameId] = new ScriptContainer(frameId);
        }
        return ScriptContainer._instances[frameId];
    };
    ScriptContainer.prototype._injectIFrame = function (iframeId) {
    ...
    ScriptContainer.prototype.loadWebResources = function (webResources) {
        if (this._assetLoader) {
            return this._assetLoader.loadScripts(webResources);
        }
        else {
            return Promise.reject("AssetLoader not initialized");
        }
    };
    ScriptContainer.prototype.getHandler = function (handler) {
        var contentWindow = this._iframe.contentWindow;
        var func = contentWindow[handler];
        if (func !== undefined && func !== null) {
            return func;
        }
    };
    ScriptContainer.prototype.unloadIFrame = function () {
        if (ScriptContainer._instances[this.iframeId]) {
            var frame = document.getElementById(this.iframeId);
            if (frame && frame.parentNode) {
                frame.parentNode.removeChild(frame);
            }
            delete ScriptContainer._instances[this.iframeId];
        }
    };
    ScriptContainer._instances = {};
...
var EditGridWithViewSelect = (function (_super) {
    ...
    EditGridWithViewSelect.prototype.onViewChange = function (viewId, context) {
        if (this.input.viewMruKey && this.input.preSelectedView != viewId) {
...
var EditWithHistoryApiImpl = (function (_super) {
    ...
    EditWithHistoryApiImpl.prototype.setFocusBackToGrid = function (cell) {
        ...
        var editbutton = focusElement.querySelector('[data-automation-id*=gridIconButton_onEdit_]');
        if (editbutton) {
            editbutton.focus();
        }
    };
    EditWithHistoryApiImpl.prototype.getTitle = function () {
        ...
        if (this.determineFiColumnType(cell.rowId) === "RolledUpColumns") {
            var hierarchyPrimaryGroupStrTemplate = this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.OWNER_NAME_GROUP_SMALLCASE);
            outP.ownerName = hierarchyPrimaryGroupStrTemplate.replace("{0}", outP.ownerName);
        }
    ...
    EditWithHistoryApiImpl.prototype.getAdjustmentValues = function () {
        ...
        if (cellData.isManualAdjusted) {
            var directAdjustmentRow = {
                ...
                adjustmentValue: this.getValueBasedonColumnType(col, cellData.directAdjustedValue),
            };
            outP.canRevert = true;
        ...
        if (cellData.isRollupAdjusted) {
            var inDirectAdjustmentRow = {
                ...
                adjustmentValue: this.getValueBasedonColumnType(col, cellData.rollupAdjustedValue),
            };
        ...
        var calculatedAdjustmentRow = {
            ...
            adjustmentValue: this.getValueBasedonColumnType(col, cellData.originalValue),
        };
    ...
    EditWithHistoryApiImpl.prototype.triggerAdjustmentHistoryFetch = function () {
        ...
        this.context.forecastServices.forecastDataAccess.ManualAdjustHistory(maHistoryReq).then(function (historyList) {
            ...
            if (openedCell.rowId != "" && openedCell.colId != "" && cell.rowId == openedCell.rowId && cell.colId == openedCell.colId) {
                ...
                var UIData = _this._convertToDisplayData(historyList, cell.colId);
    ...
    EditWithHistoryApiImpl.prototype._convertToDisplayData = function (historyList, colId) {
        var _this = this;
        var outP = [];
        var col = this.getColumnInfoFromId(colId);
        if (historyList == null)
        ...
        historyList.map(function (data) {
            outP.push({
                ...
                FromValue: _this.getValueBasedonColumnType(col, data.From),
                ToValue: _this.getValueBasedonColumnType(col, data.To),
    ...
    EditWithHistoryApiImpl.prototype.onManualAdjustmentClick = function (newValue, notes) {
        ...
        var frId = this.fullApi.fcfrManager.getActiveFRId();
        var cell = this.context.stateManager.fiGrid.getCalloutCell();
        if (newValue && this.checkIfColumnTypeOfCurrency(cell.colId)) {
            newValue /= this.fullApi.multiCurrencyManager.getActiveCurrency().ExchangeRate;
        }
        var manualAdjReq = {
            ForecastInstanceId: this.normalizeID(cell.rowId),
            ForecastConfigurationColumnId: cell.colId,
...
var FCChartsApiImpl = (function (_super) {
    ...
    FCChartsApiImpl.prototype.getForecastCumulativeTrendLineSeries = function () {
        var chartData = this.stateManager.getCummulativeTrendChartData();
        var advSettings = this.fullApi.fcfrManager.getActiveFC().advancedsettings;
        if (!advSettings || (advSettings && advSettings.SelectedDownStreamPrimaryDataType !== forecastPageTypes_1.DownStreamPrimaryDataType.Quantity))
            return this.updateLineSeriesValuesForActiveCurrency(chartData);
        return chartData;
    };
    FCChartsApiImpl.prototype.updateLineSeriesValuesForActiveCurrency = function (cumulativeTrendChartData) {
        var _this = this;
        if (cumulativeTrendChartData.lineseries) {
            var cumulativeTrendChartData11 = JSON.parse(JSON.stringify(cumulativeTrendChartData));
            cumulativeTrendChartData11.lineseries.forEach(function (line) {
                line.data.forEach(function (val) {
                    if (val.length > 1) {
                        val[1] *= _this.fullApi.multiCurrencyManager.getActiveCurrency().ExchangeRate;
                    }
                });
            });
            return cumulativeTrendChartData11;
        }
        return cumulativeTrendChartData;
    };
    FCChartsApiImpl.prototype.getLatestPredictedResultSplit = function () {
        return this.updateWaterFallValuesForActiveCurrency(this.stateManager.getWaterFallTrendChartData());
    };
    FCChartsApiImpl.prototype.updateWaterFallValuesForActiveCurrency = function (latestPredictedResultSplit) {
        var _this = this;
        if (latestPredictedResultSplit.data) {
            var latestPredictedResultSplit11 = JSON.parse(JSON.stringify(latestPredictedResultSplit));
            latestPredictedResultSplit11.data.forEach(function (result) {
                result.y *= _this.fullApi.multiCurrencyManager.getActiveCurrency().ExchangeRate;
            });
            return latestPredictedResultSplit11;
        }
        return latestPredictedResultSplit;
    };
    ...
    FCChartsApiImpl.prototype.setIsWaterFallPanelOpen = function (arg0) {
        if (arg0 === false) {
            this.fullApi.fiGrid._clearSelectedCell();
        }
    ...
    FCChartsApiImpl.prototype.getSelectedHierarchyRecordId = function () {
        var _a, _b;
        return (_b = (_a = this.getFiFromFiId(this.getSelectedCellId().rowId)) === null || _a === void 0 ? void 0 : _a.HierarchyEntityData) === null || _b === void 0 ? void 0 : _b.id;
    };
    FCChartsApiImpl.prototype.isForecastInsightsEnabled = function () {
        var _a, _b;
        return (_b = (_a = this.fullApi.fcfrManager.getActiveFC().advancedsettings) === null || _a === void 0 ? void 0 : _a.Options) === null || _b === void 0 ? void 0 : _b.isPredictionInsightsEnabled;
    };
    ...
    FCChartsApiImpl.prototype.getIsPredictionSplitDataFetchFailed = function () {
        return this.stateManager.getIsPredictionSplitDataFetchFailed();
    };
    ...
    FCChartsApiImpl.prototype._onPredictiveCellSelect = function (fcId, frId, rowId, context) {
        ...
        if (this.fullApi.global.getSIPackageInstalled()) {
            ...
            if (!this.isDrillDownRowOrCellSelected()) {
                ...
                var hierarchyRecordId = (_b = (_a = this.getFiFromFiId(fiId)) === null || _a === void 0 ? void 0 : _a.HierarchyEntityData) === null || _b === void 0 ? void 0 : _b.id;
                if (this.isForecastInsightsEnabled() && this.stateManager.initiateForecastInsightFetchForNode(fcId, hierarchyRecordId, isRollUp)) {
                    this.fetchForecastInsights(fcId, hierarchyRecordId, fiId, isRollUp, rowId);
                }
            }
        }
        this.fullApi.partRecordViewer.onCloseClick(false);
    };
    ...
    FCChartsApiImpl.prototype.setPredictiveErrorBarState = function (arg) {
        this.stateManager.setPredictiveErrorBarVisibleState(arg);
    };
    FCChartsApiImpl.prototype.getPredictiveErrorBarState = function () {
        return this.stateManager.getPredictiveErrorBarVisibleState();
    };
    FCChartsApiImpl.prototype.isChartDataAvailable = function () {
        var chartData = this.stateManager.getCummulativeTrendChartData();
        var showChartData = false;
        chartData.lineseries.forEach(function (line) {
    ...
    FCChartsApiImpl.prototype.fetchAndUpdatelatestPredictiveResultSplit = function (fcId, frId, rowId, fiId, isRollUp, context) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, latestPredictiveResultSplit, timeStampRequestEnd, scenarioName, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        timeStampRequestStart = performance.now();
                    ...
                    case 1:
                        ...
                        this.logInfo("WaterfallChartDataFetcher", "", __assign({}, context), "fetch-fccharts-success");
                        if (this.fullApi.fiGrid.getSelectedCell().rowId == rowId) {
                            ...
                            timeStampRequestEnd = performance.now();
                            scenarioName = "Forecast - Predictive Waterfall chart";
                            this.logPerf("WaterfallChartDataFetcher", scenarioName, this.getPerfDataJson(scenarioName, timeStampRequestEnd - timeStampRequestStart));
                        }
                        return [3, 3];
                    case 2:
                        e_1 = _a.sent();
                        this.stateManager.setIsPredictionSplitDataFetchFailed(true);
                        return [3, 3];
                    case 3: return [2];
                }
            });
    ...
    FCChartsApiImpl.prototype.fetchPredictionStatusForFC = function (fcId) {
        return __awaiter(this, void 0, void 0, function () {
            var predictionStatus, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.fullApi.global.getSIPackageInstalled() && this.isPredictiveEnabled())) return [3, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        e_2 = _a.sent();
                        this.logError("FcChartsApi", e_2, "Error fetching prediction status for FC");
                        return [3, 4];
                    case 4: return [2];
                }
            });
    ...
    FCChartsApiImpl.prototype.fetchTrendChartData = function (fcId, frId, fiId, isRollUp, requestId, context) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, trendChartData, promises, advSettings, selectedDataType, trendDataPromise, predictionPromise, timeStampRequestEnd, scenarioName, e_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        trendChartData = {};
                        promises = [];
                        advSettings = this.fullApi.fcfrManager.getActiveFC().advancedsettings;
                        selectedDataType = advSettings && advSettings.SelectedDownStreamPrimaryDataType
                            ? advSettings.SelectedDownStreamPrimaryDataType
                            : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
                        ...
                        if (this.isPredictiveEnabled() && selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Currency) {
                        ...
                        return [4, Promise.all(promises).then(function (result) {
                                ...
                                .catch(function (error) {
                                _this.logError("TrendChartDataFetcher", error, "Error fetching chart data", __assign({}, context));
                            })];
                    case 1:
                        _a.sent();
                        if (this.stateManager.getCompositeChartRequestId() == requestId) {
                            this.processAndUpdateFCChartData(trendChartData, selectedDataType);
                            timeStampRequestEnd = performance.now();
                            scenarioName = "Forecast - Trend chart";
                            this.logPerf("TrendChartDataFetcher", scenarioName, this.getPerfDataJson(scenarioName, timeStampRequestEnd - timeStampRequestStart));
                        }
                        return [3, 3];
                    case 2:
                        e_3 = _a.sent();
                        this.context.errorHandler.handleError("Error while fetching forecast trend chart data.", 3, e_3);
                        this.logError("fetchTrendChartData", e_3, "", __assign({}, context));
                        throw e_3;
                    case 3: return [2];
                }
            });
    ...
    FCChartsApiImpl.prototype.fetchForecastInsights = function (fcId, hierarchyRecordId, fiId, isRollup, rowId) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, forecastInsights, timeStampRequestEnd, scenarioName, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (this.fullApi.fiGrid.getSelectedCell().rowId == rowId) {
                            ...
                            timeStampRequestEnd = performance.now();
                            scenarioName = "Forecast - Predictive Insights";
                            this.logPerf("ForecastInsightsFetcher", scenarioName, this.getPerfDataJson(scenarioName, timeStampRequestEnd - timeStampRequestStart));
                        }
                        return [3, 3];
                    case 2:
                        e_4 = _a.sent();
                        this.stateManager.setForecastInsights(fcId, hierarchyRecordId, isRollup, forecastPageTypes_1.ERROR_IN_FETCHING_FORECAST_INSIGHTS);
                        this.logError("FcChartsApi", e_4, "Error fetching forecast insights");
                        return [3, 3];
                    case 3: return [2];
                }
            });
    ...
    FCChartsApiImpl.prototype.processAndUpdateFCChartData = function (trendChartData, selectedDataType) {
        return __awaiter(this, void 0, void 0, function () {
            var existingChartData, MilliSecondsInADay, recurrenceType, recurrenceStartDate, recurrenceEndDate, tickIntervalValue, minorTickIntervalValue, fcInfo, quotaColumn, quotaLineSeries, xAxis1, lineSeriesChartData;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                if (Object.keys(existingChartData).length == 0) {
                    ...
                    fcInfo = this.fullApi.fcfrManager.getActiveFC();
                    quotaColumn = fcInfo.gridMetadata.columnDefinitions.find(function (c) { return c.uniqueName == "quota"; });
                    if (quotaColumn && ((quotaColumn.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency && selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Currency)
                        || ((quotaColumn.dataType == forecastPageTypes_1.ForecastColumnDataType.Decimal || quotaColumn.dataType == forecastPageTypes_1.ForecastColumnDataType.Integer)
                            && selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Quantity))) {
                        quotaLineSeries = {
                            id: "quota",
                    ...
                    trendChartData.series = trendChartData.series.filter(function (col) {
                        return _this.isColumnOfSpecifiedDataType(col, selectedDataType);
                    });
                    xAxis1 = [{
                            type: 'datetime',
    ...
    FCChartsApiImpl.prototype.isPredictiveEnabled = function () {
        ...
        var fc = this.fullApi.fcfrManager.getActiveFC();
        fc && fc.gridMetadata.columnDefinitions.forEach(function (val) {
    ...
    FCChartsApiImpl.prototype.isColumnOfSpecifiedDataType = function (col, dataType) {
        if (col.id && constants_1.ALLOW_TREND_COLS_CURRENCY.includes(col.id)) {
            return dataType === forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        }
        var allColumns = this.fullApi.fcfrManager.getActiveFC().gridMetadata.columnDefinitions;
        var columnInfo = allColumns.find(function (c) {
            return c.id == col.id || (c.uniqueName == "quota" && col.id == "quota");
        });
        if (dataType == forecastPageTypes_1.DownStreamPrimaryDataType.Currency) {
            return columnInfo && columnInfo.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency;
        }
        else {
            return columnInfo && (columnInfo.dataType == forecastPageTypes_1.ForecastColumnDataType.Decimal || columnInfo.dataType == forecastPageTypes_1.ForecastColumnDataType.Integer);
        }
    };
...
var FcFrManager = (function (_super) {
    ...
    function FcFrManager(context, fullApi) {
        ...
        _this.forecastActionWorkflowNotEnabled = false;
    ...
    FcFrManager.prototype._onFcChange = function (newId, mruFrID, context) {
        ...
        this.fullApi.fcWebResourcesApi.onFcChange(newId, oldFcId);
        this.fullApi.fcCharts._onFcChange(newId, oldFcId);
        this.fullApi.showByGrid._onFcChange(newId, oldFcId, context);
        if (!this.fullApi.global.shouldRenderTabControl()) {
            this.fullApi.global.setForecastPageMode(forecastPageTypes_1.ForecastPageMode.FIGrid);
        }
    };
    ...
    FcFrManager.prototype.getForecastConfigTelemetryInfo = function (fc) {
        ...
        var IsClientApisPresent = fc.advancedsettings && fc.advancedsettings.UnderlyingRecordsWebResourceList ? fc.advancedsettings.UnderlyingRecordsWebResourceList.length > 0 : false;
        return {
            ...
            IsClientApisPresent: IsClientApisPresent
        };
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        e_1 = _a.sent();
                        if (this.hasWorkflowNotEnabledError(e_1)) {
                            this.stateManager.all.global.setIsFullPageLoading(false);
                            this.forecastActionWorkflowNotEnabled = true;
                        }
                        else {
...
var drillDownDataFetcher = (function (_super) {
    ...
    drillDownDataFetcher.prototype.checkAndShowLongDurationMessageToast = function (rowId, pageInfos, forecastRecurrenceId, forecastPivotId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.shouldProcessSendingToast(forecastRecurrenceId, forecastPivotId, pageInfos, rowId)) return [3, 2];
                        _a = this;
                        return [4, this.addToastNotification(this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.DRILLDOWN_LATENCY_MESSAGE))];
                    case 1:
                        _a.toastNotificationId = _b.sent();
                        _b.label = 2;
                    case 2: return [2];
                }
            });
    ...
    drillDownDataFetcher.prototype.shouldProcessSendingToast = function (forecastRecurrenceId, forecastPivotId, pageInfos, rowId) {
        var pageInfoDict = this.fullApi.drillDownGridApi.getDrillDownPageInfoDict();
        ...
        return this.isCurrentFR(forecastRecurrenceId) &&
            ...
            this.fullApi.drillDownGridApi.isFiDrillDownExpanded(rowId) &&
            ((pageInfoDict == undefined ||
                pageInfoDict[rowId] == undefined ||
                pageInfoDict[rowId].pageNo < pageInfos.pageNumber ||
                (diListState && diListState.keyDict &&
                    diListState.keyDict[rowId].length == 0 &&
                    pageInfoDict[rowId].numberOfNonAccessibleRecords != 0)));
    };
    ...
    drillDownDataFetcher.prototype.fetchDrillDownInstancesForParentAndPageNo = function (rowId, pageNo, context) {
        ...
        var forecastPivot = this.fullApi.pivotManager.getActivePivot();
        ...
        this.context.stateManager.drillDownGridStateManager.updateDrilldownFetchHadError(rowId, false);
        this.logInfo("DrillDownInstancesFetch", "started", __assign({ rowId: rowId, pageNo: pageNo }, context));
        this.toastTimerId = window.setTimeout(function () { return _this.checkAndShowLongDurationMessageToast(rowId, pageInfos, forecastRecurrenceId, forecastPivot.ForecastPivotId); }, constants_1.DRILLDOWN_TIMEOUT_FOR_TOAST_MS);
        this.context.forecastServices.forecastDataAccess.fetchDrillDownInstances(forecastConfigurationId, forecastRecurrenceId, targetForecastInstanceId, forecastPivot, columnGroupType, forecastConfigurationColumnIds, pageInfos).then(function (drillDownResponse) {
            ...
            if (_this.shouldProcessResponse(forecastRecurrenceId, forecastPivot.ForecastPivotId, pageInfos, rowId)) {
                ...
                _this.checkAndClearToastNotification(drillDownResponse);
                _this.checkAndFetchNextPageAutomatically(rowId, drillDownResponse, pageInfos);
            }
        }).catch(function (e) {
            if (_this.shouldProcessResponse(forecastRecurrenceId, forecastPivot.ForecastPivotId, pageInfos, rowId)) {
                _this.fullApi.drillDownGridApi.markDrillDownRecordsFetchComplete({ rowId: rowId });
                _this.context.stateManager.drillDownGridStateManager.updateDrilldownFetchHadError(rowId, true);
                _this.logError("DrillDownInstancesFetch", e, '');
                _this.fullApi.drillDownGridApi.clearToastNotificationAndReInitialize();
            }
        });
    };
    drillDownDataFetcher.prototype.checkAndClearToastNotification = function (drillDownResponse) {
        if (drillDownResponse.forecastDrillDownInstances.length > 0 || drillDownResponse.hasMoreRecords == false) {
            this.clearToastNofication(this.toastNotificationId);
        }
    };
    drillDownDataFetcher.prototype.clearToastNotificationAndReInitialize = function () {
        window.clearTimeout(this.toastTimerId);
        this.clearToastNofication(this.toastNotificationId);
        this.toastNotificationId = "";
    };
...
var drillDownGridApiImpl = (function (_super) {
    ...
    drillDownGridApiImpl.prototype.onDrillDownButtonClick = function (rowId) {
        ...
        var fcId = this.fullApi.fcfrManager.getActiveFC().id;
        var pivotId = this.fullApi.pivotManager.getActivePivotId();
        this.logUsage("pivotIconEnabled icon click", "", __assign({ fcId: fcId, pivotId: pivotId, rowId: rowId, isAlreadyExpanded: isAlreadyExpanded }, context), "Click", "onDrillDownButtonClick", constants_1.FORECAST_DRILLDOWN_FEATURE_NAME);
    ...
    drillDownGridApiImpl.prototype._onDrillDownButtonClick = function (rowId, context) {
        ...
        if (isAlreadyExpanded) {
            ...
            this.clearToastNotificationAndReInitialize();
            if (this.stateManager.getIsDrillDownCacheMarkedInvalidated()) {
    ...
    drillDownGridApiImpl.prototype.clearDrillDownData = function () {
        ...
        this.stateManager.resetDrilldownFetchHadErrorDict();
        this.stateManager.setIsDrillDownCacheMarkedInvalidated(false);
    };
    ...
    drillDownGridApiImpl.prototype.isAnyDrillDownExpanded = function () {
        var dict = this.getDrillDownExpandedDict();
        var outP = false;
    ...
    drillDownGridApiImpl.prototype.clearToastNotificationAndReInitialize = function () {
        this.drillDownDataFetcher.clearToastNotificationAndReInitialize();
    };
    ...
    drillDownGridApiImpl.prototype.markDrilldownsForRefresh = function () {
        this.stateManager.setIsDrillDownCacheMarkedInvalidated(true);
    };
...
var drillDownRowsSelector = (function (_super) {
        ...
        var _loop_1 = function () {
            if (diExpandDict[diKey]) {
                ...
                if (index_1 != -1) {
                    ...
                    var diHadError = this_1.context.stateManager.drillDownGridStateManager.checkDrilldownFetchHadError(fiListOutp[index_1].id);
                    if (diListState) {
                        ...
                        if (diList_1.length > 0) {
                            var firstDiRow = diList_1[0];
                            var firstDi = disById_1[firstDiRow.id];
                            if (firstDi.uniqueId === sharedEnums_1.blankDrillDownInstanceUniqueId) {
                                diList_1 = diList_1.slice(1);
                                if (this_1.shouldAddBlankRecordRow(pageInfoDict, diKey)) {
                                    diList_1.push(firstDiRow);
                                }
                            }
                            diList_1[diList_1.length - 1].shouldAddLazyLoadCue = pageInfoDict[diKey] != undefined && !diHadError ? pageInfoDict[diKey].hasMoreRecords : false;
                            diList_1[diList_1.length - 1].lazyLoadNextPageNumber = pageInfoDict[diKey] != undefined ? pageInfoDict[diKey].pageNo + 1 : 2;
                        }
                    }
                    if (diHadError) {
                        diList_1.push({
                            id: fiListOutp[index_1].id + "_error",
                            parentId: fiListOutp[index_1].id,
                            cellData: {},
                            isExpanded: false,
                            showExpandIcon: false,
                            indendationLevel: 0,
                            fiGridRowType: forecastPageTypes_1.fiGridRowType.drilldownLoadErrorMessage
                        });
                    }
    ...
    drillDownRowsSelector.prototype.shouldAddBlankRecordRow = function (pageInfoDict, diKey) {
                ...
                switch (fcColumn.dataType) {
                    ...
                    case forecastPageTypes_1.ForecastColumnDataType.Currency:
                        outP.cellData[col.forecastConfigurationColumnId] = {
                            displayValue: _this.getActiveCurrencyFormattedValue(col.value)
                        };
                        break;
                    ...
                    case forecastPageTypes_1.ForecastColumnDataType.Integer:
                        {
                            outP.cellData[col.forecastConfigurationColumnId] = {
                                displayValue: _this.getNumberFormattedValue(col.value, 0)
                            };
                            break;
                        }
...
var FiColumnsSelector = (function (_super) {
    ...
    FiColumnsSelector.prototype.getFiGridColumnFromFCColumnDefinition = function (c) {
        ...
        if (c.forecastColumnType == __1.ForecastColumnType.Predictive && !this.fullApi.fiSnapshot.isSnapshotFiGridPageActive()) {
    ...
    FiColumnsSelector.prototype.updateGridColumnsForPredictiveColumnType = function (fiGridColumn) {
        ...
        if (predictionStatus && predictionStatus.PredictionOn) {
            ...
            if (formattedPredictionOnDate) {
                ...
                iconProps.iconAriaLabel = this.context.forecastServices.uiFcbProvider.IsUiFCBEnabled("ShowSnapshotEnhancedUX")
                    ? this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.PREDICTION_COLUMN_INFO_MESSAGE) + " " + formattedPredictionOnDate
                    : this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.PREDICTION_STATE_LAST_PREDICTED_MESSAGE) + " " + formattedPredictionOnDate;
            }
        }
...
var FiFetcher = (function (_super) {
    ...
    FiFetcher.prototype.fetchRootFI = function (_a) {
        var _this = this;
        var newId = _a.newId, context = _a.context, preventPreCleanup = _a.preventPreCleanup;
        var fcId = this.fullApi.fcfrManager.getActiveFCId();
        ...
        this.context.forecastServices.forecastDataAccess.fetchForecastInstances(newId, fcId, [""], pageInfos, snapId).then(function (fiResponse) {
            ...
            if (preventPreCleanup) {
                _this.addMessageBarNotification("error", _this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.FI_GRID_UPDATE_ERROR));
            }
            else {
    ...
    FiFetcher.prototype.fetchChildFiForParentAndPageNo = function (rowId, pageNo, context) {
        ...
        var snapId = this.getSnapshotIdForFiRequest();
        this.stateManager.updatefiChildFetchHadError(rowId, false);
        this.context.forecastServices.forecastDataAccess.fetchForecastInstances(frId, fcId, [rowId], pageInfos, snapId).then(function (fiResponse) {
            ...
            var endRequestTimeStamp = performance.now();
            var sceanrioName = _this.getScenarioNameFromContext(context);
            _this.logPerf("FiFetch", sceanrioName, _this.getPerfDataJson(sceanrioName, endRequestTimeStamp - context.triggerTimeStamp));
        }).catch(function (e) {
            _this.fullApi.fiGrid.fiHierarchy.markChildRecordsFetchComplete({ rowId: rowId });
            _this.stateManager.updatefiChildFetchHadError(rowId, true);
    ...
    FiFetcher.prototype.getScenarioNameFromContext = function (context) {
        var scenarioName = "";
        switch (context.triggerSource) {
            case "on-fc-change":
            case "on-fr-change":
                scenarioName = "FI grid load";
                break;
            case "fi-grid-hierarchy-expand":
                scenarioName = "FI grid hierarchy expand";
                break;
            case "snapshot-grid-hierarchy-expand":
                scenarioName = "Snapshot grid hierarchy expand";
                break;
            case "snapshot-calendar-click":
                scenarioName = "Snapshot grid load";
                break;
            default:
                break;
        }
...
var FiGridApiImpl = (function (_super) {
    ...
    FiGridApiImpl.prototype.onExpandClick = function (rowId) {
        ...
        var triggerSource = "fi-grid-hierarchy-expand";
        if (this.fullApi.fiSnapshot.isSnapshotFiGridPageActive()) {
            triggerSource = "snapshot-grid-hierarchy-expand";
        }
        var context = this.createNewContext(triggerSource);
    ...
    FiGridApiImpl.prototype.onDrillDownCellSelect = function (rowId, colId, context) {
        this.logUsage("Drilldown Grid cell", "", { rowId: rowId, colId: colId }, "Select", "FiGridApiImpl.onDrillDownCellSelect", constants_1.FORECAST_DRILLDOWN_FEATURE_NAME);
    ...
    FiGridApiImpl.prototype.onCellFocus = function (rowId, colId) {
        ...
        if (this.isCellValidForSelect(colId) || (colInfo && colInfo.forecastColumnType === forecastPageTypes_1.ForecastColumnType.Calculated))
            this.stateManager.setFocusedCell({ rowId: rowId, colId: colId });
    };
    FiGridApiImpl.prototype.isCellValidForSelect = function (colId, isDrilldownCell) {
        ...
        if (!colInfo)
            return false;
        var isPredictiveCellValidForSelect = true;
        if (isDrilldownCell && !this.fullApi.global.isUiFcbEnabled("ShowPredictiveEnhancedUX")) {
            isPredictiveCellValidForSelect = false;
        }
        return colInfo.forecastColumnType === forecastPageTypes_1.ForecastColumnType.Rollup || colInfo.forecastColumnType === forecastPageTypes_1.ForecastColumnType.HierarchyPrimary || (colInfo.forecastColumnType === forecastPageTypes_1.ForecastColumnType.Predictive && isPredictiveCellValidForSelect);
    };
    ...
    FiGridApiImpl.prototype.onRefresh = function () {
        var newId = this.fullApi.fcfrManager.getActiveFRId();
        var oldFrId = newId;
        this._reloadFiGrid({ newId: newId, oldFrId: oldFrId, context: this.createNewContext(), preventPreCleanup: true });
    ...
    FiGridApiImpl.prototype._reloadFiGrid = function (args) {
        ...
        this.stateManager.resetfiChildFetchHadErrorDict();
    };
...
var FiRowsSelector = (function (_super) {
    ...
    function FiRowsSelector(context, fullApi) {
        var _this = _super.call(this, context, fullApi) || this;
        _this.hierarchyPrimaryGroupStrTemplate = "{0}";
        _this.hierarchyPrimaryGroupStrTemplate = _this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.OWNER_NAME_GROUP_SMALLCASE);
        return _this;
    }
    FiRowsSelector.prototype.getFiRows = function () {
        ...
        flattenedFiIdList.map(function (_a) {
            var id = _a.id, indentationLevel = _a.indentationLevel, hasMoreChildren = _a.hasMoreChildren, nextPageNo = _a.nextPageNo, hasErrorBelow = _a.hasErrorBelow;
            ...
            var fiRowHadError = hasErrorBelow;
            outP.shouldAddLazyLoadCue = !fiRowHadError && hasMoreChildren;
            outP.lazyLoadNextPageNumber = nextPageNo;
            fiListOutp.push(outP);
            if (fiRowHadError) {
                fiListOutp.push({
                    id: outP.id + "_error",
                    parentId: outP.parentId,
                    cellData: {},
                    isExpanded: false,
                    showExpandIcon: false,
                    indendationLevel: 0,
                    fiGridRowType: forecastPageTypes_1.fiGridRowType.rowLoadErrorMessage
                });
            }
    ...
    FiRowsSelector.prototype.getSimpleAndRollupColumnsFromFC = function (fc) {
        ...
        if (this.fullApi.fiSnapshot.isSnapshotFiGridPageActive()) {
            cols = this.fullApi.fiSnapshot.getSelectedColumnsForGrid(cols);
        }
        ...
        this.getVisibleColumnDefinitions(fc).map(function (col) {
            switch (col.dataType) {
                case forecastPageTypes_1.ForecastColumnDataType.Old:
                    if (col.forecastColumnType == __1.ForecastColumnType.HierarchyPrimary || col.forecastColumnType == __1.ForecastColumnType.HierarchySecondary) {
                        ...
                        outP.cellData[col.id] = {
                            displayValue: fiColumnData && fiColumnData[col.id] && _this.getActiveCurrencyFormattedValue(fiColumnData[col.id].rawValue),
                ...
                case forecastPageTypes_1.ForecastColumnDataType.Integer:
                    {
                        outP.cellData[col.id] = {
                            displayValue: fiColumnData && fiColumnData[col.id] && _this.getNumberFormattedValue(fiColumnData[col.id].rawValue, 0),
                            rawValue: fiColumnData && fiColumnData[col.id] && fiColumnData[col.id].rawValue,
                        };
                        break;
                    }
            ...
            switch (col.forecastColumnType) {
                ...
                case __1.ForecastColumnType.Rollup:
                    {
                        if (fiColumnData[col.id] && fiColumnData[col.id].isEditable && !isFiSnapshotModeEnabled) {
                            ...
                            if (loadingCell.rowId != "" && loadingCell.colId != "" && outP.id == loadingCell.rowId && col.id == loadingCell.colId) {
                                ...
                                if (_this.stateManager.getAdjustedValue() != "") {
                                    outP.cellData[col.id].displayValue = _this.getValueBasedonColumnType(col, Number(_this.stateManager.getAdjustedValue()));
                                    outP.cellData[col.id].rawValue = Number(_this.stateManager.getAdjustedValue());
                                }
                                else {
                                    var oldValue = fiColumnData[col.id].originalValue;
                                    outP.cellData[col.id].displayValue = _this.getValueBasedonColumnType(col, oldValue);
                        ...
                        else if (fiColumnData && fiColumnData[col.id] && fiColumnData[col.id].showHistory && !isFiSnapshotModeEnabled) {
                        ...
                        if (fiColumnData && fiColumnData[col.id] && (fiColumnData[col.id].isManualAdjusted || fiColumnData[col.id].isRollupAdjusted)) {
                            ...
                            if (fiColumnData[col.id].originalValue != null) {
                                outP.cellData[col.id].strikethroughValue = _this.getValueBasedonColumnType(col, fiColumnData[col.id].originalValue);
                            }
                        }
                        if (col.forecastColumnType == __1.ForecastColumnType.Predictive && fiColumnData && fiColumnData[col.id].rawValue == 0) {
                            var predictionStatus = _this.context.stateManager.fcCharts.getPredictionStatusForFC(_this.fullApi.fcfrManager.getActiveFCId());
                            if (!predictionStatus || !predictionStatus.PredictionOn) {
                                outP.cellData[col.id] = {
                                    displayValue: "--"
                                };
                ...
                case __1.ForecastColumnType.HierarchyPrimary: {
                    ...
                    if (outP.showExpandIcon) {
                        outP.cellData[col.id].displayValue = _this.hierarchyPrimaryGroupStrTemplate.replace("{0}", outP.cellData[col.id].displayValue);
                    }
                }
            }
            if ((col.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency || col.dataType == forecastPageTypes_1.ForecastColumnDataType.Integer || col.dataType == forecastPageTypes_1.ForecastColumnDataType.Decimal)
                && col.showProgressComparedToQuota && fiColumnData && fiColumnData[col.id]) {
    ...
    FiRowsSelector.prototype.addChildRowsBelowExpandedRows = function () {
        ...
        childDict[""] && childDict[""].map(function (fiId) {
            treeListFlattener_1.flattenListHelper(fiId, 0, results, isExpandDict, childDict, pageInfoDict, _this.stateManager.getfiChildFetchHadErrorDict());
        });
        return results;
    };
...
function flattenListHelper(current, depth, results, isExpandedDict, childrenDict, pageInfoDict, fiChildFetchHadErrorDict) {
    ...
    if (isExpandedDict[current]) {
        childrenDict[current] && childrenDict[current].map(function (childId) {
            flattenListHelper(childId, depth + 1, results, isExpandedDict, childrenDict, pageInfoDict, fiChildFetchHadErrorDict);
        });
        ...
        if (fiChildFetchHadErrorDict[current]) {
            exports.isTraversingComplete = false;
            results[results.length - 1].hasErrorBelow = true;
        }
    }
}
...
var FcWebResourcesApiImpl_1 = __webpack_require__(/*! ./customScriptInjection/FcWebResourcesApiImpl */ "./src/ForecastPageUiApi/customScriptInjection/FcWebResourcesApiImpl.ts");
var pivotManager_1 = __webpack_require__(/*! ./PivotManager/pivotManager */ "./src/ForecastPageUiApi/PivotManager/pivotManager.ts");
var MultiCurrencyManager_1 = __webpack_require__(/*! ./multiCurrencyManager/MultiCurrencyManager */ "./src/ForecastPageUiApi/multiCurrencyManager/MultiCurrencyManager.ts");
var ForecastPageUiApi = (function () {
    function ForecastPageUiApi(contextServices, onReRender, stateManager) {
        ...
        this.fcWebResourcesApi = new FcWebResourcesApiImpl_1.FcWebResourcesApiImpl(context, this);
        this.multiCurrencyManager = new MultiCurrencyManager_1.MultiCurrencyManager(context, this);
        this.initLogging();
    }
...
var GlobalStateManager = (function (_super) {
    ...
    GlobalStateManager.prototype.shouldRenderNoWorkflowsMessage = function () {
        return this.fullApi.fcfrManager.forecastActionWorkflowNotEnabled;
    };
    ...
    GlobalStateManager.prototype.getActiveCurrencySymbol = function () {
        return this.fullApi.multiCurrencyManager.getActiveCurrency().CurrencySymbol;
    };
    GlobalStateManager.prototype.getActiveCurrencyUpdatedValue = function (value) {
        return value * this.fullApi.multiCurrencyManager.getActiveCurrency().ExchangeRate;
    };
    GlobalStateManager.prototype.getActiveCurrencyFormattedValueWrapper = function (value) {
        return this.getActiveCurrencyFormattedValue(value);
    };
    GlobalStateManager.prototype.getNumberFormattedValueWrapper = function (value, precision) {
        return this.getNumberFormattedValue(value, precision);
    };
    GlobalStateManager.prototype.getCurrencyFormattedValueWrapper = function (value) {
        return this.getCurrencyFormattedValue(value);
    };
    GlobalStateManager.prototype.getWholeNumberFormattedValue = function (value) {
        return this.getNumberFormattedValue(value, 0);
    };
    ...
    GlobalStateManager.prototype.getUCHostContext = function () {
        return this.context.forecastServices.hostContext;
    };
    GlobalStateManager.prototype.shouldRenderTabControl = function () {
        return !this.fullApi.fiSnapshot.isSnapshotFiGridPageActive()
            && this.getInsightsFeaturesVisible()
            && this.getSIPackageInstalled()
            && ((this.fullApi.fcfrManager.getActiveFC() && this.fullApi.fcfrManager.getActiveFC().isSnapshotScheduled)
                || this.fullApi.fiSnapshot.getLatestSnapshot() != undefined);
    };
    ...
    GlobalStateManager.prototype._fetchClientMetaData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var date, clientMetaData, currentDate;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.logDebug("fetching client meta data", constants_1.MULTI_CURRENCY_FEATURE_NAME);
                        date = new Date();
                        return [4, this.context.forecastServices.forecastDataAccess.fetchClientMetaData()];
                    case 1:
                        clientMetaData = _a.sent();
                        this.fullApi.multiCurrencyManager.updateCurrencyList(clientMetaData.Currencies);
                        this.fullApi.multiCurrencyManager.updateBaseCurrencyId(clientMetaData.BaseCurrencyId);
                        this.fullApi.multiCurrencyManager.updateUserCurrencyId(clientMetaData.UserCurrencyId);
                        currentDate = new Date();
                        this.logDebug("fetching client meta data completed in ms:", (date.getMilliseconds() - currentDate.getMilliseconds()).toString(), constants_1.MULTI_CURRENCY_FEATURE_NAME);
                        return [2];
                }
            });
        });
...
var KanbanApiImpl = (function (_super) {
    ...
    KanbanApiImpl.prototype.getKanbanProps = function () {
        ...
        var activeCurrencyForKanban = this.getActiveCurrencyForKanban();
        var memoKey = this.getMemoKey(cell.rowId, activeCurrencyForKanban);
        if (this.memoProps[memoKey])
            return this.memoProps[memoKey];
        this.memoProps = {};
        var kanbanInfo = {
        ...
        var fc = this.fullApi.fcfrManager.getActiveFC();
        var kanbanProps = this.containerWrapper.getKanbanProps(kanbanInfo, fc, activeCurrencyForKanban);
        this.memoProps[memoKey] = kanbanProps;
        kanbanProps.eventHandlerCallbacks = this.getEventHandlerCallbacks(fc);
        return kanbanProps;
    };
    KanbanApiImpl.prototype.getActiveCurrencyForKanban = function () {
        var activeCurrency = this.fullApi.multiCurrencyManager.getActiveCurrency();
        return {
            transactionCurrencyId: activeCurrency.TransactionCurrencyId,
            currencyName: activeCurrency.CurrencyName,
            currencySymbol: activeCurrency.CurrencySymbol,
            currencyCode: activeCurrency.IsoCurrencyCode,
            currencyPrecision: activeCurrency.CurrencyPrecision,
            exchangeRate: activeCurrency.ExchangeRate
        };
    };
    KanbanApiImpl.prototype.getMemoKey = function (rowId, activeCurrency) {
        return rowId + "_" + activeCurrency.currencyCode;
    };
    ...
    KanbanApiImpl.prototype.isKanbanLoading = function () {
        if (this.fullApi.fiGrid.isGridLoading())
            return true;
...
var KanbanWrapperContainer = (function () {
    ...
    KanbanWrapperContainer.prototype.getKanbanProps = function (kanbanBoardInfo, forecastConfigInfo, activeCurrency) {
        var _this = this;
        ...
        var laneSet = new Set();
        var dupColumnsSelectorMap = this.getDuplicateSelectorDatatype(forecastConfigInfo);
        pipelineRecordsFetchXmlResponse.ForecastConfigurationColumns.forEach(function (item, index) {
            ...
            if (!_this.doesColumnBelongsToSelectedDatatype(item, forecastConfigInfo, dupColumnsSelectorMap)) {
                return;
            }
            if (!laneSet.has(item.ColumnOptionSetValue)) {
                ...
                if (!_this.isCurrencyColumn(forecastConfigInfo, item)) {
                    activeCurrency = null;
                }
                kanbanProps.lanes.push({
                    ...
                    aggregateProps: {
                        ...
                        currencyFormattingInfo: activeCurrency
                    },
    ...
    KanbanWrapperContainer.prototype.isCurrencyColumn = function (forecastConfigInfo, item) {
        var columns = forecastConfigInfo.gridMetadata.columnDefinitions;
        var column = columns.find(function (column) { return column.id == item.ColumnId; });
        if (column && column.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency)
            return true;
        return false;
    };
    KanbanWrapperContainer.prototype.getDuplicateSelectorDatatype = function (forecastConfigInfo) {
        var selectedDatatype = forecastConfigInfo.advancedsettings && forecastConfigInfo.advancedsettings.SelectedDownStreamPrimaryDataType ? forecastConfigInfo.advancedsettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        var columns = forecastConfigInfo.gridMetadata.columnDefinitions;
        columns = columns.filter(function (column) { return column.forecastColumnType == forecastPageTypes_1.ForecastColumnType.Rollup; });
        if (selectedDatatype === forecastPageTypes_1.DownStreamPrimaryDataType.Currency) {
            columns = columns.filter(function (item) { return item.dataType === forecastPageTypes_1.ForecastColumnDataType.Currency; });
        }
        else if (selectedDatatype === forecastPageTypes_1.DownStreamPrimaryDataType.Quantity) {
            columns = columns.filter(function (item) { return item.dataType === forecastPageTypes_1.ForecastColumnDataType.Decimal || item.dataType === forecastPageTypes_1.ForecastColumnDataType.Integer; });
        }
        return this.getDuplicateSelectorColumns(columns);
    };
    KanbanWrapperContainer.prototype.getDuplicateSelectorColumns = function (columns) {
        var allSelectorColumns = {};
        var duplicateSelectorColumns = {};
        columns.forEach(function (column) {
            if (column.optionSetValue || column.optionSetValue == 0) {
                if (allSelectorColumns[column.optionSetValue]) {
                    allSelectorColumns[column.optionSetValue].push(column.id);
                }
                else {
                    allSelectorColumns[column.optionSetValue] = [column.id];
                }
            }
        });
        Object.keys(allSelectorColumns).forEach(function (col) {
            if (allSelectorColumns[col].length > 1) {
                duplicateSelectorColumns[col] = allSelectorColumns[col];
            }
        });
        return duplicateSelectorColumns;
    };
    ...
    KanbanWrapperContainer.prototype.doesColumnBelongsToSelectedDatatype = function (item, forecastConfigInfo, dupColumnsSelectorMap) {
        var selectedDatatype = forecastConfigInfo.advancedsettings && forecastConfigInfo.advancedsettings.SelectedDownStreamPrimaryDataType ? forecastConfigInfo.advancedsettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        var selectedDuplicateColumns = forecastConfigInfo.advancedsettings && forecastConfigInfo.advancedsettings.SelectedDuplicateColumns ? forecastConfigInfo.advancedsettings.SelectedDuplicateColumns : [];
        var forecastColumn = forecastConfigInfo.gridMetadata.columnDefinitions.find(function (column) { return column.id == item.ColumnId; });
        if (forecastColumn) {
            if (selectedDatatype == forecastPageTypes_1.DownStreamPrimaryDataType.Currency && forecastColumn.dataType !== forecastPageTypes_1.ForecastColumnDataType.Currency)
                return false;
            else if (selectedDatatype == forecastPageTypes_1.DownStreamPrimaryDataType.Quantity && (forecastColumn.dataType !== forecastPageTypes_1.ForecastColumnDataType.Decimal && forecastColumn.dataType !== forecastPageTypes_1.ForecastColumnDataType.Integer))
                return false;
            if (dupColumnsSelectorMap[item.ColumnOptionSetValue]) {
                return selectedDuplicateColumns.includes(item.ColumnId);
            }
            return true;
        }
        return false;
...
/***/ "./src/ForecastPageUiApi/multiCurrencyManager/MultiCurrencyManager.ts":
/*!****************************************************************************!*\
  !*** ./src/ForecastPageUiApi/multiCurrencyManager/MultiCurrencyManager.ts ***!
  \****************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MultiCurrencyManager = void 0;
var baseUiApi_1 = __webpack_require__(/*! ../common/baseUiApi */ "./src/ForecastPageUiApi/common/baseUiApi.ts");
var forecastPageTypes_1 = __webpack_require__(/*! ../../Interface/forecastPageTypes */ "./src/Interface/forecastPageTypes.ts");
var guidUtils_1 = __webpack_require__(/*! ../../Utility/guidUtils */ "./src/Utility/guidUtils.ts");
var constants_1 = __webpack_require__(/*! ../common/constants */ "./src/ForecastPageUiApi/common/constants.ts");
var MultiCurrencyManager = (function (_super) {
    __extends(MultiCurrencyManager, _super);
    function MultiCurrencyManager(context, fullApi) {
        var _this = _super.call(this, context, fullApi) || this;
        _this.stateManager = _this.context.stateManager.multiCurrency;
        return _this;
    }
    MultiCurrencyManager.prototype.currencyListItemSelector = function (currencyList) {
        var _this = this;
        var currencyListItem = [];
        currencyList.map(function (currency) { return __awaiter(_this, void 0, void 0, function () {
            var currencyItem;
            return __generator(this, function (_a) {
                currencyItem = {};
                currencyItem.id = currency.TransactionCurrencyId;
                currencyItem.title = currency.CurrencyName;
                currencyItem.IsoCurrencyCode = currency.IsoCurrencyCode;
                currencyItem.CurrencySymbol = currency.CurrencySymbol;
                currencyItem.ExchangeRate = currency.ExchangeRate;
                currencyItem.isActive = currency.TransactionCurrencyId == this.getActiveCurrencyId();
                currencyListItem.push(currencyItem);
                return [2];
            });
        }); });
        this.logDebug("currencyListItemSelector", "", { currencyListItem: currencyListItem }, "MultiCurrencyManager.currencyListItemSelector", constants_1.MULTI_CURRENCY_FEATURE_NAME);
        return currencyListItem;
    };
    MultiCurrencyManager.prototype.updateCurrencyList = function (currencyList) {
        this.stateManager._updateCurrencyList(currencyList);
    };
    MultiCurrencyManager.prototype.initializeCurrency = function () {
        return __awaiter(this, void 0, void 0, function () {
            var mruCurrencyID, mruCurrency, initialCurrencyId, context;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.context.forecastServices.mruInfoProvider.getMRU_ID("msdyn_gridCurrency")];
                    case 1:
                        mruCurrencyID = _a.sent();
                        mruCurrency = mruCurrencyID && this.stateManager.getCurrencyList().find(function (c) { return c.TransactionCurrencyId === mruCurrencyID; });
                        initialCurrencyId = mruCurrency ? mruCurrency.TransactionCurrencyId : this.stateManager.getBaseCurrencyId();
                        context = this.createNewContext("initial-currency");
                        this.logDebug("initial currency", "", __assign({ mruCurrencyID: mruCurrencyID, initialCurrencyId: initialCurrencyId }, context), "MultiCurrencyManager.setInitialCurrency", constants_1.MULTI_CURRENCY_FEATURE_NAME);
                        this._onCurrencyChange(initialCurrencyId);
                        return [2];
                }
            });
        });
    };
    MultiCurrencyManager.prototype.updateBaseCurrencyId = function (id) {
        this.stateManager._updateBaseCurrencyId(id);
        this.initializeCurrency();
    };
    MultiCurrencyManager.prototype.updateUserCurrencyId = function (id) {
        this.stateManager._updateUserCurrencyId(id);
    };
    MultiCurrencyManager.prototype.getBaseCurrencyId = function () {
        return this.stateManager.getBaseCurrencyId();
    };
    MultiCurrencyManager.prototype.getUserCurrencyId = function () {
        return this.stateManager.getUserCurrencyId();
    };
    MultiCurrencyManager.prototype.getCurrencyList = function () {
        return this.currencyListItemSelector(this.stateManager.getCurrencyList());
    };
    MultiCurrencyManager.prototype.getActiveCurrencyId = function () {
        var activeCurrency = this.getActiveCurrency();
        return activeCurrency && this.getActiveCurrency().TransactionCurrencyId;
    };
    MultiCurrencyManager.prototype.getActiveCurrency = function () {
        if (this.getBaseCurrencyId() == forecastPageTypes_1.EMPTY_GUID) {
            return this.getEmptyCurrency();
        }
        else if (this.isMultiCurrencyDropDownEnabled()) {
            return this.stateManager.getActiveCurrency();
        }
        return this.stateManager.getBaseCurrency();
    };
    MultiCurrencyManager.prototype.getEmptyCurrency = function () {
        return {
            TransactionCurrencyId: guidUtils_1.GuidUtils.NewGuid(),
            CurrencyName: "",
            CurrencySymbol: "",
            ExchangeRate: 1,
            CurrencyPrecision: 2,
    ...
    MultiCurrencyManager.prototype.isMultiCurrencyDropDownEnabled = function () {
        var _a, _b;
        var fc = this.fullApi.fcfrManager.getActiveFC();
        return (_b = (_a = fc === null || fc === void 0 ? void 0 : fc.advancedsettings) === null || _a === void 0 ? void 0 : _a.Options) === null || _b === void 0 ? void 0 : _b.isMultiCurrencySelectionEnabled;
    };
    MultiCurrencyManager.prototype.onCurrencyChange = function (newId) {
        var context = this.createNewContext("on-currency-change");
        this.logUsage("currency selector", "", __assign({ newId: newId }, context), "Change", "MultiCurrencyManager.onCurrencyChange", constants_1.MULTI_CURRENCY_FEATURE_NAME);
        this._onCurrencyChange(newId);
    };
    MultiCurrencyManager.prototype._onCurrencyChange = function (newId) {
        this.context.forecastServices.mruInfoProvider.setMRU_ID("msdyn_gridCurrency", newId);
        this.stateManager.updateActiveCurrencyId(newId);
    };
    return MultiCurrencyManager;
}(baseUiApi_1.BaseUiApi));
exports.MultiCurrencyManager = MultiCurrencyManager;
...
var NearRealTimeApiImpl = (function (_super) {
    ...
    NearRealTimeApiImpl.prototype.clearNotifications = function () {
        this.context.forecastServices.nrtToastNotificationsManager.clearNotifications();
    };
    NearRealTimeApiImpl.prototype.setMessageBarErrorNotification = function () {
        var notificationMessage = this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.RECOMPUTE_FAILURE_MESSAGE);
        var msgType = "error";
...
var PartRecordGridApiImpl = (function (_super) {
    ...
    PartRecordGridApiImpl.prototype.onRecordSaved = function (recordId, hierarchyLinkedAtttributeId, optionSetValue, changes, context) {
        ...
        if (this.stateManager.getGridMode() === partRecordStateManager_1.ForecastPartGridMode.ShowBy) {
            this.setCannotUpdateRealTimeWarningMessage();
        }
    };
    ...
    PartRecordGridApiImpl.prototype._retrievePartRecordFetchXml = function (rowId, colId, viewD, context) {
        return __awaiter(this, void 0, void 0, function () {
            var viewId, cacheFetchXml, forecastPivotId, isAgg, rowType, colInfo, colIdForFetch, isPersonalView, viewFetchXml, partFetchXml, forecastPivotId, fiId, drilldownInstanceId, fiId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        viewId = viewD.id;
                        ...
                        if (this.isDrillDownRowOrCellSelected()) {
                            ...
                            cacheFetchXml = this.stateManager.getIsPartRecFetchXml(rowId, colId, viewId, forecastPivotId);
                        }
                        if (cacheFetchXml) {
                    ...
                    case 1:
                        partFetchXml = _a.sent();
                        this.logInfo("PartRecordFetchXmlFetcherForDrilldown", "fetchXml fetch complete", __assign({}, context), "partrec-fetchxml-fetch-success");
                        this.stateManager.setIsPartRecFetchXml(rowId, colId, viewId, partFetchXml, forecastPivotId);
                        return [3, 4];
                    case 2:
    ...
    PartRecordGridApiImpl.prototype.setCannotUpdateRealTimeWarningMessage = function () {
        var notificationMessage = this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.CANNOT_UPDATE_REALTIME_UNDERLYING);
        var msgType = "warning";
        this.addMessageBarNotification(msgType, notificationMessage);
    };
...
var PartRecordViewerApiImpl = (function (_super) {
        ...
        if (isDealFlowPageMode) {
            ...
            if (col && col.forecastColumnType == sharedEnums_1.ForecastColumnType.Rollup) {
                if (this.isDrillDownRowOrCellSelected()) {
                    ...
                    if (cellData) {
                        outP.formattedAmount = this.getValueBasedonColumnType(col, Number(cellData.value));
                    }
                }
                else {
                    ...
                    if (cellData && cellData[cell.colId]) {
                        outP.formattedAmount = this.getValueBasedonColumnType(col, Number(cellData[cell.colId].originalValue));
                    }
                }
    ...
    PartRecordViewerApiImpl.prototype.onCloseClick = function (resetCell) {
        if (resetCell === void 0) { resetCell = true; }
        ...
        if (this.fullApi.global.getForecastPageMode() != forecastPageTypes_1.ForecastPageMode.DealFlow && resetCell) {
            this.fullApi.fiGrid._clearSelectedCell();
            this.fullApi.pivotManager.clearSelectedCell();
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        if (this.fullApi.drillDownGridApi.isAnyDrillDownExpanded()) {
                            this.showDrillDownNeedsManualRefreshMsg();
                            this.fullApi.drillDownGridApi.markDrilldownsForRefresh();
                        }
                        fcId = this.fullApi.fcfrManager.getActiveFCId();
    ...
    PartRecordViewerApiImpl.prototype.getFcColumnsFromOptionSetValue = function (optionSetValue) {
        var fc = this.context.stateManager.fcFr.getActiveFc();
        var cols = fc.gridMetadata.columnDefinitions.filter(function (col) { return (col.optionSetValue === optionSetValue && col.forecastColumnType === sharedEnums_1.ForecastColumnType.Rollup); });
    ...
    PartRecordViewerApiImpl.prototype.deriveDeltaRecomputeColumnIdsAndHierarchyIDs = function (optionSetValue, hierarchyLinkedAtttributeId, changes) {
        var _this = this;
        var fc = this.context.stateManager.fcFr.getActiveFc();
        var colIDs = this.getFcColumnsFromOptionSetValue(optionSetValue);
        ...
        changes.forEach(function (val, key) {
            if (key === attrOptionSet) {
                if (optionSetValue !== val.peviousValue) {
                    var previousColIds = _this.getFcColumnsFromOptionSetValue(val.peviousValue);
                    colIDs = __spreadArrays(colIDs, previousColIds);
                }
            }
    ...
    PartRecordViewerApiImpl.prototype.checkIfAllCallsCompleted = function () {
        if (this.numActiveDeltaRecomputeCalls <= 0) {
            if (this.didAnyDeltaRecomputeCallFailed) {
                var msg = this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.UNDERLYING_CHANGE_RECOMPUTE_ERROR);
                this.addMessageBarNotification("error", msg);
            }
            this.context.stateManager.nrt.setRibbonConfig(forecastPageTypes_1.RealtimeNotificationTypes.Initial);
            this.didAnyDeltaRecomputeCallFailed = false;
        }
    };
    PartRecordViewerApiImpl.prototype.showDrillDownNeedsManualRefreshMsg = function () {
        var notificationMessage = this.context.forecastServices.stringsProvider.getLocalizedString(sharedEnums_1.DrillDownUnderlyingNotReflected);
        var msgType = "warning";
        this.addMessageBarNotification(msgType, notificationMessage);
    };
...
var SnapshotApiImpl = (function (_super) {
    ...
    SnapshotApiImpl.prototype.getDealFlowChartData = function () {
        ...
        var advSettings = this.fullApi.fcfrManager.getActiveFC().advancedsettings;
        if (!advSettings || (advSettings && advSettings.SelectedDownStreamPrimaryDataType !== forecastPageTypes_1.DownStreamPrimaryDataType.Quantity))
            return this.updateDealFlowChartDataForActiveCurrency(chartData);
        return chartData;
    };
    SnapshotApiImpl.prototype.updateDealFlowChartDataForActiveCurrency = function (chartData) {
        var _this = this;
        var currencySymbol = this.fullApi.global.getActiveCurrencySymbol();
        if (chartData) {
            var chartData11 = JSON.parse(JSON.stringify(chartData));
            chartData11.Nodes.forEach(function (node) {
                var abbreviatedValue = stringUtility_1.abbreviateNumber(Number(_this.fullApi.global.getActiveCurrencyUpdatedValue(node.value)), 1, currencySymbol);
                node.abbreviatedValue = abbreviatedValue ? abbreviatedValue : node.value.toString();
                node.formattedValue = _this.getActiveCurrencyFormattedValue(Number(node.value));
            });
            chartData11.Edges.forEach(function (edge) {
                var abbreviatedValue = stringUtility_1.abbreviateNumber(_this.fullApi.global.getActiveCurrencyUpdatedValue(edge.value), 1, currencySymbol);
                edge.abbreviatedValue = abbreviatedValue ? abbreviatedValue : edge.value.toString();
            });
            chartData11.AggregateData.forEach(function (aggregateNode) {
                var abbreviatedValue = stringUtility_1.abbreviateNumber(_this.fullApi.global.getActiveCurrencyUpdatedValue(Number(aggregateNode.value)), 1, currencySymbol);
    ...
    SnapshotApiImpl.prototype.getDealFlowGridRows = function () {
        ...
        return this.stateManager.getDfGridData().map(function (row) {
            return __assign(__assign({}, row), { S1DataValue: _this.getFormattedValueForSelectedDataTypeFromColId(row.S1DataValue, row.S1CategoryId), S2DataValue: _this.getFormattedValueForSelectedDataTypeFromColId(row.S2DataValue, row.S2CategoryId), S1TargetDate: row.S1TargetDate && _this.getDateFormattedValue(new Date(row.S1TargetDate)), S2TargetDate: row.S2TargetDate && _this.getDateFormattedValue(new Date(row.S2TargetDate)) });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this._getLatestSnapshotStatusForActiveFC();
                        if (this.fullApi.global.getForecastPageMode() !== forecastPageTypes_1.ForecastPageMode.FIGrid)
    ...
    SnapshotApiImpl.prototype.fetchSnapshotList = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, showSnapshotEnhandedUX, fcId, frId, snapshots, timeStampRequestEnd, scenarioName, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        timeStampRequestStart = performance.now();
                    ...
                    case 2:
                        ...
                        this.setDefaultSnapshotSelection(context);
                        timeStampRequestEnd = performance.now();
                        scenarioName = "Forecast - Snapshot calendar";
                        this.logPerf("SnapshotlistFetcher", scenarioName, this.getPerfDataJson(scenarioName, timeStampRequestEnd - timeStampRequestStart));
                        return [3, 4];
                    case 3:
                        e_2 = _a.sent();
    ...
    SnapshotApiImpl.prototype._triggerChartDataFetch = function (fiId, forecastInstanceGroupType, context) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, forecastConfig, fcId, frId, mainSnapId, secondSnapId, advSettings, selectedDataType, baseCurrencySymbol_1, chartData, timeStampRequestEnd, scenarioName, e_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        advSettings = forecastConfig.advancedsettings;
                        selectedDataType = advSettings && advSettings.SelectedDownStreamPrimaryDataType ? forecastConfig.advancedsettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
                        baseCurrencySymbol_1 = selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Currency ? this.fullApi.global.getActiveCurrencySymbol() : "";
                        this.stateManager.setChartData({ Nodes: [], Edges: [], AggregateData: [], RollupEntityName: forecastConfig.rollupEntity });
                        return [4, this.context.forecastServices.forecastDataAccess.fetchDeaFlowData(frId, fcId, mainSnapId, secondSnapId, fiId, forecastInstanceGroupType, selectedDataType)];
                    case 1:
                        chartData = _a.sent();
                        ...
                        chartData.Nodes.forEach(function (node) {
                            ...
                            node.abbreviatedValue = abbreviatedValue ? abbreviatedValue : node.value.toString();
                            node.formattedValue = _this.getFormattedValueForSelectedDataTypeFromColId(node.value, node.key);
                        });
                        ...
                        chartData.AggregateData.forEach(function (aggregateNode) {
                            ...
                            aggregateNode.abbreviatedValue = abbreviatedValue ? abbreviatedValue : aggregateNode.value;
                            aggregateNode.value = _this.getFormattedValueForAggregateNode(Number(aggregateNode.value), chartData.Nodes);
                        });
                        ...
                        timeStampRequestEnd = performance.now();
                        scenarioName = "Forecast - Deal flow";
                        this.logPerf("DealFlowFetcher", scenarioName, this.getPerfDataJson(scenarioName, timeStampRequestEnd - timeStampRequestStart));
                        return [3, 3];
                    case 2:
                        e_3 = _a.sent();
    ...
    SnapshotApiImpl.prototype._triggerGridDataFetch = function (pageOffset, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var timeStampRequestStart, fcId, mainSnapId, secondSnapId, nodeInfo, edgeInfo, isNodeDatFetch, pageInfo, srcCategoryDetails, destCategoryDetails, dfEntityDataRequest, fiId, isAgg, rowType, gridData, expectedCurrentSize, timeStampRequestEnd, scenarioName, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        timeStampRequestStart = performance.now();
                    ...
                    case 2:
                        ...
                        this.setGridDataFetchStatus(forecastPageTypes_1.Status.Success);
                        timeStampRequestEnd = performance.now();
                        scenarioName = "Forecast - Deal flow underlying records";
                        this.logPerf("Dealflowgriddatafetcher", scenarioName, this.getPerfDataJson(scenarioName, timeStampRequestEnd - timeStampRequestStart));
                        return [3, 4];
                    case 3:
                        _a = _b.sent();
                        this.stateManager.setIsDFGridLoading(false);
    ...
    SnapshotApiImpl.prototype.onIncludedRecordClick = function (entityId) {
        ...
        try {
            ...
            this.openEntityFormInDialog(entityFormOptions.entityName, entityFormOptions.entityId);
        }
        catch (err) {
            this.logError("SnapshotApi", err, "Error opening the record. Either record was deleted or does not exist.");
        }
    };
    SnapshotApiImpl.prototype.getFormattedValueForSelectedDataTypeFromColName = function (val, colName) {
        var advSettings = this.fullApi.fcfrManager.getActiveFC().advancedsettings;
        var selectedDataType = advSettings && advSettings.SelectedDownStreamPrimaryDataType ? advSettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        if (selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Quantity) {
            var columnType = this.getColumnTypeFromColName(colName);
            var precision = columnType == forecastPageTypes_1.ForecastColumnDataType.Decimal ? 1 : 0;
            return this.getNumberFormattedValue(val, precision);
        }
        else {
            return this.getActiveCurrencyFormattedValue(val);
        }
    };
    SnapshotApiImpl.prototype.getFormattedValueForSelectedDataTypeFromColId = function (val, colId) {
        var advSettings = this.fullApi.fcfrManager.getActiveFC().advancedsettings;
        var selectedDataType = advSettings && advSettings.SelectedDownStreamPrimaryDataType ? advSettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        if (selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Quantity) {
            var columnType = this.getColumnTypeFromColId(colId);
            var precision = columnType && columnType == forecastPageTypes_1.ForecastColumnDataType.Decimal ? 1 : 0;
            return this.getNumberFormattedValue(val, precision);
        }
        else {
            return this.getActiveCurrencyFormattedValue(val);
    ...
    SnapshotApiImpl.prototype.getFormattedValueForAggregateNode = function (val, nodes) {
        var _this = this;
        var advSettings = this.fullApi.fcfrManager.getActiveFC().advancedsettings;
        var selectedDataType = advSettings && advSettings.SelectedDownStreamPrimaryDataType ? advSettings.SelectedDownStreamPrimaryDataType : forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        if (selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Quantity) {
            var isDecimal = nodes.some(function (node) {
                return _this.getColumnTypeFromColId(node.key) == forecastPageTypes_1.ForecastColumnDataType.Decimal;
            });
            var precision = isDecimal ? 1 : 0;
            return this.getNumberFormattedValue(val, precision);
        }
        return val.toString();
    };
    SnapshotApiImpl.prototype.getColumnTypeFromColId = function (colId) {
        var columns = this.fullApi.fcfrManager.getActiveFC().gridMetadata.columnDefinitions;
    ...
    SnapshotApiImpl.prototype.getColumnTypeFromColName = function (colName) {
        var columns = this.fullApi.fcfrManager.getActiveFC().gridMetadata.columnDefinitions;
        return columns.find(function (col) {
            return col.uniqueName == colName;
        }).dataType;
    };
    ...
    SnapshotApiImpl.prototype._getLatestSnapshotStatusForActiveFC = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fcId, snapshotStatus, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fcId = this.fullApi.fcfrManager.getActiveFCId();
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.context.forecastServices.forecastDataAccess.fetchSnapshotStatusForFC(fcId)];
                    case 2:
                        snapshotStatus = _a.sent();
                        this.stateManager.setSnapshotStatusForActiveFC(snapshotStatus);
                        return [3, 4];
                    case 3:
                        err_1 = _a.sent();
                        this.logError("SnapshotApi", err_1, "Error fetching snapshot status");
                        return [3, 4];
                    case 4: return [2];
                }
            });
...
var SnapshotFiGridApiImpl = (function (_super) {
    ...
    SnapshotFiGridApiImpl.prototype.onNewRibbonButtonClick = function (snapId) {
        var context = this.createNewContext("snapshot-calendar-click");
        this.logUsage("SnapshotDatePicker", "", __assign({ snapId: snapId }, context), "Click", "SnapshotFiGridApiImpl.onNewRibbonButtonClick", constants_1.FISNAPSHOT_FEATURE_NAME);
    ...
    SnapshotFiGridApiImpl.prototype.getIsSnapshotDisabledStatus = function () {
        var fcInfo = this.fullApi.fcfrManager.getActiveFC();
        var isSnapScheduled = fcInfo ? fcInfo.isSnapshotScheduled : false;
        var snapshotDisabledStatus = {
            isSnapshotDisabled: false,
            disabledOnDate: " "
        };
        var latestSnapshot = this.getLatestSnapshot();
        if (!isSnapScheduled && latestSnapshot) {
            var disabledOnDatestr = latestSnapshot.createdOn;
            var disabledOnDate = new Date(disabledOnDatestr.split("T")[0]);
            disabledOnDate.setDate(disabledOnDate.getDate() + 1);
            if (disabledOnDate) {
                snapshotDisabledStatus.isSnapshotDisabled = true;
                snapshotDisabledStatus.disabledOnDate = this.getDateFormattedValue(disabledOnDate);
            }
        }
        return snapshotDisabledStatus;
    };
    SnapshotFiGridApiImpl.prototype.getLatestSnapshotStatus = function () {
        return this.stateManager.getSnapshotStatusForActiveFC();
    };
    SnapshotFiGridApiImpl.prototype.getSelectedColumnsForGrid = function (allColumns) {
        var fcInfo = this.fullApi.fcfrManager.getActiveFC();
        var advSettings = fcInfo.advancedsettings;
        var selectedDataType = forecastPageTypes_1.DownStreamPrimaryDataType.Currency;
        if (advSettings && advSettings.SelectedDownStreamPrimaryDataType) {
            selectedDataType = advSettings.SelectedDownStreamPrimaryDataType;
        }
        var allColumnsOfDownStreamDataType = allColumns;
        var duplicateOptionSet = new Set();
        var nonDuplicateColumns = new Set();
        var columnsWithUserSelection = [];
        allColumnsOfDownStreamDataType.forEach(function (column) {
            if (!nonDuplicateColumns.has(column.optionSetValue) || column.optionSetValue == 0) {
                nonDuplicateColumns.add(column.optionSetValue);
            }
            else {
                duplicateOptionSet.add(column.optionSetValue);
            }
        });
        allColumnsOfDownStreamDataType.forEach(function (col) {
            if (!duplicateOptionSet.has(col.optionSetValue)) {
                columnsWithUserSelection.push(col);
            }
        });
        var userSelectedColumnIds = fcInfo.advancedsettings ? fcInfo.advancedsettings.SelectedDuplicateColumns : undefined;
        var userSelectedColumns = [];
        if (userSelectedColumnIds) {
            allColumnsOfDownStreamDataType.forEach(function (col) {
                if (userSelectedColumnIds.includes(col.id)) {
                    userSelectedColumns.push(col);
                }
            });
        }
        columnsWithUserSelection.push.apply(columnsWithUserSelection, userSelectedColumns);
        return columnsWithUserSelection;
    };
    ...
    SnapshotFiGridApiImpl.prototype.getAllColumnsOfDownStreamDataType = function (allColumns, selectedDataType) {
        var _this = this;
        var allColumnsOfDownStreamDataType = [];
        if (selectedDataType == forecastPageTypes_1.DownStreamPrimaryDataType.Quantity) {
            allColumns.forEach(function (col) {
                if (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Decimal || col.dataType == forecastPageTypes_1.ForecastColumnDataType.Integer || _this.isHierarchyColumn(col)) {
                    allColumnsOfDownStreamDataType.push(col);
                }
            });
        }
        else {
            allColumns.forEach(function (col) {
                if (col.dataType == forecastPageTypes_1.ForecastColumnDataType.Currency || _this.isHierarchyColumn(col)) {
                    allColumnsOfDownStreamDataType.push(col);
                }
            });
        }
        return allColumnsOfDownStreamDataType;
    };
    SnapshotFiGridApiImpl.prototype.isHierarchyColumn = function (col) {
        return col.forecastColumnType == forecastPageTypes_1.ForecastColumnType.HierarchyPrimary || col.forecastColumnType == forecastPageTypes_1.ForecastColumnType.HierarchySecondary;
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ERROR_IN_FETCHING_FORECAST_INSIGHTS = exports.NO_INSIGHTS_FOR_SPECIFIED_KEY = exports.PredictionDetailsTabRenderMode = exports.NullCrmDatasetInfo = exports.EMPTY_GUID = exports.ForecastInstanceColumnGroupType = exports.DEALFLOW_PAGE_SIZE = exports.DRILLDOWN_PAGE_SIZE = exports.PAGE_SIZE = exports.FORCERECOMPUTE_FAILURE_MESSAGE = exports.RECOMPUTE_INPROGRESS_STATUSCODE = exports.RECOMPUTE_COMPLETE_STATUSCODE = exports.ForecastingSurveyApiRequestType = exports.ForecastingSurveyType = exports.Status = exports.ILogLevel = exports.DialogType = exports.AdjustmentType = exports.FiGridColumnType = exports.pivotIconStateType = exports.fiGridRowType = exports.NotificationMessageType = exports.ForecastPageMode = exports.RealtimeNotificationTypes = exports.FrPeriodExpiryStatus = exports.ChartType = exports.FCChartType = exports.RecurrenceType = exports.SnapshotFeatureId = exports.ColumnGroupType = exports.ForecastColumnDataType = exports.ForecastColumnType = exports.ForecastPivotType = exports.NameBasedOn = exports.DownStreamPrimaryDataType = void 0;
var DownStreamPrimaryDataType;
(function (DownStreamPrimaryDataType) {
    DownStreamPrimaryDataType[DownStreamPrimaryDataType["Currency"] = 1] = "Currency";
    DownStreamPrimaryDataType[DownStreamPrimaryDataType["Quantity"] = 2] = "Quantity";
})(DownStreamPrimaryDataType = exports.DownStreamPrimaryDataType || (exports.DownStreamPrimaryDataType = {}));
var NameBasedOn;
...
(function (ForecastColumnDataType) {
    ...
    ForecastColumnDataType[ForecastColumnDataType["NotSupported"] = 4] = "NotSupported";
    ForecastColumnDataType[ForecastColumnDataType["Integer"] = 5] = "Integer";
...
(function (fiGridRowType) {
    ...
    fiGridRowType[fiGridRowType["rowLoadErrorMessage"] = 4] = "rowLoadErrorMessage";
    fiGridRowType[fiGridRowType["drilldownLoadErrorMessage"] = 5] = "drilldownLoadErrorMessage";
...
(function (ILogLevel) {
    ...
    ILogLevel[ILogLevel["Perf"] = 5] = "Perf";
...
(function (PredictionDetailsTabRenderMode) {
    ...
    PredictionDetailsTabRenderMode[PredictionDetailsTabRenderMode["Loading"] = 5] = "Loading";
})(PredictionDetailsTabRenderMode = exports.PredictionDetailsTabRenderMode || (exports.PredictionDetailsTabRenderMode = {}));
exports.NO_INSIGHTS_FOR_SPECIFIED_KEY = "NoInsightsForTheSpecifiedKey";
exports.ERROR_IN_FETCHING_FORECAST_INSIGHTS = "ErrorInFetchingForecastInsights";
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.EMPTY_VIEW_ID = exports.blankDrillDownInstanceUniqueId = exports.NOT_APPLICABLE = exports.DESC_ORDER = exports.ASC_ORDER = exports.NONE_ITEM_ID = exports.EMPTY_GUID = exports.SnapshotFeatureId = exports.ForecastInstanceColumnGroupType = exports.DEALFLOW_PAGE_SIZE = exports.PAGE_SIZE = exports.FiGridColumnType = exports.ForecastColumnType = exports.APPENDWITHSPACE = exports.CURRENTRECURRENCE = exports.DI_RECORDS_FETCH_ERRORMESSAGE = exports.FI_GRID_UPDATE_ERROR = exports.FI_RECORDS_FETCH_ERRORMESSAGE = exports.PREDICTION_COLUMN_INFO_MESSAGE = exports.PREDICTION_STATE_FAILED_MESSAGE = exports.PREDICTION_STATE_LAST_PREDICTED_MESSAGE = exports.PREDICTION_STATE_INPROGRESS_MESSAGE = exports.OWNER_NAME_GROUP_SMALLCASE = exports.DrillDownUnderlyingNotReflected = exports.DRILLDOWN_LATENCY_MESSAGE = exports.CANNOT_UPDATE_REALTIME_UNDERLYING = exports.MA_DIRECT_VALUE_HOVERTEXT = exports.MA_INDIRECT_VALUE_HOVERTEXT = exports.MA_REQUEST_FAILED = exports.UNDERLYING_CHANGE_RECOMPUTE_ERROR = exports.RECOMPUTE_FAILURE_MESSAGE = exports.FORCERECOMPUTE_FAILURE_MESSAGE = exports.NotificationMessageType = exports.RECOMPUTE_INPROGRESS_STATUSCODE = exports.RECOMPUTE_COMPLETE_STATUSCODE = exports.RealtimeNotificationTypes = void 0;
var RealtimeNotificationTypes;
(function (RealtimeNotificationTypes) {
    RealtimeNotificationTypes[RealtimeNotificationTypes["None"] = 1] = "None";
    RealtimeNotificationTypes[RealtimeNotificationTypes["Initial"] = 2] = "Initial";
...
exports.FORCERECOMPUTE_FAILURE_MESSAGE = "ForceRecompute_Failure_Message";
exports.RECOMPUTE_FAILURE_MESSAGE = "Recompute_Failure_Message";
exports.UNDERLYING_CHANGE_RECOMPUTE_ERROR = "UNDERLYING_CHANGE_RECOMPUTE_ERROR";
...
exports.CANNOT_UPDATE_REALTIME_UNDERLYING = "CANNOT_UPDATE_REALTIME_UNDERLYING";
exports.DRILLDOWN_LATENCY_MESSAGE = "DRILLDOWN_LATENCY_MESSAGE";
exports.DrillDownUnderlyingNotReflected = "DrillDownUnderlyingNotReflected";
exports.OWNER_NAME_GROUP_SMALLCASE = "OWNER_NAME_GROUP_SMALLCASE";
...
exports.PREDICTION_COLUMN_INFO_MESSAGE = "PREDICTION_COLUMN_INFO_MESSAGE";
exports.FI_RECORDS_FETCH_ERRORMESSAGE = "FI_Records_Fetch_Errormessage";
exports.FI_GRID_UPDATE_ERROR = "FI_GRID_UPDATE_ERROR";
...
/***/ "./src/StateManager/MultiCurrencyStateManager.ts":
/*!*******************************************************!*\
  !*** ./src/StateManager/MultiCurrencyStateManager.ts ***!
  \*******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.MultiCurrencyStateManager = void 0;
var baseStateManager_1 = __webpack_require__(/*! ./baseStateManager */ "./src/StateManager/baseStateManager.ts");
var forecastPageTypes_1 = __webpack_require__(/*! ../Interface/forecastPageTypes */ "./src/Interface/forecastPageTypes.ts");
var MultiCurrencyStateManager = (function (_super) {
    __extends(MultiCurrencyStateManager, _super);
    function MultiCurrencyStateManager(onReRender, all) {
        var _this = _super.call(this, onReRender, all) || this;
        _this.all = all;
        _this.baseCurrencyId = forecastPageTypes_1.EMPTY_GUID;
        _this.userCurrencyId = forecastPageTypes_1.EMPTY_GUID;
        _this.activeCurrencyId = forecastPageTypes_1.EMPTY_GUID;
        _this.currencyList = {};
        return _this;
    }
    MultiCurrencyStateManager.prototype._updateCurrencyList = function (currencyList) {
        var _this = this;
        currencyList.forEach(function (currency) {
            _this.currencyList[currency.TransactionCurrencyId] = currency;
        });
    };
    MultiCurrencyStateManager.prototype.getCurrencyList = function () {
        return Object.values(this.currencyList);
    };
    MultiCurrencyStateManager.prototype._updateBaseCurrencyId = function (id) {
        this.baseCurrencyId = id;
    };
    MultiCurrencyStateManager.prototype.getBaseCurrencyId = function () {
        return this.baseCurrencyId;
    };
    MultiCurrencyStateManager.prototype._updateUserCurrencyId = function (id) {
        this.userCurrencyId = id;
    };
    MultiCurrencyStateManager.prototype.getUserCurrencyId = function () {
        return this.userCurrencyId;
    };
    MultiCurrencyStateManager.prototype.updateActiveCurrencyId = function (id) {
        this.activeCurrencyId = id;
        this.reRender();
    };
    MultiCurrencyStateManager.prototype.getActiveCurrency = function () {
        return this.currencyList[this.activeCurrencyId];
    };
    MultiCurrencyStateManager.prototype.getBaseCurrency = function () {
        return this.currencyList[this.baseCurrencyId];
    };
    return MultiCurrencyStateManager;
}(baseStateManager_1.BaseStateManager));
exports.MultiCurrencyStateManager = MultiCurrencyStateManager;
...
var drillDownGridStateManager = (function (_super) {
    ...
    function drillDownGridStateManager(onReRender, all) {
        ...
        _this.drilldownFetchHadErrorDict = {};
        _this.IsDrillDownCacheMarkedInvalidated = false;
        return _this;
    }
    ...
    drillDownGridStateManager.prototype.checkDrilldownFetchHadError = function (rowId) {
        return this.drilldownFetchHadErrorDict[rowId] || false;
    };
    drillDownGridStateManager.prototype.updateDrilldownFetchHadError = function (rowId, hasError) {
        this.drilldownFetchHadErrorDict[rowId] = hasError;
        this.reRender();
    };
    drillDownGridStateManager.prototype.resetDrilldownFetchHadErrorDict = function () {
        this.drilldownFetchHadErrorDict = {};
    };
    drillDownGridStateManager.prototype.setIsDrillDownCacheMarkedInvalidated = function (arg0) {
        this.IsDrillDownCacheMarkedInvalidated = arg0;
        this.reRender();
    };
    drillDownGridStateManager.prototype.getIsDrillDownCacheMarkedInvalidated = function () {
        return this.IsDrillDownCacheMarkedInvalidated;
    };
...
var FCChartsStateManager = (function (_super) {
    ...
    function FCChartsStateManager(onReRender, all) {
        ...
        _this.isPredictionSplitDataFetchFailed = false;
        _this.showPredictiveErrorBar = true;
        return _this;
    }
    FCChartsStateManager.prototype.resetChartData = function () {
        ...
        this.isPredictionSplitDataFetchFailed = false;
    };
    ...
    FCChartsStateManager.prototype.setForecastInsights = function (fcId, hierarchyRecordId, isRollup, insights) {
        if (Object.keys(this.insightsByFcIdNodeId).length >= 10) {
            try {
                var oldestInsightsFetchedOn = this.insightsByFcIdNodeId[Object.keys(this.insightsByFcIdNodeId)[0]].fetchedOn;
                var oldestKey = Object.keys(this.insightsByFcIdNodeId)[0];
                for (var i = 1; i < Object.keys(this.insightsByFcIdNodeId).length; i++) {
                    if (this.insightsByFcIdNodeId[Object.keys(this.insightsByFcIdNodeId)[i]].fetchedOn < oldestInsightsFetchedOn) {
                        oldestInsightsFetchedOn = this.insightsByFcIdNodeId[Object.keys(this.insightsByFcIdNodeId)[i]].fetchedOn;
                        oldestKey = Object.keys(this.insightsByFcIdNodeId)[i];
                    }
                }
                delete this.insightsByFcIdNodeId[oldestKey];
            }
            catch (e) {
                this.insightsByFcIdNodeId = {};
            }
        }
    ...
    FCChartsStateManager.prototype.IsForecastInsightsAvailableForHierarchyRecord = function (fcId, hierarchyRecordId, isRollup) {
        var _a, _b;
        if (((_b = (_a = this.predictionStatusForFC[fcId]) === null || _a === void 0 ? void 0 : _a.status) === null || _b === void 0 ? void 0 : _b.PredictionOn) != null) {
            return this.insightsByFcIdNodeId[this.getInsightsKey(fcId, hierarchyRecordId, isRollup)]
                && (this.insightsByFcIdNodeId[this.getInsightsKey(fcId, hierarchyRecordId, isRollup)].fetchedOn > (new Date().getTime() - (30 * 60 * 1000)));
        }
        else {
            return false;
        }
    ...
    FCChartsStateManager.prototype.initiateForecastInsightFetchForNode = function (fcId, hierarchyRecordId, isRollup) {
        var initiateFetch = true;
        var insights = this.getForecastInsights(fcId, hierarchyRecordId, isRollup);
        if (insights && insights != forecastPageTypes_1.ERROR_IN_FETCHING_FORECAST_INSIGHTS) {
            initiateFetch = false;
        }
    ...
    FCChartsStateManager.prototype.setPredictiveErrorBarVisibleState = function (arg) {
        this.showPredictiveErrorBar = arg;
    };
    FCChartsStateManager.prototype.getPredictiveErrorBarVisibleState = function () {
        return this.showPredictiveErrorBar;
    };
    FCChartsStateManager.prototype.setIsPredictionSplitDataFetchFailed = function (value) {
        this.isPredictionSplitDataFetchFailed = value;
        this.isWaterfallChartLoading = false;
        this.reRender();
    };
    FCChartsStateManager.prototype.getIsPredictionSplitDataFetchFailed = function () {
        return this.isPredictionSplitDataFetchFailed;
    };
...
/***/ "./src/StateManager/fcWebResourcesStateManager.ts":
/*!********************************************************!*\
  !*** ./src/StateManager/fcWebResourcesStateManager.ts ***!
  \********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.FcWebResourcesStateManager = void 0;
var baseStateManager_1 = __webpack_require__(/*! ./baseStateManager */ "./src/StateManager/baseStateManager.ts");
var FcWebResourcesStateManager = (function (_super) {
    __extends(FcWebResourcesStateManager, _super);
    function FcWebResourcesStateManager(onReRender, all) {
        var _this = _super.call(this, onReRender, all) || this;
        _this.all = all;
        _this.isFcWebResourcesLoading = false;
        _this.isFcWebResourcesLoadSuccess = false;
        _this.isFcMappedWithWebResources = false;
        _this.webResourcesMappedWithFc = [];
        _this.handlerMpg = {};
        return _this;
    }
    FcWebResourcesStateManager.prototype.resetFcWebResourcesData = function () {
        this.isFcWebResourcesLoadSuccess = false;
        this.isFcWebResourcesLoading = false;
        this.isFcMappedWithWebResources = false;
        this.webResourcesMappedWithFc = [];
        this.handlerMpg = {};
        this.reRender();
    };
    FcWebResourcesStateManager.prototype.setHandlerDetails = function (fns) {
        this.handlerMpg = fns;
        this.reRender();
    };
    FcWebResourcesStateManager.prototype.getHandlerDetails = function () {
        return this.handlerMpg;
    };
    FcWebResourcesStateManager.prototype.setIsFcWebResourcesLoading = function (arg0) {
        this.isFcWebResourcesLoading = arg0;
        this.reRender();
    };
    FcWebResourcesStateManager.prototype.getIsFcWebResourcesLoading = function () {
        return this.isFcWebResourcesLoading;
    };
    FcWebResourcesStateManager.prototype.setIsFcWebResourcesLoadSuccess = function (arg0) {
        this.isFcWebResourcesLoadSuccess = arg0;
        this.reRender();
    };
    FcWebResourcesStateManager.prototype.getIsFcWebResourcesLoadSuccess = function () {
        return this.isFcWebResourcesLoadSuccess;
    };
    FcWebResourcesStateManager.prototype.setIsFcMappedWithWebResources = function (arg0) {
        this.isFcMappedWithWebResources = arg0;
        this.reRender();
    };
    FcWebResourcesStateManager.prototype.getIsFcMappedWithWebResources = function () {
        return this.isFcMappedWithWebResources;
    };
    FcWebResourcesStateManager.prototype.setWebResourcesMappedWithFc = function (arg0) {
        this.webResourcesMappedWithFc = arg0;
    };
    FcWebResourcesStateManager.prototype.getWebResourcesMappedWithFc = function () {
        return this.webResourcesMappedWithFc;
    };
    return FcWebResourcesStateManager;
}(baseStateManager_1.BaseStateManager));
exports.FcWebResourcesStateManager = FcWebResourcesStateManager;
...
var FiGridStateManager = (function (_super) {
    ...
    function FiGridStateManager(onReRender, all) {
        ...
        _this.fiChildFetchHadErrorDict = {};
        _this.pageInfoDict = {};
    ...
    FiGridStateManager.prototype.getfiChildFetchHadErrorDict = function () {
        return this.fiChildFetchHadErrorDict;
    };
    FiGridStateManager.prototype.updatefiChildFetchHadError = function (rowId, hasError) {
        this.fiChildFetchHadErrorDict[rowId] = hasError;
        this.reRender();
    };
    FiGridStateManager.prototype.resetfiChildFetchHadErrorDict = function () {
        this.fiChildFetchHadErrorDict = {};
    };
...
var PartRecordStateManager = (function (_super) {
    ...
    PartRecordStateManager.prototype.getKey = function (rowId, colId, viewId, pivotId) {
        if (pivotId)
            return rowId + "_" + colId + "_" + viewId + "_" + pivotId;
        return rowId + "_" + colId + "_" + viewId;
    };
    PartRecordStateManager.prototype.getIsPartRecFetchXml = function (rowId, colId, viewId, pivotId) {
        var k = this.getKey(rowId, colId, viewId, pivotId);
        return this.fetchXmlDict[k];
    };
    PartRecordStateManager.prototype.setIsPartRecFetchXml = function (rowId, colId, viewId, partFetchXml, pivotId) {
        var k = this.getKey(rowId, colId, viewId, pivotId);
...
var fcWebResourcesStateManager_1 = __webpack_require__(/*! ./fcWebResourcesStateManager */ "./src/StateManager/fcWebResourcesStateManager.ts");
var MultiCurrencyStateManager_1 = __webpack_require__(/*! ./MultiCurrencyStateManager */ "./src/StateManager/MultiCurrencyStateManager.ts");
var SimpleStateManager = (function () {
    function SimpleStateManager(onReRender) {
        ...
        this.fcWebResourcesStateManager = new fcWebResourcesStateManager_1.FcWebResourcesStateManager(this.reRender.bind(this), this);
        this.multiCurrency = new MultiCurrencyStateManager_1.MultiCurrencyStateManager(this.reRender.bind(this), this);
        if (onReRender)
...
var SnapshotsStateManager = (function (_super) {
    ...
    function SnapshotsStateManager(onReRender, all) {
        ...
        _this.fcSnapshotStatusResponse = undefined;
        return _this;
    }
    ...
    SnapshotsStateManager.prototype.setSnapshotStatusForActiveFC = function (arg0) {
        this.fcSnapshotStatusResponse = arg0;
    };
    SnapshotsStateManager.prototype.getSnapshotStatusForActiveFC = function () {
        return this.fcSnapshotStatusResponse;
    };
...
var FakeCrmDataFormatter = (function () {
    ...
    FakeCrmDataFormatter.prototype.formatCurrency = function (value, currencySymbol, precision) {
...
/***/ "./src/Testing/fakeServices/fakeDataAccessHelpers/ClientMetadataGenerator.ts":
/*!***********************************************************************************!*\
  !*** ./src/Testing/fakeServices/fakeDataAccessHelpers/ClientMetadataGenerator.ts ***!
  \***********************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.generateClientMetaDataResponse = void 0;
function generateClientMetaDataResponse() {
    var response = {
        Currencies: [
            {
                ...
                "CurrencySymbol": "$",
                "IsoCurrencyCode": "USD",
                "TransactionCurrencyId": "3faef43f-53a7-ea11-a81b-000d3a382cc3",
            ...
            },
            {
                ...
                "CurrencySymbol": "€",
                "IsoCurrencyCode": "EUR",
                "TransactionCurrencyId": "1b718f64-f9dd-ea11-a813-000d3a06a63e",
            ...
            },
            {
                ...
                "CurrencySymbol": "₹",
                "IsoCurrencyCode": "INR",
                "TransactionCurrencyId": "a55fdf67-f6dd-ea11-a813-000d3a06a63e",
                "ExchangeRate": 74.1020030000,
                "CurrencyPrecision": 3
            }
        ],
        BaseCurrencyId: "3faef43f-53a7-ea11-a81b-000d3a382cc3",
        UserCurrencyId: "1b718f64-f9dd-ea11-a813-000d3a06a63e"
    };
    return response;
}
exports.generateClientMetaDataResponse = generateClientMetaDataResponse;
    ...
    var outP = {
        ...
        advancedsettings: {
            ...
            Options: {
                ...
                isMultiCurrencySelectionEnabled: true,
                isPredictionInsightsEnabled: false
            },
            UnderlyingRecordsWebResourceList: [{
                    Id: "cf6403b2-20cb-ea11-a813-000d3a06a63e",
                    Name: "new_forecastingtestjs",
                    DisplayName: "ForecastingTest"
                }]
        }
    };
    return outP;
...
var ClientMetadataGenerator_1 = __webpack_require__(/*! ./fakeDataAccessHelpers/ClientMetadataGenerator */ "./src/Testing/fakeServices/fakeDataAccessHelpers/ClientMetadataGenerator.ts");
var FakeForecastDataAccess = (function () {
    ...
    FakeForecastDataAccess.prototype.fetchClientMetaData = function () {
        var _this = this;
        var response = ClientMetadataGenerator_1.generateClientMetaDataResponse();
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                resolve(response);
                _this.onNetworkCallComplete("fetchClientMetaData");
            }, _this.config.networkDelay);
        });
    };
    ...
    FakeForecastDataAccess.prototype.fetchForecastInstances = function (forecastRecurrenceId, fcId, parentIds, pagesInfo, snapshotId) {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.fiFetchRequestShouldFail) {
                setTimeout(function () {
                    _this.onNetworkCallComplete("fetchForecastInstances");
    ...
    FakeForecastDataAccess.prototype.fetchDrillDownInstances = function (forecastConfigurationId, forecastRecurrenceId, targetForecastInstanceId, forecastPivot, columnGroupType, forecastConfigurationColumnIds, pageInfo) {
        var _this = this;
        this.onFetchDrillDownSPY && this.onFetchDrillDownSPY(forecastConfigurationId, forecastRecurrenceId, targetForecastInstanceId, forecastPivot.ForecastPivotId, columnGroupType, forecastConfigurationColumnIds, pageInfo);
        this.fetchDrillDownCnt++;
        return new Promise(function (resolve, reject) {
            if (_this.fiFetchRequestShouldFail) {
                setTimeout(function () {
                    _this.onNetworkCallComplete();
                    reject(new Error("Fetch drilldowns failed with a fake error"));
                }, _this.config.networkDelay + _this.extraFiRequestTime);
                return;
            }
            var drillDownGenerator = new DrillDownInstanceGenerator_1.DrillDownInstanceGenerator(_this.config, forecastPivot.ForecastPivotId, forecastRecurrenceId, forecastConfigurationId, _this.updateDrilLDown.bind(_this));
            var forecastDrillDownInstances = [];
            var hasMoreRecords = false;
            var stIdx = (pageInfo.pageNumber - 1) * (pageInfo.pageSize);
            var endIdx = Math.min(stIdx + pageInfo.pageSize, _this.config.numberOfDrillDownRecords);
            for (var i = stIdx; i < endIdx; i++) {
                var fi4 = drillDownGenerator.createFakeDI(targetForecastInstanceId, columnGroupType, i);
                forecastDrillDownInstances.push(fi4);
            }
            if (endIdx < _this.config.numberOfDrillDownRecords)
                hasMoreRecords = true;
            var outP = {
    ...
    FakeForecastDataAccess.prototype.fetchSnapshotStatusForFC = function (fcId) {
        throw new Error("Method not implemented.");
    };
...
var FakeNrtToastNotificationManager = (function () {
    ...
    FakeNrtToastNotificationManager.prototype.clearNotification = function (id) {
        this.config.onNrtNotificationInvoke(FakeNotificationTypes.Clear);
    };
    FakeNrtToastNotificationManager.prototype.createInfoToastNotification = function (msg) {
        this.config.onNrtNotificationInvoke(FakeNotificationTypes.InProgress);
        return new Promise(function (resolve, reject) {
        });
    };
...
var FakeStringsProvider = (function () {
    ...
    FakeStringsProvider.prototype.getLocalizedString = function (key) {
        ...
        if (key === "CurrentRecurrence")
            return "(Current)";
        if (key === "OWNER_NAME_GROUP_SMALLCASE")
            return "{0} (group)";
        if (key === "UNDERLYING_CHANGE_RECOMPUTE_ERROR")
            return "There was an error in updating the forecast grid with changes in the underlying records. Please recalculate and update the forecast data.";
        return key;
    };
...
var NullLogger = (function () {
    ...
    NullLogger.prototype.logPerf = function (component, message, args) {
    };
    return NullLogger;
}());
...
var ConsoleLogger = (function () {
    ...
    ConsoleLogger.prototype.logPerf = function (component, message, args) {
        console.log("ForecastPageUIApi [Perf]: " + component + " - " + message + " - " + JSON.stringify(args, null, 2));
    };
...
var SurveyHandler = (function () {
    ...
    SurveyHandler.prototype.validateEligibility = function (surveyType, triggerSource) {
        ...
        try {
            ...
            ce_1.callValidateEligibilityAPI()
                ...
                if (formsData && formsData["FormsProId"]) {
                    _this.displayFormsProSurvey(formsData, ce_1, triggerSource);
    ...
    SurveyHandler.prototype.callTriggerAndValidateEligibility = function (surveyType, triggerSource) {
        ...
        try {
            ...
            ce_2.callTriggerAndValidateEligibilityAPI(EventName)
                .then(function (formsData) {
                if (formsData && formsData["FormsProId"]) {
                    var formsContext = _this.displayFormsProSurvey(formsData, ce_2, triggerSource);
    ...
    SurveyHandler.prototype.displayFormsProSurvey = function (formsData, ce, triggerSource) {
        try {
            var se = new SurveyEmbed(formsData["FormsProId"], "https://forms.office.com/formspro/", "https://mfpembedcdnmsit.azureedge.net/mfpembedcontmsit/", "true");
            var globalContext = window.Xrm.Utility.getGlobalContext();
            var userId = formsData["AADID"];
