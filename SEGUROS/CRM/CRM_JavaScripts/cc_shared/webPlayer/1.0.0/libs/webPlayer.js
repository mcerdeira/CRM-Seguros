    ...
    (function (Embedding) {
        var CoreEmbedding = /** @class */ (function () {
            function CoreEmbedding(embeddingOptions, hostWindow) {
                ...
                if (embeddingOptions.hostName) {
                    this.embeddingOptions.hostName = this.ensureTrailingSlash(embeddingOptions.hostName);
                }
                this.embeddingOptions.hostName = this.embeddingOptions.hostName ? this.embeddingOptions.hostName : this.getHostName();
                ...
                if (input && input.api !== undefined) {
                    switch (input.api) {
                        case Embedding.RuntimeToSdkApi.GetAccessToken:
                            ...
                            this.embeddingOptions.getAccessToken(getAccessTokenInput.audience, successCallback, errorCallback);
                            break;
                        default:
                            // Invalid API.
                            break;
            ...
            CoreEmbedding.prototype.validateMessageOrigin = function (event) {
                return !!this.subDomainRegex.exec(event.origin);
            };
            ...
            CoreEmbedding.prototype.constructBaseUrl = function (pathSegment) {
                ...
                if (this.embeddingOptions.source) {
                    url += "&source=" + this.embeddingOptions.source;
                }
                if (this.embeddingOptions.locale) {
                    url += "&locale=" + this.embeddingOptions.locale;
                }
                if (this.embeddingOptions.externalCorrelationId) {
                    url += "&correlationId=" + encodeURIComponent(this.embeddingOptions.externalCorrelationId);
                }
                if (this.embeddingOptions.enableOnBehalfOf) {
                    url += "&enableOnBehalfOf=true";
                }
                return url;
            };
...
(function (WebPlayer) {
    ...
    (function (Sdk) {
        ...
        (function (PowerAppsEmbeddingCallbackApi) {
            ...
            PowerAppsEmbeddingCallbackApi[PowerAppsEmbeddingCallbackApi["Send"] = 30] = "Send";
...
(function (WebPlayer) {
    ...
    (function (Sdk) {
        ...
        var PowerAppsEmbedding = /** @class */ (function (_super) {
                ...
                if (this.options.parameters) {
                    for (var paramKey in this.options.parameters) {
                        if (this.options.parameters.hasOwnProperty(paramKey)) {
                            url += "&" + paramKey + "=" + encodeURIComponent(this.options.parameters[paramKey]);
                        }
                    }
                }
            ...
            PowerAppsEmbedding.prototype._setIframeSize = function () {
                if (this.options.appInfo && this.options.appInfo.tags && this.options.appInfo.tags.primaryDeviceWidth && this.options.appInfo.tags.primaryDeviceHeight) {
                    ...
                    if (aspectRatio > 0) {
                        ...
                        this._setIframeSizeWithNoAspectRatio();
                    }
                }
                else {
            ...
            PowerAppsEmbedding.prototype._setIframeSizeWithNoAspectRatio = function () {
                if (this.options.maxWidth) {
                    // max width is set so force the width to be that
                    this.iframe.width = parseInt(this.options.maxWidth, 10) + "px";
                }
                else {
                ...
                if (this.options.maxHeight) {
                    // max width is set so force the width to be that
                    this.iframe.height = parseInt(this.options.maxHeight, 10) + "px";
                }
                else {
                    // Set to to fill 100% of container div
                    this.iframe.height = "100%";
             ...
             *  - send: Fired when the app transmits information to the host
             *
                ...
                if (input && input.api !== undefined) {
                    ...
                    switch (input.api) {
                        ...
                        case Sdk.PowerAppsEmbeddingCallbackApi.RequestHide:
                            ...
                            break;
                        case Sdk.PowerAppsEmbeddingCallbackApi.Send:
                            eventName = "send";
                            break;
            ...
            PowerAppsEmbedding.prototype._trackEmbeddedPlayerVisibility = function () {
                ...
                var mutationObserver = new MutationObserver(function (changed, observer) {
                    ...
                    _this._reportEmbeddedPlayerVisibility();
                });
            ...
            PowerAppsEmbedding.prototype._reportEmbeddedPlayerVisibility = function () {
            ...
            PowerAppsEmbedding._isElementOnScreen = function (element) {
                var between = function (first, second, compare) { return first <= compare && second >= compare; };
                var containsRect = function (container, rect) {
                    return (between(container.top, container.bottom, rect.top) ||
                        between(container.top, container.bottom, rect.bottom)) && (between(container.left, container.right, rect.left) ||
                        between(container.right, container.right, rect.right));
                };
...
//# sourceMappingURL=D:/_dev/PowerApps2/obj/Assets/js/WebPlayer.Sdk/index.js.map