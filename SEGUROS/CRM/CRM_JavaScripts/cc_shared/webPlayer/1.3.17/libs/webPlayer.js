        ...
        var PowerAppsEmbedding = /** @class */ (function (_super) {
            ...
            PowerAppsEmbedding.prototype._constructUrl = function () {
                ...
                if (this._isCallingServiceFabricEndpoint()) {
                    url = this.options.hostName + "play" + decodeURIComponent(this.options.appId);
            ...
            PowerAppsEmbedding.prototype._renderWebPlayerApp = function () {
                ...
                this.iframe.setAttribute("allow", "geolocation *; microphone *; camera *; fullscreen *;");
                this.iframe.allowFullscreen = true; // Not all browsers use the "allow" attribute for full screen
