        ...
        var CoreEmbedding = /** @class */ (function () {
            ...
            CoreEmbedding.prototype.constructBaseUrl = function (pathSegment) {
                ...
                if (this.embeddingOptions.source) {
                    url += querySeparator + "source=" + this.embeddingOptions.source;
                    querySeparator = "&";
                }
                if (this.embeddingOptions.locale) {
                    url += querySeparator + "locale=" + this.embeddingOptions.locale;
                    querySeparator = "&";
                }
                if (this.embeddingOptions.externalCorrelationId) {
                    url += querySeparator + "correlationId=" + encodeURIComponent(this.embeddingOptions.externalCorrelationId);
                    querySeparator = "&";
                }
                if (this.embeddingOptions.enableOnBehalfOf) {
                    url += querySeparator + "enableOnBehalfOf=true";
                    querySeparator = "&";
                }
                return url;
            };
    ...
    (function (Sdk) {
        ...
        var PowerAppsEmbedding = /** @class */ (function (_super) {
            ...
            PowerAppsEmbedding.prototype.sendCdpData = function (itemId, promise) {
                ...
                if (!this.options.overrideSendCdpDataApiEnabled
                    && this.sdkOrchestrator.packageVersion < minPackageVersionApiSupport) {
                    return;
                }
                var cdpData = {
                    itemId: itemId,
                ...
                this.sdkOrchestrator.sendCdpData(cdpData);
            };
            /**
            ...
            PowerAppsEmbedding.prototype._renderAppWithSdkOrchestrator = function (sdkMetadata) {
                ...
                this.queuedCdpData.forEach(function (cdpData) {
                    _this.sdkOrchestrator.sendCdpData(cdpData);
                });
                this.queuedCdpData = [];
            };
...
//# sourceMappingURL=G:/pa2/PowerApps-Client/obj/Assets/js/WebPlayer.Sdk/index.js.map