    ...
    (function (Sdk) {
        ...
        (function (EmbeddingConsentFlowHelper) {
            ...
            function onConsentServiceLoaded(input) {
                ...
                config.logger.logOperationEnd("WebPlayerRuntime.LoadingDisambiguationWithConsentService", input.data.consentDialogLoadedTimestamp);
            }
...
(function (WebPlayer) {
    ...
    (function (Sdk) {
        var EmbeddingLogger = /** @class */ (function () {
            ...
            EmbeddingLogger.prototype.logOperationEnd = function (operationName, endTimeStamp) {
                ...
                this._logCallback({ operationName: operationName, duration: duration });
    ...
    (function (Sdk) {
        ...
        var PowerAppsEmbedding = /** @class */ (function (_super) {
            ...
            PowerAppsEmbedding.prototype._constructUrl = function (isConsentService) {
                ...
                var url = "";
                var isServiceFabric = this._isCallingServiceFabricEndpoint();
                if (isServiceFabric) {
                ...
                if (this.options.embedderOrigin) {
                    url += "&embedderOrigin=" + this.options.embedderOrigin;
                }
                return url;
            };
            ...
            PowerAppsEmbedding.prototype._renderAppWithSdkOrchestrator = function (sdkMetadata) {
                ...
                this.queuedCdpData = [];
                this._initEmbeddingLogger(this.iframe);
            };
            ...
            PowerAppsEmbedding.prototype._initEmbeddingLogger = function (iframe) {
                this.embeddingLogger = new Sdk.EmbeddingLogger(function (data) {
                    var params = {
                        api: Sdk.PowerAppsEmbeddingCallbackApi.Log,
                        data: data
                    };
            ...
            PowerAppsEmbedding.prototype._renderConsentPage = function () {
                if (this.options.consentDialogOpenCloseHandler) {
                    this.options.consentDialogOpenCloseHandler(true);
                }
            ...
            PowerAppsEmbedding.prototype._disposeConsentPage = function () {
                if (this.consentIframe) {
                    ...
                    if (this.options.consentDialogOpenCloseHandler) {
                        this.options.consentDialogOpenCloseHandler(false);
                    }
                }
            };
            /**
                ...
                if (input && input.api !== undefined) {
                    ...
                    switch (input.api) {
                        ...
                        case Sdk.PowerAppsEmbeddingCallbackApi.InteractionRequired:
                            ...
                            if (this.options.standAloneConsent && input && input.data && input.data.source === "AppPermissionDialog") {
                                Sdk.EmbeddingConsentFlowHelper.onConsentServiceLoaded(input);
                                if (this.options.consentDialogUserInteractionHandler) {
                        ...
                        case Sdk.PowerAppsEmbeddingCallbackApi.OpenConsentPage:
                            Sdk.EmbeddingConsentFlowHelper.initializeConsentService({
                                ...
                                postMessageToConsentService: function (params) {
                                    if (_this.consentIframe && _this.consentIframe.contentWindow) {
                                        _this.consentIframe.contentWindow.postMessage(params, "*");
                                    }
                                }
                            }, input);
                            break;
