...
(function (MscrmCommon) {
    ...
    */
	(function (ProgressIndicatorType) {
        ...
        */
		ProgressIndicatorType[ProgressIndicatorType["Bar"] = 0] = "Bar";
        /**
        * Circular ring of dots.
        */
		ProgressIndicatorType[ProgressIndicatorType["Ring"] = 1] = "Ring";
	})(MscrmCommon.ProgressIndicatorType || (MscrmCommon.ProgressIndicatorType = {}));
	var ProgressIndicatorType = MscrmCommon.ProgressIndicatorType;
})(MscrmCommon || (MscrmCommon = {}));
/**
* @license Copyright (c) Microsoft Corporation. All rights reserved.
*/
...
(function (MscrmCommon) {
	...
	var CommonControl = (function () {
		...
		CommonControl.prototype.createWrapperContainer = function (className, isRtl) {
			...
			if (isRtl) {
				wrapperContainer.className += " " + MscrmCommon.CommonControl.ClassRtl;
			}
...
(function (MscrmCommon) {
	...
	var EventConstants = (function () {
		...
		/** Mouse Out event */
		EventConstants.MouseOut = "mouseout";
		/** Pointer Down event */
	...
	(function (ControlUtils) {
        ...
        */
		var WijmoGlobalization = (function () {
            ...
            */
			WijmoGlobalization.setCrmNumberFormatting = function (crmFormatting) {
				WijmoGlobalization.formatting = crmFormatting;
				if (!WijmoGlobalization.wijmoFormatNumber) {
					WijmoGlobalization.wijmoFormatNumber = wijmo.Globalize.formatNumber;
					wijmo.Globalize.formatNumber = WijmoGlobalization.formatNumber;
				}
			};
            /**
            ...
            */
			WijmoGlobalization.formatNumber = function (value, format, trim) {
				var matches = format.match(/\d+/);
				var prec = matches ? parseInt(matches[0]) : null;
				switch (format[0]) {
					case "N":
						return WijmoGlobalization.formatting.formatDecimal(value, prec);
					case "C":
						return WijmoGlobalization.formatting.formatCurrency(value, prec);
					default:
						return WijmoGlobalization.wijmoFormatNumber(value, format, trim);
				}
			};
            /**
...
(function (MscrmCommon) {
	...
	var ThemingHelper = (function () {
		...
		ThemingHelper.getHoverLinkColor = function (theming) {
			// In change 'PR 37354: Apply Style to Custom Controls', 'hoverlinkeffect' is deprecated. Add it here for backward compatibility
			var deprecatedValue = theming.hoverlinkeffect;
			var hoverlinkeffectcolor = !MscrmCommon.ControlUtils.Object.isNullOrUndefined(theming.hoverlinkeffectcolor) ? theming.hoverlinkeffectcolor : deprecatedValue;
			return ThemingHelper.validateCssColor(hoverlinkeffectcolor);
		};
        /*
        ...
        /*
         * Retrieves the shade control color in hexadecimal RGB format, prepended with a hash.
         * @param theming The theming bag.
         * @param htmlEncode The encoding function used to HTML encode strings.
         * @return The accent color in hexadecimal RGB format, prepended with a hash.
         */
		ThemingHelper.getShadeControlColor = function (theming) {
			return ThemingHelper.validateCssColor(theming.controlshadecolor);
		};
		...
		ThemingHelper.getFontFamily = function (theming) {
			return ThemingHelper.validateCssFontFamily(theming.normalfontfamily);
		};
		...
		ThemingHelper.getFontColor = function (theming) {
			return ThemingHelper.validateCssColor(theming.normalfontcolor);
		};
		...
		ThemingHelper.getFontSize = function (theming) {
			return ThemingHelper.validateCssSize(theming.normalfontsize);
		};
        /*
         ...
         */
		ThemingHelper.getEditModeStyle = function (theming, error) {
			var solidborderstyle = theming.solidborderstyle, textboxredcolor = theming.textboxredcolor, textboxcontentcolor = theming.textboxcontentcolor, textboxerrorbackgroundcolor = theming.textboxerrorbackgroundcolor, textboxbackgroundcolor = theming.textboxbackgroundcolor, textboxhoverboxcolor = theming.textboxhoverboxcolor, textboxlinethickness = theming.textboxlinethickness, textboxlineheight = theming.textboxlineheight, textboxfontsize = theming.textboxfontsize, textboxfontweight = theming.textboxfontweight, textboxcontentfontweight = theming.textboxcontentfontweight, textboxhorizontalpadding = theming.textboxhorizontalpadding, textboxverticalpadding = theming.textboxverticalpadding;
			var color = error ? textboxredcolor : textboxcontentcolor;
			var fontWeight = error ? textboxcontentfontweight : textboxfontweight;
			var backgroundColor = error ? textboxerrorbackgroundcolor : textboxbackgroundcolor;
			var borderColor = error ? textboxredcolor : textboxhoverboxcolor;
			return {
				width: "100%",
				boxSizing: "border-box",
				lineHeight: textboxlineheight,
				fontWeight: fontWeight,
				fontSize: textboxfontsize,
				color: color,
				paddingLeft: textboxhorizontalpadding,
				paddingRight: textboxhorizontalpadding,
				paddingTop: textboxverticalpadding,
				paddingBottom: textboxverticalpadding,
				backgroundColor: backgroundColor,
				borderColor: borderColor,
				borderStyle: solidborderstyle,
				borderLeftWidth: textboxlinethickness,
				borderRightWidth: textboxlinethickness,
				borderBottomWidth: textboxlinethickness,
				borderTopWidth: textboxlinethickness
			};
		};
        /**
         ...
         * @returns style - collected styles for input
         */
		ThemingHelper.getReadModeStyle = function (theming, error) {
			var textboxredcolor = theming.textboxredcolor, textboxrestmodecolor = theming.textboxrestmodecolor, textboxcontentcolor = theming.textboxcontentcolor, textboxlineheight = theming.textboxlineheight, textboxfontsize = theming.textboxfontsize, textboxcontentfontweight = theming.textboxcontentfontweight, textboxverticalpadding = theming.textboxverticalpadding, textboxhorizontalpadding = theming.textboxhorizontalpadding, solidborderstyle = theming.solidborderstyle, textboxlinethickness = theming.textboxlinethickness;
			var color = error ? textboxredcolor : textboxcontentcolor;
			return {
				width: "100%",
				lineHeight: textboxlineheight,
				fontWeight: textboxcontentfontweight,
				fontSize: textboxfontsize,
				color: color,
				borderColor: textboxrestmodecolor,
				borderStyle: solidborderstyle,
				borderWidth: textboxlinethickness,
				paddingLeft: textboxhorizontalpadding,
				paddingRight: textboxhorizontalpadding,
				paddingTop: textboxverticalpadding,
				paddingBottom: textboxverticalpadding
...
/// <reference path="mscrm/ProgressIndicatorType.ts" />
...
var Guid = (function () {
	...
	Guid.equals = function (x, y) {
		// if the canonical string representations are the same, the guids are equal
