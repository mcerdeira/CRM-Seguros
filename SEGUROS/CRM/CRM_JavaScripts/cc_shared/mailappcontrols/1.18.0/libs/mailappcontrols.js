    ...
    (function (MailApp) {
        ...
        var LimitedModeNotification = (function () {
            ...
            LimitedModeNotification.prototype.render = function (context) {
                ...
                var infoIcon = this._getIconComponent(179);
                var arrowIcon = this._getIconComponent(97, true);
                ...
                }, [infoIcon, content, arrowIcon]);
            };
            LimitedModeNotification.prototype._getIconComponent = function (entityPrimaryField, isActionable) {
                if (isActionable === void 0) { isActionable = false; }
                return this._context.factory.createElement("MICROSOFTICON", {
                    ...
                    style: Object.assign({
                        fontSize: this._context.theming.fontsizes.font150,
                    }, isActionable && {
                        cursor: "pointer",
                        padding: "4px",
                        fontWeight: "bold",
                    ...
                    onClick: isActionable ? this._props.onClose : null,
                });
            };
            LimitedModeNotification.prototype._getLinkComponent = function (message) {
                ...
                return this._context.factory.createElement("HYPERLINK", {
                    ...
                    style: (_a = {
                        ...
                        _a["padding" + (isRTL ? "Right" : "Left")] = "6px",
                        _a["padding" + (isRTL ? "Left" : "Right")] = "3px",
