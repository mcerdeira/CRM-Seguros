        ...
        (function (ContextualEmail) {
            ...
            var PopupUtility = (function () {
                ...
                PopupUtility.getEmailSrcUrl = function (createParams, emailId) {
                    ...
                    var dataParams = encodeURIComponent(ContextualEmail.Utils.escapeXMLCharacters(JSON.stringify(createParams.dataParams)));
                    var emailSrc = window.location.protocol + "//" + window.location.host + window.location.pathname + "?appid=" + appId + "&pagetype=entityrecord&etn=email&navbar=off";
