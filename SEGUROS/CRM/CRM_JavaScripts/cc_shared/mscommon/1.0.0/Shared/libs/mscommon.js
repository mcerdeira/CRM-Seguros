...
(function (MscrmCommon) {
    ...
    var ThemingHelper = (function () {
        ...
        ThemingHelper.getGlobalLinkColor = function (theming) {
            return ThemingHelper.validateCssColor(theming.colors.globallink);
        };
        /*
        ...
        ThemingHelper.getHoverLinkColor = function (theming) {
            ...
            var hoverlinkeffectcolor = !MscrmCommon.ControlUtils.Object.isNullOrUndefined(theming.colors.hoverlinkeffect) ? theming.colors.hoverlinkeffect : deprecatedValue;
        ...
        ThemingHelper.getProcessControlColor = function (theming) {
            return ThemingHelper.validateCssColor(theming.colors.processcontrol);
        };
        /*
        ...
        ThemingHelper.getShadeControlColor = function (theming) {
            return ThemingHelper.validateCssColor(theming.colors.controlshade);
        };
        ...
        ThemingHelper.getEditModeStyle = function (theming, error) {
            var solidborderstyle = theming.solidborderstyle, textbox = theming.textbox;
            var color = error ? textbox.redcolor : textbox.contentcolor;
            var fontWeight = error ? textbox.contentfontweight : textbox.fontweight;
            var backgroundColor = error ? textbox.errorbackgroundcolor : textbox.backgroundcolor;
            var borderColor = error ? textbox.redcolor : textbox.hoverboxcolor;
            return {
                width: "100%",
        ...
        ThemingHelper.getReadModeStyle = function (theming, error) {
            ...
            return {
                ...
                fontSize: textbox.fontsize,
                color: color,
                borderColor: textbox.restmodecolor,
                borderStyle: solidborderstyle,
                borderWidth: textbox.linethickness,
                paddingLeft: textbox.horizontalpadding,
                paddingRight: textbox.horizontalpadding,
                paddingTop: textbox.verticalpadding,
                paddingBottom: textbox.verticalpadding
