...
(function (MscrmCommon) {
    ...
    var ThemingHelper = (function () {
        ...
        ThemingHelper.getHoverLinkColor = function (theming) {
            return ThemingHelper.validateCssColor(theming.hoverlinkeffectcolor);
        };
        /*
        ...
        ThemingHelper.getReadModeStyle = function (theming, error) {
            var noneborderstyle = theming.noneborderstyle, textboxredcolor = theming.textboxredcolor, textboxcontentcolor = theming.textboxcontentcolor, textboxlineheight = theming.textboxlineheight, textboxfontsize = theming.textboxfontsize, textboxcontentfontweight = theming.textboxcontentfontweight;
            var color = error ? textboxredcolor : textboxcontentcolor;
            return {
                width: "100%",
                lineHeight: textboxlineheight,
